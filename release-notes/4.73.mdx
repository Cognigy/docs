...
- Added the UI Preferences section to the Agent Copilot Tile Nodes. Now you can modify fonts for the Agent Copilot [Plug-and-Play](/agent-copilot/plug-and-play-widgets) widgets
