...
- Added [Source Tags](/ai/agents/develop/knowledge-ai/knowledge-source/overview-tags) to Knowledge Sources, which can be used to dynamically filter the search scope from the Search Extract Output Node.
