---
title: "4.63 - Happy Halloween \U0001F987"
...
- Added [Source Tags](/ai/agents/develop/knowledge-ai/knowledge-source/knowledge-source-tags) to Knowledge Sources, which can be used to dynamically filter the search scope from the Search Extract Output Node.

#### Improvements

- Added the [Glossary Input ID](/ai/agents/deploy/endpoints/real-time-translation-settings#real-time-translation-settings) field to the Endpoint settings for the DeepL Translate Pro provider
...
- Added support for the [`gpt3.5-turbo-instruct`](/ai/agents/develop/gen-ai-and-llms/model-support-by-feature) model by Microsoft Azure OpenAI and OpenAI
- Added the Agent Assist Workspace link for the [8x8 handover provider](/ai/escalate/handover-reference/8x8)
- Added the Agent Assist Workspace link for the [Genesys Cloud Open Messaging handover provider](/ai/escalate/handover-reference/genesys-cloud-open-messaging)
...
- Added the limit and sort filters to the detailed view of the [Label Summary](/insights/reports/live-agent#label-summary) chart
