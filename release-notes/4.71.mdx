...
<Accordion title="Cognigy.AI Handover problem solved in 4.71.4">
  This version solves an issue with an incorrect caching behavior of Cognigy.AI Handovers by deactivating the cache by default. If you are upgrading to this version, the following configuration, which was necessary in the older version of 4.71 is **NOT necessary**:
  ```yaml
  cognigyEnv:
...
- Implemented [streaming](/voice-gateway/webapp/streaming) capability with the ElevenLabs Speech provider
