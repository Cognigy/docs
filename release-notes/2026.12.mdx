...
- Fixed the issue where the [`GET /v2.1/projects/{projectId}/logs`](/api-reference-logs/logs-v21/get-log-entries) API method was unavailable
...
- Fixed the issue where Cognigy didn't receive AMD events when a custom HTTP URL was used as the `amd.actionHook` value
