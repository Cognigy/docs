...
- Added the opportunity to access the Voice Gateway Self-Service Portal [via Cognigy.AI user credentials](/voice-gateway/getting-started#set-up-voice-gateway-for-your-organization). This feature is available to users with the [Account](/voice-gateway/webapp/users#account) role
