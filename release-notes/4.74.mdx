...
import ReleaseNotesCognigyJourneysRemoval from '/snippets/release-notes/cognigy-journeys-removal.mdx'
import ReleaseNotesUpdateForSocketioWebchatEndpoints from '/snippets/release-notes/update-for-socket.io-webchat-endpoints.mdx'
import ReleaseNotesWeaviateToQdrant from '/snippets/release-notes/weaviate-to-qdrant.mdx'

<ReleaseNotesUpdateForSocketioWebchatEndpoints/>

<ReleaseNotesCognigyJourneysRemoval/>

<ReleaseNotesWeaviateToQdrant/>
...
- Improved user experience for [creating LLMs](/ai/agents/develop/gen-ai-and-llms/llms#model-types) and also enabled custom models for the LLM providers
- Added support for [`text-embedding-3-large`](/ai/agents/develop/gen-ai-and-llms/model-support-by-feature), which can be hosted on either OpenAI or Microsoft Azure. Now, you can use [these embeddings for NLU training and scoring](/ai/platform-features/nlu/external/nlu-connectors/overview)
