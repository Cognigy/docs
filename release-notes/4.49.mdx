---
title: email notification authentication secret.
sidebarTitle: '4.49'
...
- Added a [search bar](/insights/explorers/conversations) in the step filter in Transcript Explorer
...
- Added [LiveAgentEscalations](/ai/agents/analyze/odata#liveagentescalations) to Cognigy OData Collections
...
This release contains security updates for Redis and RabbitMQ. Note that both Redis Pods and the RabbitMQ Pod in your Kubernetes cluster will restart. While the restart is in progress, Cognigy and Cognigy Insights will be unavailable.
