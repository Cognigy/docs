...
<Warning>
  ...
  - The [`GET /v2.0/profiles`](/api-reference/contact-profiles/get-contact-profiles) API method has been deprecated. The removal is planned for Cognigy.AI 2026.24.0. Use [`GET /v2.1/profiles`](/api-reference/contact-profiles/get-contact-profiles-performance) instead for improved performance when retrieving Contact Profiles.
