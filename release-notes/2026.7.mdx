...
<Warning>
  ...
  - The States in the Interaction Panel, States functions, and States API methods have been deprecated. The removal is planned for Cognigy.AI 2026.12.0. Delete your States and retrain your NLU model before the removal. Use [Intent Conditions](/ai/platform-features/nlu/intents/conditions) as an alternative for controlling Intent recognition.
...
Introduced the [NiCE CXone](/ai/escalate/handover-reference/nice-cxone/nice-cxone-integrated) handover provider, allowing end users to hand over their conversations from an AI Agent to a human agent in a contact center. This feature is available for Cognigy.AI installations integrated with NiCE CXone.
