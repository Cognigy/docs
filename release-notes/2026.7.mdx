...
<Warning>
  ...
  - The [States](/ai/agents/test/interaction-panel/state) in the Interaction Panel, [States functions](/ai/for-developers/function-reference/states/overview), and [States API methods](/api-reference/states/get-states) have been deprecated. The removal is planned for Cognigy.AI 2026.12.0. Delete your States and retrain your NLU model before the removal. Use [Intent Conditions](/ai/platform-features/nlu/intents/conditions) as an alternative for controlling Intent recognition.
