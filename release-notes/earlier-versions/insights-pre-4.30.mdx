...
- Fixed a bug where Message Explorer had 2 scroll bars which caused invalid infinite loader behavior
...
- Fixed a bug where Step Explorer mistakenly does not display newly tracked steps, if there is already a cached version of today's report
