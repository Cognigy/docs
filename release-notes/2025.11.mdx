...
<Warning>
  ...
  - The [Intent Sentence Generation, Lexicon Generation, Flow Generation, Adaptive Card Generation](/ai/agents/develop/gen-ai-and-llms/generative-ai#generate-cognigyai-resources) lists in the Project settings were deprecated in April 2025 and will be removed in Cognigy 2025.13.0. After the removal, select the LLM for all these features from the [Design-Time Generative LLM Features list](/ai/agents/develop/gen-ai-and-llms/generative-ai#design-time-generative-ai-features).
