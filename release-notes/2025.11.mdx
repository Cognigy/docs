...
<Warning>
  - As of April 2025, the [Insights Beta API](https://api-trial.cognigy.ai/openapi#get-/insights/beta/messages/report/-queryHash-) is deprecated. The full removal is planned for Cognigy.AI 2025.12.0. After the removal, use the [Cognigy.AI OData endpoint](/ai/agents/analyze/odata) instead.
  - As of April 2025, the [Intent Sentence Generation, Lexicon Generation, Flow Generation, Adaptive Card Generation](/ai/agents/develop/gen-ai-and-llms/generative-ai#generate-cognigy-ai-resources) lists in the Project settings are deprecated. The full removal is planned for Cognigy.AI 2025.13.0. After the removal, select the LLM for all these features from the [Design-Time Generative LLM Features list](/ai/agents/develop/gen-ai-and-llms/generative-ai#design-time-generative-ai-features).
