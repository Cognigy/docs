...
- Improved compatibility with [Anthropic models](/ai/agents/develop/gen-ai-and-llms/providers/anthropic) that don't support sampling parameters. Now, Cognigy removes unsupported `temperature`, `top_p`, and `top_k` parameters before sending the request
...
- Renamed AI Copilot Workspace to Agent Copilot Workspace in the [Profile](/live-agent/profile-settings) and [Account](/live-agent/settings/account-settings) settings for consistency with the Cognigy interface
