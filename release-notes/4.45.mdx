...
- Added the opportunity for human agents to [create hyperlinks](/live-agent/conversation/send-reply#send-replies-to-users) and sent the hyperlinked text in the conversation chart
