...
- Added the Include Rich Media Context option to the [AI Agent](/ai/agents/develop/node-reference/ai/ai-agent#ai-agent-settings), [LLM Prompt](/ai/agents/develop/node-reference/service/llm-prompt#llm-prompt-settings), and [Get Transcript](/ai/agents/develop/node-reference/service/get-transcript#parameters) Nodes. With this option, you can provide either structured content or textual description to AI Agents as more context for rich media like Text with Buttons and Quick Replies
