...
<Warning>
  The Cognigy.AI OData interfaces 2.0 and 2.2 have been deprecated. These interfaces will be removed in Cognigy.AI 4.48.0. Migrate to OData 2.3 before the removal date.
</Warning>
