---
title: 4.42 - Happy New Year ✨
---

<Warning>
  Live Agent Lite, also known as Livechat, is an outdated product that is no longer receiving updates or support. As such, all references to this product will be removed in future versions of Cognigy. We strongly recommend upgrading to Cognigy Live Agent, the successor of Live Agent Lite.
</Warning>

<Warning>
  The Cognigy OData interfaces 2.0 and 2.2 have been deprecated. These interfaces will be removed in Cognigy 4.48.0. Migrate to OData 2.3 before the removal date.
</Warning>
...
- Added a [Data Expiration indicator](/insights/data-management/data-expiration) in the upper-right corner of the Insights interface
