---
title: "4.43 - Happy National Pie Day \U0001F967"
hidden: false
---
...
- Once an Intent is found with high confidence, the mapping between it and its child Intents may still be ambiguous. The [Intent Mapping Priority](/ai/platform-features/nlu/intents/intent-hierarchy/intent-mapping-priority) functionality allows users to specify whether it should be more likely that the parent or child Intent is predicted.
