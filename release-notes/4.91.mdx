...
- Added the `da-DK-Standard-F` and `da-DK-Standard-G` voices when using [Google Speech Services for Text to Speech](/ai/agents/test/voice-preview#configure-speech-provider)
