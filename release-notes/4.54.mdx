...
import ReleaseNotesK8cSupport from '/snippets/release-notes/k8c-support.mdx'
...
- Improved stability of the Cognigy and Cognigy Voice Gateway connection by adding an additional healthcheck between both products
...
- Modified the tooltip styles to align with the tooltips in Cognigy
...
(CRDs) of Traefik.
Replace `<namespace>` with the namespace in which Cognigy or Cognigy Voice Gateway is running.
