...
This release of Cognigy adds support for rich media elements for the WhatsApp Cloud channel. You will now have the chance to output Locations, Contacts and Rich Links as part of our Say-Node in the Flow-Editor when specifying outputs for the WhatsApp Cloud channel.
...
- Fixed a bug that leads to a crash as soon as there was an executeFlow node with parseSlots enabled
...
- Fixed a bug when unsupported WhatsApp input data was not passed to the flow
...
- Add the possibility to edit contact profiles by agents directly in the conversation information section, the change will be reflected in Cognigy as well
