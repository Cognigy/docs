...
- Redesigned the [Transcript Explorer](/insights/explorers/conversations)
...
- Fixed the issue where a user accessing Live Agent with a URL from a different Cognigy organization URL was not able to log in using the right account
