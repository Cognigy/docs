...
- Improved reconnection behavior. Voice Gateway now reconnects faster and more reliably when it temporarily loses its connection to Cognigy
...
#### Cognigy + Insights + Agent Copilot + AI Ops Center

##### Activate AI Ops Center

The activation process depends on the installation type:

- **SaaS.** All clusters include the Cognigy monitoring stack by default. Contact your Customer Success Manager to activate AI Ops Center.
