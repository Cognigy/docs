...
- Removed the Knowledge Search Node. Instead, the [Search Only Mode](/ai/agents/develop/node-reference/other-nodes/search-extract-output) of the Search Extract Output Node should be used
