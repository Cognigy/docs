...
- Introduced [new global roles](/ai/administer/access/admin-center/access-control#global-roles), specifically designed for support purposes. These roles are: `fullSupportUser`, `basicSupportUser`, `projectAssigner`
