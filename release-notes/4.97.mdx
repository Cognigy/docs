...
Added Deepgram as a voice provider to the [Voice Preview](/ai/agents/test/voice-preview#configure-speech-provider) feature, enabling you to test your voice AI Agent using your Deepgram credentials in the Interaction Panel.
