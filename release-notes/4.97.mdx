...
<Warning>
  ...
  - On April 1, 2025, [Insights Beta API](https://api-trial.cognigy.ai/openapi#get-/insights/beta/messages/report/-queryHash-) will be deprecated. Instead, use the [Cognigy OData endpoint](/ai/agents/analyze/odata).
