...
Added Deepgram as a voice provider to the [Voice Preview](/ai/agents/test/voice-preview#set-up-a-voice-preview-provider) feature, enabling you to test your voice AI Agent using your Deepgram credentials in the Interaction Panel.
