...
- Fixed the connection between Cognigy and Voice Gateway, ensuring Mute Speech Input prevents speech barge-in. This update complements the fix from [Voice Gateway patch 2026.6.2](#2026-6-2). To resolve this issue, make sure you update Cognigy to this version and Voice Gateway to 2026.6.2
...
- Added OAuth2 authentication support to the Cognigy API
