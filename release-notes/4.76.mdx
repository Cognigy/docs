...
- Added [Intent descriptions](/ai/platform-features/nlu/external/intent-reranking) to the `input.nlu.scores` object to improve intent ranking
...
- Renamed Agent to Project in the Cognigy UI

#### Bug Fixes

- Fixed the issue where the host header for the Cognigy UI was not validated
