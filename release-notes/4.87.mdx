...
- Added the capability to [configure queue updates for Live Agent](/live-agent/conversation/conversation-queue/real-time-queue-notifications) in the [Handover to Agent Node](/ai/agents/develop/node-reference/service/handover-to-agent) settings
