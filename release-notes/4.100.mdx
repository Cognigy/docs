...
- Added [backward compatibility](/ai/agents/analyze/goals-and-tasks/tasks#compatibility-alias-to-profiletasks) for `profile.goals`. Now, `profile.goals` points to `profile.tasks`, ensuring compatibility with all Flows
