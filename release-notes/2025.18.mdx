...
- Removed the Beta flag from the new [Handover Providers](/ai/escalate/migration) interface
...
- Fixed the issue in the Cognigy API documentation. Now, GET APIs show the response for the `next` and `previous` cursors
...
- With [version 3.29.1](https://github.com/Cognigy/Webchat/releases/tag/v3.29.1), Webchat v3 is now officially available as an [npm package](/webchat/v3/embedding/npm). This change makes it easier for developers to integrate, update, and manage Webchat v3 in modern web applications.
