---
title: "4.47 - Happy Math Day \U0001F9EE"
---
...
- Added the Soniox speech provider to the Voice Gateway web application and to Cognigy voice Nodes
...
- Migrated the ClamAV Image to the one used and maintained by Cognigy. To do that, set the `pullSecretName` value in the `values.yaml` file. This migration was necessary as the previous ClamAV image for Live agent has been deprecated
