...
This release of Cognigy brings the following changes to the Cognigy cluster:
...
Starting from this release, you need to follow the rollback instructions below if you want to revert Cognigy to a version older than 4.60:
