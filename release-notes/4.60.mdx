...
- Added [Plug-and-Play Widgets](/agent-copilot/plug-and-play-widgets) to improve the Agent Assist Workspace Experience with Next Action Assist, Sentiment Assist, Transcript Assist and Identity Assist
