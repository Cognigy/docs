...
- Fixed the issue of disconnect events not being sent when the [Async Mode](/ai/agents/deploy/endpoint-reference/audiocodes#async-mode) setting was enabled in the AudioCodes Endpoint
