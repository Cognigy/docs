...
This release of Cognigy adds French as a new language in our Cognigy user interface
...
- Improved by adding status colors for notifications shown while actions are performed, such as updating settings or assigning conversations
