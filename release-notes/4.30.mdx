...
This release of Cognigy contains the new WhatsApp Cloud API endpoint,
...
- Fixed a bug where deleting the user from Cognigy will also delete the user from LiveAgent
...
- Add Cognigy channel to the conversation information section and also add the possibility to filter conversations based on this field
