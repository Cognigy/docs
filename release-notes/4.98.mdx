...
<Warning>
  ...
  - [Insights Beta API](https://api-trial.cognigy.ai/openapi#get-/insights/beta/messages/report/-queryHash-). Instead, use the [Cognigy.AI OData endpoint](/ai/agents/analyze/odata).
...
- Renamed Goals to Tasks in the [Contact Profile](/ai/agents/analyze/contact-profiles) to standardize naming conventions across Cognigy.AI
