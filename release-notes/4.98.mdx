...
<Warning>
  ...
  - In September, 2025, OData v2.3 will be deprecated. Before this date, ensure a smooth transition by switching to the [Cognigy.AI OData v2.4](/ai/agents/analyze/odata#supported-versions).
