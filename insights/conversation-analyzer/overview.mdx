...
<a href="/release-notes/2026.18"><Badge className="version-badge" color="purple">Added in 2026.18 (beta)</Badge></a>
...
- Conversation Analyzer doesn't support the following models:
    ...
    - Microsoft Azure OpenAI — `gpt-5-6-sol`, `gpt-5-6-terra`, `gpt-5-6-luna`
    - Anthropic — `claude-sonnet-4-6`
    - Google GenAI — `gemini-3.5-flash`, `gemini-3.6-flash`, `gemini-3.7-flash`, `gemini-3.1-flash-lite`, `gemini-3.1-pro-preview`, `gemini-3-flash-preview`
