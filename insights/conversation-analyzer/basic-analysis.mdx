...
keywords: ['conversation analyzer', 'Basic Analysis', 'customer sentiment', 'containment', 'ai behavior', 'agent experience', 'cognigy insights']
...
| Tool Usage Correctness | Shows how correctly the AI Agent uses tools in conversations, based on the transcript. The Conversation Analyzer doesn't access underlying tool specifications or actual API responses. |
