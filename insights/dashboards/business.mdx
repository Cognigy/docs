...
<Frame>
  <img class="image-center" src="/_assets/insights/dashboards/active-sessions.png" alt="Bar chart comparing sessions handled by AI Agents versus those escalated to human agents" style={{ width: 'auto' }} />
</Frame>
