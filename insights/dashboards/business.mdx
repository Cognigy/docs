...
description: Monitor real-time session metrics, location activity, active AI and human agent data, and business outcomes.
...
<div style={{ textAlign: 'center' }}>
  <video 
    ...
    aria-label="The video shows the Business dashboard: a rotating globe displaying session activity by city and country, a list of top session locations, an active sessions indicator, and metrics for time saved, cost savings, revenue earned, and top goals."
...
<div style={{ textAlign: 'center' }}>
  <video 
    ...
    height="400" 
    controls 
    title="Interactive session map showing geographical distribution of conversations"
    aria-label="The video shows a rotating 3D globe with bars marking session volume at each location, updating in real time as conversations occur."
    style={{ border: '1px solid #ccc', borderRadius: '12px' }} 
    autoPlay
  >
...
If a city or country is marked as `Unknown`, it means Insights couldn't determine where the session occurred.
...
<Frame>
  <img src="/_assets/insights/dashboards/active-sessions.png" alt="Bar chart comparing sessions handled by AI Agents versus those escalated to human agents" style={{ width: 'auto' }} />
</Frame>
