...
description: Learn how to export Cognigy Insights data as CSV files for analysis in Excel or databases, covering overview, engagement, NLU, and live agent charts.
keywords: ['download reports', 'csv export', 'insights analytics', 'data export', 'report download']
---
...
1. Go to Insights and select one of the previously mentioned reports in the side menu bar on the left side.
2. Click ![menu](/_assets/icons/black-and-white/vertical-ellipsis.svg) in the top right corner of a report chart you want to get as a report. 
