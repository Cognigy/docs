---
title: Goals
description: Track AI Agent goal completion, time savings, cost savings, and revenue impact with the Insights Goals report. Requires the new Insights framework.
keywords: ['goals report', 'goal tracking', 'cost savings', 'ai agent performance', 'business metrics']
---
...
<a href="/release-notes/2026.14"><Badge className="version-badge" color="purple">Updated in 2026.14</Badge></a>
...
<Frame>
  <img src="/_assets/insights/reports/goals/goals-report.webp" alt="Goals report showing completion status, time saved, cost savings, and revenue metrics" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
  <img src="/_assets/insights/reports/goals/goals-performance.png" alt="Bar chart showing goal completion counts broken down by incomplete, partial, and total" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
  <img src="/_assets/insights/reports/goals/time-saved.png" alt="Bar chart displaying hours saved per goal over the selected time span" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
  <img src="/_assets/insights/reports/goals/cost-savings.png" alt="Bar chart displaying cost savings per goal over the selected time span" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
  <img src="/_assets/insights/reports/goals/revenue-earned.png" alt="Bar chart displaying revenue earned per goal over the selected time period" style={{ width: 'auto' }} />
</Frame>
