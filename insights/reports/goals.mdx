...
<a href="/release-notes/4.94"><Badge className="version-badge" color="blue">Added in 4.94</Badge></a>

<Note>
  The Goals Report is available if you have migrated to the new [Insights framework](/insights/data-management/pre-aggregation).
