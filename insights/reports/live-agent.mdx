---
title: Live Agent
description: Monitor human agent handovers, response times, resolution rates, and conversation statuses with the Live Agent report in Cognigy Insights.
keywords: ['live agent report', 'insights reports', 'handover to human agent report']
---
...
- Evaluate conversation types based on the assigned label.
...
<Frame>
  <img src="/_assets/insights/reports/live-agent/live-agent-report.png" alt="Live Agent report showing handover metrics, response times, and resolution data" style={{ width: 'auto' }} />
</Frame>
...
- Abandoned — a conversation is closed because the user left the conversation.
...
<Frame>
  <img src="/_assets/insights/reports/live-agent/handover-end-reason.png" alt="Bar chart showing handover end reasons such as abandoned and resolved over time" style={{ width: 'auto' }} />
</Frame>

### Label Summary

Indicates Live Agents labels for categorizing and prioritizing conversations.
...
<Frame>
  <img src="/_assets/insights/reports/live-agent/label-summary.png" alt="Bar chart summarizing conversation labels assigned by human agents" style={{ width: 'auto' }} />
</Frame>
...
The Resolution Time metric refers to the average time of a customer's interaction with a human agent, from the start of the handover sequence until the end of the session.
...
<Frame>
  <img src="/_assets/insights/reports/live-agent/live-agent-performance-times.png" alt="Line chart comparing average first response time and resolution time for human agents" style={{ width: 'auto' }} />
</Frame>
