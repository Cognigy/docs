...
description: Analyze NLU Intent recognition accuracy, execution times, and slot performance for your AI Agent with the Cognigy Insights NLU Performance report.
keywords: ['nlu performance', 'intent recognition', 'execution time', 'ai agent analytics', 'intent scores']
---
...
<Frame>
  <img src="/_assets/insights/reports/nlu/NLU-report.png" alt="NLU Performance report showing intent scores, execution times, and slot metrics" style={{ width: 'auto' }} />
</Frame>
...
Similar to **Top Intents**, this chart displays the top-rated number of Slots in a horizontal bar chart.
...
<Frame>
  <img src="/_assets/insights/reports/top_slots.png" alt="Horizontal bar chart showing the most frequently filled slots" style={{ width: 'auto' }} />
</Frame>
...
you can select the **Go to Intent Trainer** that leads you to the application in Cognigy to improve your Flow.
...
<Frame>
  <img src="/_assets/insights/reports/nlu/NLU_intents_by_score_range.png" alt="Bar chart displaying intent score ranges with minimum, maximum, and average values" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
  <img src="/_assets/insights/reports/nlu/NLU_top_intent_scores.png" alt="Bar chart ranking intents by their confidence scores" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
  <img src="/_assets/insights/reports/nlu/NLU_avg_execution_time.png" alt="Line chart showing average Flow execution time in milliseconds over a time span" style={{ width: 'auto' }} />
</Frame>
