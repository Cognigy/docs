---
title: Engagement
description: Analyze customer interaction metrics, containment rates, session data, and handover performance with the Cognigy Insights Engagement report.
keywords: ['engagement report', 'session metrics', 'containment rate', 'handovers', 'customer interactions']
---
...
- [Heat maps](/insights/reports/engagement#heat-maps)
...
<Frame>
  <img src="/_assets/insights/reports/engagement/engagement-report.png" alt="Engagement report showing session metrics, ratings, and handover data" style={{ width: 'auto' }} />
</Frame>

## Indicators

The Indicator charts display real-time data that refreshes every 30 seconds.

### Tasks reached 

This chart displays the total number of [completed tasks](/ai/agents/develop/node-reference/analytics/complete-task). 
...
<Frame>
  <img src="/_assets/insights/reports/engagement/heatmap.png" alt="Heat map showing handover frequency by time of day and day of week" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
  <img src="/_assets/insights/reports/containment-rate.png" alt="Bar chart showing the containment rate percentage over time" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
  <img src="/_assets/insights/reports/engagement/handovers-on-time.png" alt="Line chart showing the number of handovers to human agents over time" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
  <img src="/_assets/insights/reports/engagement/positive-ratings.png" alt="Line chart showing positive user ratings over time" style={{ width: 'auto' }} />
</Frame>
