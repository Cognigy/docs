...
<Frame>
  <img class="image-center" src="/_assets/insights/global-filters.png" alt="Global filter bar with time span, endpoint, snapshot, and locale options" style={{ width: 'auto' }} />
