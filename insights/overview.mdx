...
<Frame>
  <img class="image-center" src="/_assets/insights/overview.png" alt="Cognigy Insights main interface with reports, explorers, and key metrics" style={{ width: 'auto' }} />
</Frame>
...
Insights operates within individual Cognigy.AI Projects. This allows you to analyze data specific to each Project and switch between Projects seamlessly. However, you cannot compare data across Projects simultaneously.
...
<Frame>
  <img class="image-center" src="/_assets/insights/reports/overview/overview-report.png" alt="Overview report displayed after navigating from Cognigy.AI to Insights" style={{ width: 'auto' }} />
...
<Frame>
  <img class="image-center" src="/_assets/insights/insights-menu.webp" alt="Insights left-side menu listing available reports and explorers" style={{ width: 'auto' }} />
