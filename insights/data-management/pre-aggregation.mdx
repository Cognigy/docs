...
description: Data pre-aggregation in Cognigy Insights pre-computes tables for faster report visualization, reducing query times and enabling instant filter application.
keywords: ['pre-aggregation', 'data aggregation', 'query performance', 'insights framework', 'data refresh']
---
...
An estimated data refresh time will be indicated on your report in the Insights UI and can take up to 2 hours.
