...
import AiUnderstoodMessages from '/snippets/ai/understood-messages.mdx'

<a href="/release-notes/4.59"><img noZoom src="https://img.shields.io/badge/Updated in-v4.59-blue.svg" /></a>
...
- For on-premises installations and dedicated SaaS installations, [set data expiration values](/ai/administer/access/management-ui#expiration-values-ttl-for-sensitive-data) in the [Management UI](/ai/administer/access/management-ui).
