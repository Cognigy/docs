...
2. Select **Create Scenario**. You will be redirected to the Simulator interface, where the Scenario will be created based on the selected transcript. The persona for the scenario will be generated from scratch. Click **Create**, then [follow the instructions](/ai/agents/test/simulator#2-simulate) to run the simulation.
