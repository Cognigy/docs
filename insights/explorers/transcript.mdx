...
<a href="/release-notes/4.97"><img noZoom src="https://img.shields.io/badge/Updated in-v4.98-blue.svg" /></a>
...
For more information, read the [Playbooks](/ai/agents/test/playbooks) documentation.

#### Open Message-Related Flow

To check your [Flow](/ai/agents/develop/projects-and-flows/overview) or to improve the configuration, the Transcript Explorer provides the context menu **Open Flow**.
