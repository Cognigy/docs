...
<Tabs>
  ...
  <Tab title="Via Insights">
    ...
    <Frame>
      <img src="/_assets/insights/explorers/step/step-explorer.png" alt="Step Explorer interface showing annotated conversation steps as columns" style={{ width: 'auto' }} />
    </Frame>
  </Tab>
</Tabs>
## Before you Begin
...
<Frame>
  <img src="/_assets/insights/explorers/step/step-explorer-elements.png" alt="Step Explorer elements including starting steps, step names, and drop-off rates" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
  <img src="/_assets/insights/explorers/step/step-explorer-details.png" alt="Step details tooltip showing Flow name, completion percentage, and visit count" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
  <img src="/_assets/insights/explorers/step/step-explorer-menu.png" alt="Step Explorer right-click context menu with operations like Open Flow and Set as Starting Step" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
  <img src="/_assets/insights/explorers/step/step-explorer-node-example.png" alt="Node-annotated step path from greetings to order confirmation with drop-off rates" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
  <img src="/_assets/insights/explorers/step/step-explorer-intent-example.png" alt="Node and Intent annotated step path showing product selection branches and order completion" style={{ width: 'auto' }} />
</Frame>
