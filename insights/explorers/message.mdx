...
To go back to the filtered top messages again, click ![close](/_assets/icons/black-and-white/X-icon.svg) in the column title labeled with **Current Message**.
...
you can enter keywords in the **![search](/_assets/icons/black-and-white/magnifying-glass.svg) Search** field at the top of the page
...
For more information, read the [Global Filter](/insights/global-filters) documentation. Some additional filters become available when you click **more filters ![filter](/_assets/icons/black-and-white/insight-filter-black.svg)** in the filter bar at the top of the **Message Explorer** page. 
...
click **more filters ![filter](/_assets/icons/black-and-white/insight-filter-black.svg)** in the **Filter Bar** section at the top of the **Message Explorer** page.
