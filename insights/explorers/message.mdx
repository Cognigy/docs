...
keywords: ['message explorer', 'analytics', 'conversation search', 'insights explorer', 'message analysis']
tag: deprecated
---
...
The Message Explorer is an analytics tool in Cognigy Insights that helps you search for specific customer or AI Agent messages within a conversation. It shows messages the user has sent before and after the selected one to provide further context. It complements the [Conversations Explorer](/insights/explorers/conversations), which provides more session-related details and user profile data.
...
<Tabs>
  ...
  <Tab title="Via Insights">
    ...
    <Frame>
      <img src="/_assets/insights/explorers/message/message-explorer.png" alt="Message Explorer interface displaying user and AI Agent messages" style={{ width: 'auto' }} />
    </Frame>
  </Tab>
</Tabs>
## Messages
...
<Note>
  Sessions with personal data masked using the [Delete Profile](/ai/agents/develop/node-reference/analytics/delete-profile) or [Deactivate Profile](/ai/agents/develop/node-reference/analytics/deactivate-profile) Nodes are excluded from the Message Explorer.
</Note>
...
<Frame>
  <img src="/_assets/insights/explorers/message/top-messages.png" alt="Top messages list sorted by frequency in descending order" style={{ width: 'auto' }} />
</Frame>
...
To go back to the filtered top messages again, click ![X-icon](/_assets/icons/black-and-white/X-icon.svg) in the column title labeled with **Current Message**.

<Frame>
  <img src="/_assets/insights/explorers/message/message-explorer_exploring-messages.png" alt="Selected message with prior and following messages shown in three columns" style={{ width: 'auto' }} />
</Frame>
...
you can enter keywords in the **![magnifying glass](/_assets/icons/black-and-white/magnifying-glass.svg) Search** field at the top of the page
...
For more information, read the [Global Filter](/insights/global-filters) documentation. Some additional filters become available when you click **more filters ![insight-filter-black](/_assets/icons/black-and-white/insight-filter-black.svg)** in the filter bar at the top of the **Message Explorer** page. 
...
click **more filters ![insight-filter-black](/_assets/icons/black-and-white/insight-filter-black.svg)** in the **Filter Bar** section at the top of the **Message Explorer** page.
...
- [Step Explorer](/insights/explorers/step)
- [Conversations Explorer](/insights/explorers/conversations)
- [Cognigy Insights Glossary](/insights/glossary)
