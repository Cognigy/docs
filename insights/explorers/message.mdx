...
<Tabs>
  ...
  <Tab title="Via Insights">
    ...
    <Frame>
      <img class="image-center" src="/_assets/insights/explorers/message/message-explorer.png" alt="Message Explorer interface displaying user and AI Agent messages" style={{ width: 'auto' }} />
...
<Frame>
  <img class="image-center" src="/_assets/insights/explorers/message/top-messages.png" alt="Top messages list sorted by frequency in descending order" style={{ width: 'auto' }} />
...
<Frame>
  <img class="image-center" src="/_assets/insights/explorers/message/message-explorer_exploring-messages.png" alt="Selected message with prior and following messages shown in three columns" style={{ width: 'auto' }}/>
