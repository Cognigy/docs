...
<Warning>
  As of Cognigy.AI 2026.5, the `createKnowledgeSource` function is deprecated. For Knowledge Connectors, use [`upsertKnowledgeSource`](/ai/for-developers/knowledge-connector/upsertKnowledgeSource) to create or update Knowledge Sources that also support knowledge synchronization.
</Warning>
