...
<Warning>
  As of Cognigy 2026.5.0, the `createKnowledgeSource` function is deprecated. For Knowledge Connectors, use [`upsertKnowledgeSource`](/ai/for-developers/knowledge-connector/upsertKnowledgeSource) to create or update Knowledge Sources that also support knowledge synchronization.
</Warning>
