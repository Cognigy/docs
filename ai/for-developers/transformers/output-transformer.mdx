...
seo:
  metatags:
    description: >-
      The Output Transformer converts the Flow output before it's sent to the
      Endpoint. This allows you to manipulate the Flow output before it's sent
      to the Endpoint.
keywords: ['output transformer', 'flow output', 'data transformation', 'endpoint integration']
---
