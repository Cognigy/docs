...
"seo":
  "metatags":
    "description": "The Notify Transformer converts the webhook payload from an external service before you call a Notify API request, which sends the data directly to the user."
