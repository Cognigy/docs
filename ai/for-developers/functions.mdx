---
title: Functions
description: "Execute long-running JavaScript functions in Cognigy for async processes like HTTP API calls to third-party systems."
keywords: ['functions', 'javascript', 'api integration']
---

_Functions_ are JavaScript functions that you can define and execute in Cognigy. Use Functions to assist with asynchronous processes, such as interacting with third-party systems through an HTTP API.
...
<Tabs>
  ...
  <Tab title="API">
        You can view, create, edit, and delete Functions using the [Cognigy API](https://api-trial.cognigy.ai/openapi#tag--Functions-v2.0). Using this API, you can also monitor, trigger, and stop a Function instance.
  </Tab>
</Tabs>
