...
| NiCE CXone Environments    | `https://cognigy-api-na1.nicecxone.com/`                                                                                                                                                                                              |
...
Cognigy API includes an OpenAPI documentation that outlines all the different API operations in detail. For example, for the Cognigy trial environment, access `https://api-trial.cognigy.ai/openapi`, and for the NiCE CXone environment, access `https://cognigy-api-na1.nicecxone.com/openapi`.
