...
- For Cognigy.AI v4.100 and earlier, you can download [Snapshots](/ai/agents/deploy/snapshots) up to 100 MB using the Cognigy.AI CLI. In later versions, there's no maximum download size for Snapshots via the CLI.
