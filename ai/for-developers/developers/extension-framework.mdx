...
description: Build custom Cognigy.AI Extensions with TypeScript, including Extension Nodes for integrations and Knowledge Connectors for external knowledge databases.
keywords: ['extension framework', 'custom extensions', 'knowledge connectors', 'custom nodes', 'typescript']
---
