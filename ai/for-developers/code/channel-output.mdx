...
description: Send custom JSON payloads to Channels using Cognigy Code Nodes. Covers api.output and api.say for Webchat, Messenger, and other channels.
...
<AccordionGroup>
  <Accordion title="AI Default Channel">
    The Cognigy default channel has a specific channel format which you can find more about at [AI default channel format](/ai/for-developers/code/ai-default-channel-formats).
  </Accordion>
