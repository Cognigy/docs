...
description: Send custom JSON payloads to Channels using Cognigy.AI Code Nodes. Covers api.output and api.say for Webchat, Messenger, and other channels.
keywords: ['channel output', 'code node', 'json payload', 'messenger', 'webchat']
---
...
<AccordionGroup>
  <Accordion title="AI Default Channel">
    The Cognigy.AI default channel has a specific channel format which you can find more about at [AI default channel format](/ai/for-developers/code/ai-default-channel-formats).
  </Accordion>
  ...
  <Accordion title="Messenger">
    ...
    For the messenger you can send multiple templates by building a JSON object or by using the **facebook-bot-messenger module**. For further information go to their [GitHub Page](https://github.com/snlangsuan/facebook-bot-messenger#readme).
  ...
  <Accordion title="LINE">
    [LINE Messaging API](https://developers.line.me/en/reference/messaging-api/#template-messages)
  ...
  <Accordion title="RingCentral Engage">
