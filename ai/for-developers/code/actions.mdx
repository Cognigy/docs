...
<AccordionGroup>
  ...
  <Accordion title="api.log">
    ...
    **Parameters**
    ...
    | Parameter | Type   | Description                                                                                                                                                                                                                                                                                                                                    |
    |-----------|--------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
    | level     | string | The log level. Cognigy.AI includes the following log levels: <ul><li>`info` — contains general information about the normal operation of a Flow.</li><li>`error` — contains information about errors that occur during Flow execution.</li><li>`debug` — contains detailed information about Flow execution for debugging purposes.</li></ul>  |
