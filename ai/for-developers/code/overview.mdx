...
description: "Execute custom JavaScript or TypeScript code within Cognigy Flows using Code Nodes with IntelliSense support."
...
The `api` object provides access to most internal Cognigy functions within the Code Node. For more information, refer to [API Functions](/ai/for-developers/code/api-functions).
