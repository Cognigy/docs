...
The `api` object provides access to most internal Cognigy.AI functions within the Code Node. For more information, refer to [API Functions](/ai/for-developers/code/actions).
...
You can send Facebook JSON directly from within Code Nodes using the [output](/ai/for-developers/code/actions) action.
...
- [API Functions](/ai/for-developers/code/actions)
