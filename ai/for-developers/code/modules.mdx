---
title: Modules
description: Reference for npm modules available in Cognigy Code Nodes, including Moment.js, Lodash, and other preinstalled packages for data manipulation.
keywords: ['modules', 'npm modules', 'lodash', 'moment.js', 'code node']
---
...
<AccordionGroup>
  ...
  <Accordion title="Lodash">
    [Lodash Documentation](https://lodash.com/docs/4.17.10)

    Cognigy also supports the utility library Lodash within Code Nodes.
  ...
  <Accordion title="Messenger Platform">
  ...
  <Accordion title="Text Cleaner">
    **Usage**
    ---
    Within a Code Node, you can invoke the `getTextCleaner` function, which retrieves an instance of the [Text Cleaner](/ai/platform-features/nlu/text-cleaner) class. 
