---
title: Modules
description: Reference for npm modules available in Cognigy.AI Code Nodes, including Moment.js, Lodash, and other preinstalled packages for data manipulation.
