...
seo:
  metatags:
    description: 'removeFromContext removes data from the Context object: either a
      key-value entry or a specific value within an array stored under that key.'
keywords: ['removeFromContext', 'context object functions']
---
