...
keywords: ['getExecutionAmount', 'execution control functions']
seo:
  metatags:
    description: getExecutionAmount returns the number of times the Node with the given nodeId has been executed in the current conversation.
---
