...
keywords: ['say', 'output', 'input and output functions']
---
...
<AccordionGroup>
  <Accordion title="Send a Simple Text Message">
  ...
  <Accordion title="Send Structured Content: Text and Quick Replies">
  ...
  <Accordion title="Send Structured Content: Carousel">
  ...
  <Accordion title="Send a Message Only to the Human Agent">
