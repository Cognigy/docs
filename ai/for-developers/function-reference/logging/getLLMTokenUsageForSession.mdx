...
seo:
  metatags:
    description: getLLMTokenUsageForSession retrieves the token usage information
      for the current session.
keywords: ['getLLMTokenUsageForSession', 'logging functions']
---
...
<Accordion title="TSessionUsageInformation object">
