...
<AccordionGroup>
  <Accordion title="1. Add Handover to Agent Node">
    ...
    <Frame>
       <img class="image-center" src="/_assets/ai/escalate/handover-reference/scenarios/1-handover-event-settings.png" style={{ width: 'auto' }} />
    </Frame>
  </Accordion>
  ...
  <Accordion title="2. Configure Lookup Node">
    ...
    2. Open a Node editor by clicking the Node, then go to the **Type** setting, select **Handover Status** from the list. Save changes.
        <Frame>
            <img class="image-center" src="/_assets/ai/escalate/handover-reference/scenarios/2-handover-lookup.png" style={{ width: 'auto' }} />
        </Frame>
    3. Go to the child Nodes:<br/>
        ...
        <Frame>
            <img class="image-center" src="/_assets/ai/escalate/handover-reference/scenarios/3-handover-child-lookup.png" style={{ width: 'auto' }} />
        </Frame>
        ...
        <Frame>
            <img class="image-center" src="/_assets/ai/escalate/handover-reference/scenarios/4-handover-second-child-lookup.png" style={{ width: 'auto' }} />
        </Frame>
  ...
  <Accordion title="3. Set Inactivity Time">
    ...
    4. Repeat the same steps for the **active** child Node in case you want to detect and handle inactivity during active handovers.
        ...
        <Frame>
            <img class="image-center" src="/_assets/ai/escalate/handover-reference/scenarios/5-set-handover-inactivity.png" style={{ width: 'auto' }} />
        </Frame>
  ...
  <Accordion title="4. Loop Back">
    ...
    <Frame>
       <img class="image-center" src="/_assets/ai/escalate/handover-reference/scenarios/6-handover-go-to.png" style={{ width: 'auto' }} />
    </Frame>
  </Accordion>
  ...
  <Accordion title="5. Handle Inactivity">
    ...
    <Frame>
       <img class="image-center" src="/_assets/ai/escalate/handover-reference/scenarios/7-handover-if.png" style={{ width: 'auto' }} />
    </Frame>
  </Accordion>
