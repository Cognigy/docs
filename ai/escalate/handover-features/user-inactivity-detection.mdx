...
<AccordionGroup>
  <Accordion title="1. Add Handover to Human Agent Node">
    ...
    <Frame>
       <img src="/_assets/ai/escalate/handover-reference/scenarios/1-handover-event-settings.png" alt="Handover to Human Agent Node event settings with queue and active events" style={{ width: 'auto' }} />
    </Frame>
  </Accordion>
  ...
  <Accordion title="2. Configure Lookup Node">
    ...
    2. Open a Node editor by clicking the Node, then go to the **Type** setting, select **Handover Status** from the list. Save changes.
        <Frame>
            <img src="/_assets/ai/escalate/handover-reference/scenarios/2-handover-lookup.png" alt="Lookup Node configured with Handover Status type" style={{ width: 'auto' }} />
        </Frame>
    3. Go to the child Nodes:<br/>
        ...
        <Frame>
            <img src="/_assets/ai/escalate/handover-reference/scenarios/3-handover-child-lookup.png" alt="Case Node with active handover status value" style={{ width: 'auto' }} />
        </Frame>
        ...
        <Frame>
            <img src="/_assets/ai/escalate/handover-reference/scenarios/4-handover-second-child-lookup.png" alt="Case Node with queue handover status value" style={{ width: 'auto' }} />
        </Frame>
  ...
  <Accordion title="3. Set Inactivity Time">
    ...
    4. Repeat the same steps for the **active** child Node in case you want to detect and handle inactivity during active handovers.
        ...
        <Frame>
            <img src="/_assets/ai/escalate/handover-reference/scenarios/5-set-handover-inactivity.png" alt="Set Handover Inactivity Node with timeout configuration" style={{ width: 'auto' }} />
        </Frame>
  ...
  <Accordion title="4. Loop Back">
    ...
    <Frame>
       <img src="/_assets/ai/escalate/handover-reference/scenarios/6-handover-go-to.png" alt="Go To Node configured to return to the Lookup Node" style={{ width: 'auto' }} />
    </Frame>
  </Accordion>
  ...
  <Accordion title="5. Handle Inactivity">
    ...
    <Frame>
       <img src="/_assets/ai/escalate/handover-reference/scenarios/7-handover-if.png" alt="If Node handling inactivity with Say and Close Handover Nodes" style={{ width: 'auto' }} />
    </Frame>
  </Accordion>
