...
The **Handover Providers** section in the [Endpoint settings](/ai/agents/deploy/endpoints/handover-settings) was deprecated in 4.97, with removal planned for the end of October 2025.
