...
description: "Migrate the legacy Endpoint handover provider settings to the new Handover Provider Settings interface in Cognigy."
...
"seo": {
  "metatags": {
    "description": "Starting from Cognigy 4.97, you can migrate your handover provider settings to a new interface that provides more flexibility and better organization."
  }
}
---
...
In 2026.16.0, the **Handover Providers** section in the Endpoint settings was removed.

If you are using version 2026.15 or earlier, migrate your handover provider settings before upgrading to 2026.16.0. The new interface provides more flexibility and improved organization for managing contact center integrations.

Follow this guide to migrate your handover provider settings to the new interface.
