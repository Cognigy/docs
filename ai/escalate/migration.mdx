...
The **Handover Providers** section in the [Endpoint settings](/ai/agents/deploy/endpoints/handover-settings) was deprecated in 4.97, with removal planned for the end of January 2026.

Starting from Cognigy.AI 4.97, you can migrate your handover provider settings to a new interface that offers more flexibility and better organization for managing integrations with contact centers.
