...
The handover happens through the [Handover to Agent Node](/ai/agents/develop/node-reference/service/handover-to-agent) within a Flow,
...
- [Compatible contact center and its connector](/ai/escalate/handover-reference/overview)
- [Endpoint that supports handovers](/ai/agents/deploy/endpoints/handover-settings)

Cognigy.AI offers a range of tools to manage this escalation effectively:

- Nodes:
    - [Handover to Agent](/ai/agents/develop/node-reference/service/handover-to-agent) — initiates the transfer to a human agent.
    - [Check Agent Availability](/ai/agents/develop/node-reference/service/check-agent-availability) — verifies if human agents are free to take over.
