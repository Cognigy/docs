...
<Frame>
  <img class="image-center" src="/_assets/ai/develop/node-reference/agent-copilot/knowledge-tile-flow.webp" alt="Agent Copilot Flow with Knowledge Tile and other Copilot Nodes" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
  <img class="image-center" src="/_assets/ai/escalate/agent-copilot-standalone.png" alt="Agent Copilot standalone workspace in a browser" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
  <img class="image-center" src="/_assets/ai/escalate/agent-copilot-embedded.png" alt="Agent Copilot tiles embedded in a contact center platform" style={{ width: 'auto' }} />
</Frame>
