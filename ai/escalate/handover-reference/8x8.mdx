---
title: 8x8
keywords: ['contact centers', '8x8', 'handover provider']
seo:
  metatags:
    description: >-
      The 8x8 handover provider bridges Cognigy and 8x8, enabling end users
...
<Frame>
  <img src="/_assets/ai/escalate/handover-reference/8x8.svg" alt="8x8 handover provider logo"/>
</Frame>

## Description

The 8x8 handover provider bridges Cognigy and [8x8](https://www.8x8.com/),
...
- Created Endpoint [compatible with 8x8](/ai/escalate/handovers#endpoints-compatible-with-handover-providers).
...
<AccordionGroup>
  ...
  <Accordion title="2. Configure Handover Settings">
    In the [Handover to Human Agent](/ai/agents/develop/node-reference/service/handover-to-agent) Node, select **8x8** in the **Handover Provider** list, and configure the following fields:
