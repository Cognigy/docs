...
description: Connect Cognigy to Genesys Cloud using Genesys Cloud Guest Chat handover.
keywords: ['genesys cloud', 'guest chat', 'handover', 'live agent handoff', 'contact center']
---
...
<Frame>
  <img src="/_assets/ai/escalate/handover-reference/genesys.svg" alt="Genesys Cloud Guest Chat handover provider logo" />
  <img src="/_assets/ai/escalate/handover-reference/genesys-dark.svg" alt="Genesys Cloud Guest Chat handover provider logo" />
</Frame>
...
The Genesys Cloud Guest Chat handover provider bridges Cognigy and [Genesys](https://login.mypurecloud.com/),
...
- Created Endpoint [compatible with Genesys Cloud Guest Chat](/ai/escalate/handovers#endpoints-compatible-with-handover-providers).
...
<AccordionGroup>
  ...
  <Accordion title="2. Configure Handover Settings">
    In the [Handover to Human Agent](/ai/agents/develop/node-reference/service/handover-to-agent) Node, select **Genesys Guest Chat** in the **Handover Provider** list, and configure the following fields:
