...
<Frame>
  <img class="image-center" src="/_assets/ai/escalate/handover-reference/chatwoot/chatwoot.svg" alt="Chatwoot handover provider logo" style={{ width: '200px' }} />
</Frame>
...
<AccordionGroup>
  ...
  <Accordion title="2. Set Up a Webhook for Inbox">
    ...
    6. Assign an agent to the inbox by selecting them and clicking **Add agents**.
      ...
      <img class="image-center" src="/_assets/ai/escalate/handover-reference/chatwoot/inbox-create-api-channel-edit.png" alt="Chatwoot API channel creation with webhook URL configuration" style={{ width: 'auto' }} />
