...
<AccordionGroup>
    <Accordion title="Send Genesys Bot Messages to End Users">
      ...
      <Frame>
        <img src="/_assets/ai/escalate/handover-reference/genesys/genesys-flow-sample.png" alt="Cognigy.AI Flow with Lookup and Go To Nodes for Genesys handover" style={{ width: 'auto' }} />
      </Frame>
