...
<Frame>
  <img class="image-center" src="/_assets/ai/escalate/handover-reference/genesys.svg"/>
</Frame>
...
- Created Endpoint [compatible with Genesys Cloud Open Messaging](/ai/agents/deploy/endpoints/handover-settings#endpoints-compatible-with-handover-providers).
...
<AccordionGroup>
  ...
  <Accordion title="2. Configure Handover Settings">
    ...
    - **Include Agent Profile Details in Chat** — display the human agent's information such as name and profile image to the end user in the chat. The parameter is disabled by default.
...
<Accordion title="Send Genesys Bot Messages to End Users">
  ...
  1. In your chosen Handover Flow, set a **Lookup** Node below the **Handover to Human Agent** Node. Set **Lookup** Node as your Entrypoint.
  ...
  <Frame>
    <img class="image-center" src="/_assets/ai/escalate/handover-reference/genesys/genesys-flow-sample.png" style={{ width: 'auto' }} />
  </Frame>
