...
<a href="/release-notes/4.100"><img noZoom src="https://img.shields.io/badge/Updated in-v4.100-blue.svg" /></a>


<Frame>
  <img class="image-center" src="/_assets/ai/escalate/handover-reference/genesys.svg" style={{ width: 'auto' }} />
</Frame>
...
<AccordionGroup>
  ...
  <Accordion title="2. Configure Handover Settings">
    In [Handover to Agent](/ai/agents/develop/node-reference/service/handover-to-agent) Node, configure the following settings:
