...
<Accordion title="2. Add a Handover to Human Agent Node">
    ...
    4. _(Optional)_ Configure additional settings:
        ...
        - **Custom Attributes** — add custom attributes, which allows you to include additional information. When sending custom attributes from Cognigy to NiCE CXone, you can enter them in two ways:
