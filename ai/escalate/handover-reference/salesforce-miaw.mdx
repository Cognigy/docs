...
seo:
  metatags:
    description: >-
      The Salesforce MIAW handover provider bridges Cognigy.AI and Salesforce
...
The Salesforce MIAW handover provider bridges Cognigy.AI and [Salesforce Messaging for In-App and Web](https://help.salesforce.com/s/articleView?id=service.miaw_intro_landing.htm&type=5),
...
- Created Endpoint [compatible with Salesforce](/ai/agents/deploy/endpoints/handover-settings#endpoints-compatible-with-handover-providers).
...
<AccordionGroup>
  ...
  <Accordion title="Example">
    ...
    grace period of 30 minutes, Cognigy.AI terminates the session on both
