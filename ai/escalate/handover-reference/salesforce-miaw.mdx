...
<a href="/release-notes/2025.17">
  <img noZoom src="https://img.shields.io/badge/Updated in-v2025.17-blue.svg" />
</a>
...
<AccordionGroup>
  ...
  <Accordion title="2. Add a Handover to Agent Node">
    In the **Salesforce Settings** section of the [Handover to Agent](/ai/agents/develop/node-reference/service/handover-to-agent) Node, configure the following settings:
...
<AccordionGroup>
  <Accordion title="Set the Access Token Expiration Time">
    ...
    **Show one more action** and select **Edit** arrow next to the channel you want to configure.
  ...
  <Accordion title="Set the Grace Period">
    ...
    file. - For dedicated SaaS and shared SaaS installations, contact [Cognigy
    Support](/help/get-help).
  </Accordion>
