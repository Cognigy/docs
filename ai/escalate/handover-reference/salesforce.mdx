...
<a href="/release-notes/4.100"><img noZoom src="https://img.shields.io/badge/Added in-v4.100-blue.svg" /></a>


<Frame>
  <img class="image-center" src="/_assets/ai/escalate/handover-reference/salesforce.svg"/>
...
<Accordion title="Configure Salesforce Service Cloud">
  ...
  4. Navigate to **Feature Settings > Service > Embedded Service > Embedded Service Deployments**. In the raw with the deployment you want to use, click ![vertical ellipsis](/_assets/icons/black-and-white/vertical-ellipsis.svg), then select **View**.
