...
<Accordion title="Configure Salesforce Service Cloud">
  ...
  4. Navigate to **Feature Settings > Service > Embedded Service > Embedded Service Deployments**. In the row with the deployment you want to use, click ![vertical ellipsis](/_assets/icons/black-and-white/vertical-ellipsis.svg), then select **View**.
