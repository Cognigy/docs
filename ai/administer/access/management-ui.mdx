...
<AccordionGroup>
    <Accordion title="Create an Organization">
        ...
        2. In the **Create new Organisation** window, fill in the following fields:
           ...
           **Business Unit ID** - this field is optional. Provide the Business Unit ID if applicable for NiCE Cognigy billing.
           Click **Create**. The organization will be created with the default settings and appears in the list of organizations.
    ...
    <Accordion title="Change Business Unit ID">
        To change the Business Unit ID for an organization, select **Organisations** from the left-side menu. From the organization list, select the organization you want to change. On the **Organisation Details** page, click ![vertical-ellipsis](/_assets/icons/black-and-white/vertical-ellipsis.svg) and select **Change Business Unit ID**.

        In the **Change Business Unit ID** window, enter the new Business Unit ID and click **Save**.
    </Accordion>
    ...
    <Accordion title="Change Billing Time Zone">
