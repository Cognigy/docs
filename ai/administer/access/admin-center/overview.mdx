...
seo:
  metatags:
    description: >-
      The Admin Center in Cognigy enables users with admin rights to view
...
The *Admin Center* is the central hub in Cognigy that enables users with `admin`<sup>[1](#footnote1)</sup> rights to manage the organization. With the Admin Center, you can monitor key resource metrics, control access, track system events, and manage global resources.
