...
<AccordionGroup>
  <Accordion title="Billable Conversations">
    ...
    <Frame>
      <img class="image-center" src="/_assets/ai/administer/access/billable-conversations.png" alt="Billable conversations chart in the Admin Center Dashboard" style={{ width: 'auto' }} />
    </Frame>
  ...
  <Accordion title="Knowledge AI">
    ...
    <Frame>
      <img class="image-center" src="/_assets/ai/administer/access/knowledge-ai.png" alt="Knowledge AI metrics chart showing queries and chunks usage" style={{ width: 'auto' }} />
    </Frame>
