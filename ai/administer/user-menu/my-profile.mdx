---
"title": "My Profile"
"description": "Manage your Cognigy.AI profile on the My Profile page, including your preferences, API keys, login history, connected accounts, and personal information."
...
<AccordionGroup>
  ...
  <Accordion title="Revoke an API Key">
    ...
    2. Select ![vertical-ellipsis](/_assets/icons/black-and-white/vertical-ellipsis.svg) **Revoke API Key** next to the API key you want to revoke.
