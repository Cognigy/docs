...
description: "Complete the Cognigy.AI pre-installation checklist covering MongoDB Helm chart requirements, Kubernetes cluster setup, and on-premises deployment steps."
