---
title: 'Cognigy: Browser Requirements'
keywords: ['browser requirements', 'supported browsers']
sidebarTitle: Browser Requirements
seo:
  metatags:
    description: >-
      The Cognigy User Interface is compatible with the following browsers:
      Google Chrome, Mozilla Firefox, Microsoft Edge, and Safari.
---

The Cognigy User Interface is compatible with the browsers listed below:
...
- You are using the latest version of one of the Cognigy supported browsers.
