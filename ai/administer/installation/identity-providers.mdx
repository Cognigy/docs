...
- The organization ID of your Cognigy.AI organization, referred to as `<organization-id>` in the examples. You can copy this ID from the [My Profile](/ai/administer/user-menu/my-profile) page by clicking ![menu](/_assets/icons/black-and-white/vertical-ellipsis.svg) **> Copy Organization ID**.
