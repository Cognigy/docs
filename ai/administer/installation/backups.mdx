---
title: Cognigy.AI Secrets Backups
sidebarTitle: Backups
description: Back up Cognigy.AI secrets and stateful data, including MongoDB, Redis, and shared PVs, to support disaster recovery in production.
---
