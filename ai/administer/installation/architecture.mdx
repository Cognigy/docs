---
title: Cognigy.AI Architecture
description: Explore Cognigy.AI's cloud-native microservices architecture, with 30+ containerized services orchestrated by Kubernetes for scalability and reliability.
keywords: ['cognigy.ai architecture', 'microservices', 'kubernetes', 'cloud-native', 'containers']
...
<Frame>
  <img
    ...
    alt="Cognigy.AI microservices architecture diagram" style={{ width: 'auto' }} />
</Frame>
...
While Cognigy Insights is actually also part of Cognigy.AI, it plays a smaller role when talking about the Cognigy.AI core product infrastructure. To learn more, read the [Insights](/insights/overview) documentation.
...
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| service-api            | RESTful API to fully control Cognigy.AI through HTTP calls. Full documentation in the form of an [OpenAPI spec](/ai/for-developers/developers/api-and-cli) is available. Also implements authentication & authorization. Integrations with Identity Providers via our Single Sign On integration. |
