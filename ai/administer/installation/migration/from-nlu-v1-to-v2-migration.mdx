---
title: 'Cognigy NLU: from V1 to V2'
sidebarTitle: 'Cognigy NLU: V1 to V2'
description: Guide for migrating Cognigy NLU from V1 to V2 NLP services on-premises.
---
...
<Note>
  As of Cognigy 4.60.0, the old NLP services are deprecated. We will only provide bug fixes for the old NLP services if they are critical. The old NLP services will be fully deprecated with release 4.64.0, at which point all on-premises customers should have migrated. After the 4.64.0 release, the old NLP services will no longer be available.
</Note>
...
The Cognigy team began deploying the new NLP services with the release **4.54.0** of Cognigy. As a result, we already have significant experience running these services in production and migrating existing AI Agents to use the new services.
...
If you have multiple environments running Cognigy, such as development and production,
...
- Deploy Cognigy version 4.54.0 or higher.
...
**Make sure to apply these changes to all of your Cognigy environments.**
...
<img src="/_assets/ai/installation/grafana-metrics.png" alt="Grafana NLP Orchestrator dashboard showing system latency metrics" />
...
<img src="/_assets/ai/installation/run-job.png" alt="Migration job output showing V1 train groups and project count" />
...
<img src="/_assets/ai/installation/job-failed.png" alt="Migration job results showing successfully migrated and failed models" />
...
<img src="/_assets/ai/installation/clean-up-old-data.png" alt="Clean up job output showing removed and repaired old NLP models" />
...
<img src="/_assets/ai/installation/check-completed-migration.png" alt="Grafana Service NLP dashboard confirming zero traffic on V1 stack" />
