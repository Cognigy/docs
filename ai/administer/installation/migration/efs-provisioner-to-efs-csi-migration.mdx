---
title: Amazon EFS Provisioner to EFS CSI
description: Migrate Cognigy.AI from the deprecated Amazon EFS external provisioner to the Amazon EFS CSI driver.
ignore_macros: true
---

As of Cognigy.AI 4.45.0, the support for the [EFS external provisioner](https://github.com/kubernetes-retired/external-storage) is deprecated. Cognigy.AI supports the [Amazon EFS CSI driver](https://docs.aws.amazon.com/eks/latest/userguide/efs-csi.html) instead.
