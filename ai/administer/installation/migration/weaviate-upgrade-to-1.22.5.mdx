---
title: Weaviate Upgrade to v1.22.5 with Cognigy.AI Release 4.66.0
sidebarTitle: Weaviate Upgrade to v1.22.5
description: Upgrade Weaviate from 1.19.0 to 1.22.5 with Cognigy.AI 4.66.0 to improve Knowledge AI stability.
---
...
Cognigy.AI releases 4.65.0 and earlier use Weaviate 1.19.0 as the vector database for the [Knowledge AI features](/ai/agents/develop/knowledge-ai/overview).
...
- Kubernetes cluster meets general Cognigy.AI [prerequisites](/ai/administer/installation/prerequisites#whitelisting-of-domains), including hardware resources.
