...
seo:
  metatags:
    description: >-
      ...
      Cognigy.AI on-premises installations.
---
...
A new NFS structure has been introduced to clearly and consistently reflect [Cognigy.AI's architecture](/ai/administer/installation/architecture). For now, the old NFS structure is still compatible, but it will be deprecated in the future. For this reason, users should migrate to the current NFS structure.
