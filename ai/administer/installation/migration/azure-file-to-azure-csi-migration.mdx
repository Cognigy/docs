...
description: Migrate Cognigy persistent storage from the deprecated Azure File Provisioner to the Azure CSI driver on Kubernetes 1.25+.
ignore_macros: true
---

As of Kubernetes 1.25, `kubernetes.io/azure-file` is deprecated. Cognigy supports [Azure File Container Storage Interface (CSI)](https://learn.microsoft.com/en-us/azure/aks/azure-files-csi) instead, which replaces the Azure File provisioner. This guide will explain the migration process from Azure File Provisioner to the Azure CSI driver.
