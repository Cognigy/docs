...
description: Learn how to reset Cognigy.AI initial user credentials.
---

In case,
you cannot obtain credentials from logs of `service-security` in the way it is described in the [Cognigy.AI installation process](/ai/administer/installation/installation-process) article,
for example,
because `service-security` service was restarted several times,
or you have deleted and recreated Cognigy.AI installation,
In case you can't obtain credentials from logs of `service-security` as described in the [Cognigy.AI installation process](/ai/administer/installation/installation-process) article, for example, because `service-security` service was restarted several times, or you have deleted and recreated Cognigy.AI installation, you need to drop `service-security` database to generate new initial credentials. 
