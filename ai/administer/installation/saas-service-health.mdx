...
description: Monitor real-time and historical Cognigy SaaS system performance, view past incidents, and subscribe to updates via the SaaS Service Health platform.
keywords: ['saas service health', 'system status', 'incident monitoring', 'cognigy uptime', 'service notifications']
"seo": {
  "metatags": {
...
- Cognigy SaaS. The platform is available at [status.cognigy.ai](https://status.cognigy.ai/).
...
- [Overview](/ai/administer/installation/overview)