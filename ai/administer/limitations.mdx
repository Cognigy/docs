...
| Maximum time until a [simulation Contact Profile](/ai/agents/test/simulator) that hasn’t been read or modified is removed      | 5 days  |
...
UI](/ai/administer/access/management-ui#expiration-values-ttl-for-sensitive-data)
