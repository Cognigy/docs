...
description: "Use the Cognigy Intent Trainer to analyze collected user inputs and add training sentences to Intents, improving NLU recognition accuracy over time."
keywords: ['train intents', 'intent trainer', 'nlu', 'scoring']
---
...
Cognigy offers the *Intent Trainer* feature that allows you to refine AI Agents based on existing dialogs.
This tool improves the AI Agent's understanding by letting you review and add user inputs to [Intents](/ai/platform-features/nlu/intents/overview).
...
<AccordionGroup>
  <Accordion title="Predefined Filters">
  ...
  <Accordion title="Custom Filters">
    ...
    | [Found a Slot](/ai/platform-features/nlu/slots/overview) | View all Slots found based on the selected filter option. By default, **Not Selected** is chosen. You can select one of the following options: <br/><ul><li>**Found Slots** — shows records where a Slot was identified.</li><li>**No Slot Found** — shows records where no Slot was identified.</li></ul>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
<AccordionGroup>
  <Accordion title="Add Records to Intents">
    ...
    <Tabs>
      ...
      <Tab title="API">
        You can add a user input record to a specific Intent using the [Cognigy API POST /v2.0/trainer/batch](https://api-trial.cognigy.ai/openapi#post-/v2.0/trainer/batch) request, specify `"action": "addToIntent"` in the `operations` object.
      
      </Tab>
    </Tabs>
  </Accordion>
  <Accordion title="Skip Records">
    ...
    <Tabs>
      ...
      <Tab title="API">
             You can skip Intent Trainer records using he [Cognigy API POST /v2.0/trainer/batch](https://api-trial.cognigy.ai/openapi#post-/v2.0/trainer/batch) request, specify `"action": "skip"` in the `operations` object.
      </Tab>
    </Tabs>
  </Accordion>
  <Accordion title="Ignore Records">
    <Tabs>
      <Tab title="GUI">
      ...
      <Tab title="API">
        You can skip Intent Trainer records using he [Cognigy API POST /v2.0/trainer/batch](https://api-trial.cognigy.ai/openapi#post-/v2.0/trainer/batch) request, specify `"action": "ignore"` in the `operations` object.
      </Tab>
    </Tabs>
  </Accordion>
</AccordionGroup>
...
<AccordionGroup>
  <Accordion title="Import Records">
    <Tabs>
      <Tab title="GUI">
        1. Go to **Tweak > Intent Trainer**.
        2. In the upper-right corner, click ![menu](/_assets/icons/black-and-white/vertical-ellipsis.svg) **> Import Trainer Records**.
      ...
      <Tab title="API">
        You can import Intent Trainer records using the [Cognigy API POST /v2.0/trainer/upload](https://api-trial.cognigy.ai/openapi#post-/v2.0/trainer/upload) request.
      </Tab>
    </Tabs>
  </Accordion>
  <Accordion title="Export Records">
    <Tabs>
      <Tab title="GUI">
        1. Go to **Tweak > Intent Trainer**.
        2. In the upper-right corner, click ![menu](/_assets/icons/black-and-white/vertical-ellipsis.svg) **> Export Trainer Records**.
      ...
      <Tab title="API">
        You can export Intent Trainer records using the Cognigy API. First, create a file via the [POST /v2.0/trainer/package](https://api-trial.cognigy.ai/openapi#post-/v2.0/trainer/package) request, and then download it via the [POST /v2.0/trainer/downloadlink](https://api-trial.cognigy.ai/openapi#post-/v2.0/trainer/downloadlink).
      </Tab>
    </Tabs>
  </Accordion>
</AccordionGroup>
