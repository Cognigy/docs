...
<AccordionGroup>
  <Accordion title="Import Records">
    <Tabs>
      <Tab title="GUI">
        ...
        2. In the upper-right corner, click ![vertical-ellipsis](/_assets/icons/black-and-white/vertical-ellipsis.svg) **> Import Trainer Records**.
  ...
  <Accordion title="Export Records">
    <Tabs>
      <Tab title="GUI">
        1. Go to **Tweak > Intent Trainer**.
        2. In the upper-right corner, click ![vertical-ellipsis](/_assets/icons/black-and-white/vertical-ellipsis.svg) **> Export Trainer Records**.
