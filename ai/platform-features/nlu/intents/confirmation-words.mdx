...
keywords: ['cognigy nlu', 'confirmation words', 'intents', 'confirmations', 'affirmative words', 'deny words']
seo:
  metatags:
    description: >-
      Cognigy.AI Confirmation Words are a manually defined list of words and
      phrases that the AI Agent recognizes as `yes` or `no` responses.
---
