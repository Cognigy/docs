---
title: Reject Intent
keywords: ['cognigy nlu', 'stop intents', 'reject intents', 'intents']
seo:
  metatags:
    description: >-
      In Cognigy, the Reject Intent feature designed to intentionally prevent
  ...
  <Accordion title="Create a Reject Intent">
    ...
    <Tabs>
      <Tab title="GUI">
        ...
        Under the **Create Intent** button, click ![menu](https://docs.cognigy.com/_assets/icons/black-and-white/vertical-ellipsis.svg) and select **Create 'Reject Intent'**. 
      
      </Tab>
      <Tab title="API">

        You can create a reject Intent using the [Cognigy API /v2.0/flows/{flowId}/intents](https://api-trial.cognigy.ai/openapi#post-/v2.0/flows/-flowId-/intents) request and specifying the `"isRejectIntent": true` parameter.
