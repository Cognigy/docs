...
keywords: ['cognigy nlu', 'intents', 'intent example sentences']
seo:
  metatags:
    description: >-
      Cognigy Intent Example Sentences are phrases that represent the
...
<AccordionGroup>
  ...
  <Accordion title="Delete Intent Sentences">
    ...
    If you need to delete or remove example sentences, you can hover over the sentence and click ![delete sentence](/_assets/icons/black-and-white/recycle-bin.svg).
...
If you don't meet the minimum of 5 example sentences or exceed the maximum of 100, Cognigy shows a warning icon prompting you to adjust the number of sentences. 
