...
keywords: ['intent inheritance mechanism', 'intent hierarchy', 'parent intents', 'child intents']
seo:
  metatags:
    description: >-
      Cognigy.AI Intent Inheritance Mechanism lets parent Intents use example
      sentences from their child Intents.
---
...
- [Intent Mapping Priority](/ai/platform-features/nlu/intents/intent-hierarchy/intent-mapping-priority)
