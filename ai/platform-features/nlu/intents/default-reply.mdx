---
title: Default Reply
keywords: ['cognigy nlu', 'default reply']
seo:
  metatags:
    description: >-
      Cognigy Default Reply feature provides a configurable, Intent-specific
      response triggered when the NLU detects a matching Intent from user input.
---
...
1. A Flow is created in Cognigy with at least one defined Intent.
...
| Output Type                           | Specifies the type of response, supporting the same output types as the [Say Node](/ai/agents/develop/node-reference/basic/say). The default output is **Text**.                                                                                                                                                                                                                                                                                                          |
