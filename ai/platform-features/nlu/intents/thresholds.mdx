---
title: Thresholds
keywords: ['cognigy nlu', 'thresholds']
seo:
  metatags:
    description: >-
      _Thresholds_ are configurable score boundaries used to determine how the
      NLU interprets and classifies user inputs based on their Intent. These
      thresholds help the NLU decide whether an intent is confidently
      recognized, requires reconfirmation, or is not recognized at all.
---
...
The reconfirmation threshold behaves differently depending on whether a [confirmation sentence](/ai/platform-features/nlu/intents/overview#apply-additional-settings) exists in your Intent:
