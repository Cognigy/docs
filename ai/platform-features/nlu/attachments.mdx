---
title: Attachments
keywords: ['flow attachments', 'lexicon attachments', 'child flow', 'add lexicon to flows']
seo:
  metatags:
    description: >-
      Cognigy Attachments allow you to share Flows and Lexicons across
...
<Tabs>
  ...
  <Tab title="API">
         - To a new Flow, use in the [Cognigy API POST /v2.0/flows](https://api-trial.cognigy.ai/openapi#post-/v2.0/flows) request.
         - To an existing Flow, use the [Cognigy API PATCH /v2.0/flows/{flowId}](https://api-trial.cognigy.ai/openapi#patch-/v2.0/flows/-flowId-) request.
