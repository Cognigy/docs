...
DATE Slot detection depends on the time zone you set in the [Project](/ai/administer/access/project-settings#timezone) or through [API functions](/ai/for-developers/code/actions).
