...
description: Learn how Cognigy NLU Slots detect predefined data types and custom phrases, letting AI Agents extract structured information from user input.
