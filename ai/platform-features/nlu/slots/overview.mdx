...
descriptions: >-
  Cognigy Slots are predefined data types or custom phrases detected by the
...
keywords: ['cognigy nlu', 'slots', 'lexicons']
---
...
- [System-Defined](/ai/platform-features/nlu/slots/system-defined) — built-in Slots that Cognigy can use to automatically recognize common data types such as dates, times, numbers, and emails.
