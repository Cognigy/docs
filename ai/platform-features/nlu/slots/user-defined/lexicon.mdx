...
<Frame>
  <img class="image-center" id="specific-image" src="/_assets/ai/empower/nlu/lexicon-editor.png" alt="Lexicon editor with keyphrases, synonyms, slots, and data columns" style={{ width: 'auto' }} />
</Frame>
