---
title: Regex Slots
keywords: ['cognigy nlu', 'slots', 'user-defined slots', 'regular expressions', 'regex slots']
seo:
  metatags:
    description: >-
      In Cognigy.AI, Regex Slots are user-defined Slots, which apply [regular
      expressions](https://regex101.com/) to match and extract specific patterns
      from user inputs.
---
