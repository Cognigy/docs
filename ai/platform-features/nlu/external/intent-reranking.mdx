...
seo:
  metatags:
    description: >-
      Cognigy.AI LLM-based Intent Reranking uses a Large Language Model (LLM) to
...
<AccordionGroup>
  <Accordion title="Add Descriptions to Intents">
    ...
    5. On the **Intent** page, in the upper-right corner, click ![vertical-ellipsis](/_assets/icons/black-and-white/vertical-ellipsis.svg) **> Edit**.
