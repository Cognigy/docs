...
keywords: ['dialogflow', 'external nlu', 'dialogflow connector']
seo:
  metatags:
    description: >-
...
<Warning>
The Dialogflow NLU connector has been deprecated. The removal is planned for January 2028. You can still create and use Dialogflow NLU connectors until the removal date, but no further feature development will occur. Before the removal date, migrate to an alternative NLU connector.
</Warning>

The Dialogflow connector enables integration with [Google Dialogflow](https://cloud.google.com/dialogflow/docs) to use its language understanding results for powering AI Agents in Cognigy.
...
In **Cognigy**, go to **Build > NLU Connectors**,
