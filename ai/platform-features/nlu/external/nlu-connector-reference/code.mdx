---
title: Code
keywords: ['code', 'external nlu', 'code nlu connector', 'custom nlu connector']
seo:
  metatags:
    description: >-
      The Code Connector allows you to use a custom connector by adding your
      JavaScript code to the Transformer section.
---

The Code connector allows
you to integrate an NLU engine that isn't natively supported by Cognigy
...
<Accordion title="Code Example with Description">
