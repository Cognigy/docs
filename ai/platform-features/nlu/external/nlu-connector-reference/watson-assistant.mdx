...
keywords: ['watson assistant', 'external nlu', 'watson assistant nlu connector']
seo:
  metatags:
    description: >-
      The Watson Assistant NLU Connector allows you to connect to IBM Watson
      Assistant and use its language understanding results to power the AI
      Agents within Cognigy.
---

import AiEmpowerNluNluConnectors from '/snippets/ai/empower/nlu/nlu-connectors.mdx'

The Watson Assistant NLU connector enables integration with [IBM Watson Assistant](https://www.ibm.com/products/watsonx-assistant) to use its language understanding results for powering AI Agents in Cognigy.
...
In Cognigy, go to **Build > NLU Connectors**, create a Watson Assistant NLU connector, and enter the retrieved credentials.
