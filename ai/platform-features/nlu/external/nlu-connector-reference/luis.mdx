...
keywords: ['microsoft luis', 'external nlu', 'microsoft luis nlu connector']
seo:
  metatags:
    description: >-
      The Microsoft LUIS NLU connector allows you to connect to Microsoft LUIS
      and use its language understanding results to power AI Agents within
      Cognigy.
---

import AiEmpowerNluNluConnectors from '/snippets/ai/empower/nlu/nlu-connectors.mdx'

The Microsoft LUIS NLU connector enables integration with [Microsoft LUIS](https://www.luis.ai/) to use its language understanding results for powering AI Agents in Cognigy.
...
3. Ensure the app is published in **production mode** for external services, such as Cognigy, to access it.

## Configuration on the Cognigy Side

1. In Cognigy, go to **Build > NLU Connectors**, create a LUIS NLU connector. 
