...
seo:
  metatags:
    description: >-
      ...
      Cognigy.AI conversations by accessing Input, Context, and Profile objects.
...
- Retrieve information from [Cognigy.AI objects](/ai/agents/develop/ai-agent-memory/overview#lifespan-of-cognigyai-objects) and reuse it in chat and voice conversations.
