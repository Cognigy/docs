...
keywords: ['ai agents', 'ai workforce', 'virtual assistant', 'voice ai', 'chat ai']
seo:
  metatags:
    description: >-
...
_Cognigy AI Workforce_ is a collection of AI Agents that you can design using the Cognigy platform to automate tasks and enhance various business processes.
...
Cognigy enables the creation of autonomous AI Agents that can manage customer inquiries, resolve common issues, and guide users through processes without human intervention. 

Using the tools on the Cognigy platform, you can create AI Agents customized to meet the specific needs of your business.
Here are some examples of AI Agents you can build with Cognigy:
...
To build a chat AI Agent using Cognigy, you need to start by creating a [Project](/ai/agents/develop/projects-and-flows/projects) and a [Flow](/ai/agents/develop/projects-and-flows/overview).
...
To build a voice AI Agent using Cognigy,
...
Cognigy offers a [marketplace of prebuilt Extensions](/ai/for-developers/extensions) and [Extension framework](/ai/for-developers/developers/extension-framework)
...
Cognigy offers a comprehensive suite of human assistants, each tailored to meet specific needs in your contact center solution:
...
Agent Copilot Bot is available only in the Cognigy Live Agent interface.

## More Information

- [Key Features](/ai/overview/key-features)
- [Build Your AI Agent in Minutes](/ai/agents/quickstart)
