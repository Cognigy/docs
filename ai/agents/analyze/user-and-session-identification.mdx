...
seo:
  metatags:
    description: >-
      Cognigy uses unique user IDs and session IDs to keep track of users'
      interactions with AI Agents.
keywords: ['user id', 'session id', 'user identification', 'session identification']
---

Cognigy uses unique user IDs and session IDs to keep track of users' interactions with AI Agents.

## Restrictions

- You must use session IDs only within one organization in your Cognigy installation.
