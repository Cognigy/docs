...
<AccordionGroup>
  ...
  <Accordion title="2. Create Flows and Configure the Initial Step">
    ...
    <figure>
    <img class="image-center" src="/_assets/ai/analyze/goals/goal-flow.png" style={{ width: 'auto' }} />
    </figure>
  </Accordion>
  ...
  <Accordion title="4. Configure the Confirm Booking Step">
    ...
    <figure>
    <img class="image-center" src="/_assets/ai/analyze/goals/goal-flow-end.png" style={{ width: 'auto' }} />
    </figure>
  </Accordion>
