...
keywords: ['goals', 'tasks', 'insights', 'odata', 'metrics']
seo:
  metatags:
    description: >-
...
<Frame>
  <img class="image-center" src="/_assets/ai/analyze/goals/life-cycle.png" alt="Life cycle of goals and tasks from definition to analysis" style={{ width: 'auto' }} />
</Frame>
