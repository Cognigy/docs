...
| Integration              | Integration with the OData endpoint [Steps](/ai/agents/analyze/odata#steps) and [ExecutedSteps](/ai/agents/analyze/odata#executedsteps) collections. | Integration with the [Contact Profile](/ai/agents/analyze/contact-profiles), the Insights [Overview](/insights/reports/overview) and [Engagement](/insights/reports/engagement) reports, as well as the OData endpoint [Sessions](/ai/agents/analyze/odata#sessions) and [Analytics](/ai/agents/analyze/odata#analytics) collections. | Improved integration with Insights through the [Goals report](/insights/reports/goals) and OData, and enhanced data reporting features.                       |
