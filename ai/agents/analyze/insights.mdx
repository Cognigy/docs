---
title: Insights
description: Use Cognigy Insights to view analytics and visualizations of your AI Agent interactions, including reports and metrics.
keywords: ['analytics', 'insights', 'metrics', 'tracking']
---

# Insights

Insights provides you with advanced analytics and visualizations for each [Project](/ai/agents/develop/projects-and-flows/projects) based on the data collected from interactions with chat and voice AI Agents.
...
To learn more about Insights, go to the [Insights](/insights/overview) documentation.

## Limitations

Customizing reports in Cognigy Insights isn't possible. Use the [OData Analytics Endpoint](/ai/agents/analyze/odata) to access the data used to populate the reports.
