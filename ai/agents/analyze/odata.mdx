...
<Frame>
    <img class="image-center" src="/_assets/ai/analyze/insights-odata-entities.drawio.svg" alt="Entity relationship diagram for Cognigy.AI OData collections" style={{ width: 'auto' }} /> 
    <figcaption>
