...
<Tabs>
  ...
  <Tab title="NiCE CXone">
    `https://cognigy-odata-na1.cognigy.ai`.
  </Tab>
</Tabs>
...
<Tabs>
  <Tab title="Version 2.4">
    ...
    - [Steps](#steps) (`/Steps`) <Badge color="orange">deprecated</Badge>
    - [ExecutedSteps](#executedsteps) (`/ExecutedSteps`) <Badge color="orange">deprecated</Badge>
