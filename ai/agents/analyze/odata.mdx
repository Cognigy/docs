---
title: Cognigy.AI OData Analytics Endpoint
sidebarTitle: OData
description: >-
  Cognigy.AI provides an OData analytics Endpoint for retrieving raw data via
...
You can control the data available through the OData endpoint at the [Endpoint](/ai/agents/deploy/endpoints/overview), [Flow](/ai/agents/develop/projects-and-flows/overview), and Node levels:
...
- Flow — add a [Blind Mode](/ai/agents/develop/node-reference/analytics/blind-mode) Node to your Flow. This Node disables or masks analytics data available to the OData endpoint.
...
```mermaid
erDiagram
    %% ERD diagram for Cognigy.AI OData v2.4 collections 
