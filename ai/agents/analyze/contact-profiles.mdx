...
seo:
  metatags:
    description: >-
      Cognigy.AI Contact Profiles contain information about users who interact
...
- **GDPR Compliance**. Cognigy.AI provides tools to comply with the General Data Protection Regulation (GDPR), including exporting user data, deleting Contact Profiles, and managing data collection preferences for individual contacts.
...
<Tabs>
  ...
  <Tab title="API">
    You can view, edit, and delete Contact Profiles using the [Cognigy.AI API](/api-reference/contact-profiles/get-contact-profiles-performance).
  </Tab>
</Tabs>   
