...
<Tabs>
  ...
  <Tab title="API">
    You can view, edit, and delete Contact Profiles using the [Cognigy.AI API](https://api-trial.cognigy.ai/openapi#tag--Profiles-v2.0).
  </Tab>
</Tabs>
...
To delete a custom field, select ![vertical-ellipsis](/_assets/icons/black-and-white/vertical-ellipsis.svg) **> Delete** next to the field. When you delete a custom field, any data related to this field is removed from all Contact Profiles.
