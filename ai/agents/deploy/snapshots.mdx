...
- You can create up to 10 Snapshots per Project. For on-premises installations, you can change this value using the `MAX_AMOUNT_SNAPSHOTS_IN_AGENT` environment variable in `values.yaml`.
