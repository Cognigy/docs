...
_Test Mode_ allows you to send messages to Endpoints without affecting the [billable conversation count](/ai/administer/billing#billable-conversation). The messages you send are processed as regular messages between a user and an AI Agent.
