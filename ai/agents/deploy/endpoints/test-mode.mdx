...
seo:
  metatags:
    description: >-
      Test Mode for Endpoints allows you to send messages to Endpoints without
      affecting the billable conversation count.
keywords: ['availability check', 'test mode', 'performance testing', 'monitoring', 'endpoint testing']
---

_Test Mode_ allows you to send messages to Endpoints without affecting the [billable conversation count](/ai/administer/billing#billable-conversations). The messages you send are processed as regular messages between a user and an AI Agent.
...
- [REST](/ai/agents/deploy/endpoint-reference/rest), for Cognigy 4.27.0 and later versions.
- [Socket.IO](/ai/agents/deploy/endpoint-reference/socketio), for Cognigy 4.42.0 and later versions.
