...
- [REST](/ai/agents/deploy/endpoint-reference/rest), for Cognigy.AI 4.27.0 and later versions.
- [Socket.IO](/ai/agents/deploy/endpoint-reference/socketio), for Cognigy.AI 4.42.0 and later versions.
