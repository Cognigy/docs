...
seo:
  metatags:
    description: >-
      The Real-Time Translation Settings section allows you to configure the
      Real-Time Translation feature, which enables real-time translation of user
      input and AI Agent output.
keywords:
...
import AddMachineTranslationProvider from '/snippets/ai/settings/add-machine-translation-provider.mdx'

In the _Real-Time Translation Settings_ section, you can configure the [Real-Time Translation](/ai/platform-features/translation-and-localization/real-time-translation) feature. Before using this feature, you need to add a machine translation provider.
...
<a href="/release-notes/4.63"><img noZoom alt="Version badge" src="https://img.shields.io/badge/Updated in-v4.63-blue.svg" /></a>
