...
seo:
  metatags:
    description: >-
      For some Cognigy.AI Endpoints, you can configure file uploading to enable
...
To test file uploads for the Webchat v2 and Webchat v3 Endpoints, use [Demo Webchat](/webchat/demo). Upload a file in the Demo Webchat interface by either dragging it from your computer or clicking ![attachment-icon](/_assets/icons/black-and-white/attach-files.svg).
