...
<Frame>
  <img class="image-center" src="/_assets/ai/deploy/endpoint-reference/webhook.png" style={{ width: 'auto' }} />
</Frame>
...
If you use [Agent Copilot for voice](/agent-copilot/voice/voice-overview) with the Webhook Endpoint, you can switch to a specific [Voice Copilot](/ai/agents/deploy/endpoint-reference/voice-copilot) Endpoint. This Endpoint includes all webhook logic, so you don't need to use a Code Node.
