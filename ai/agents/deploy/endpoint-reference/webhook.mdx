  ...
  <Accordion title="1. Send a Request">
    ...
    <AccordionGroup>
      ...
      <Accordion title="With API Key Authentication">
        ...
        The API key authentication header name depends on your Cognigy.AI version.

        <AccordionGroup>
          <Accordion title="For Cognigy.AI 2026.16.0 and later version">
          ...
          <Accordion title="For Cognigy.AI 2026.13 to 2026.15">
            <Tabs>
              <Tab title="cURL">
                Replace `https://<your-endpoint-url>` with the Endpoint URL and `<your-api-key>` with an active API key from the Endpoint settings.
