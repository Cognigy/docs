---
title: AudioCodes
keywords: ['audiocodes', 'audiocodes endpoint']
seo:
  metatags:
    description: >-
      The AudioCodes Endpoint enables you to connect your AI Agent to your contact
...
<Frame>
  <img src="/_assets/ai/deploy/endpoint-reference/audiocodes.png" alt="AudioCodes Endpoint logo" />
</Frame>
