---
title: LINE
keywords: ['line messenger', 'line messenger endpoint']
seo:
  metatags:
...
<Frame>
  <img class="image-center" src="/_assets/ai/deploy/endpoint-reference/line.png" alt="LINE Messenger Endpoint logo" />
</Frame>
