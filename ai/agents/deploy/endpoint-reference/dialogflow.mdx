...
<Warning>
  As of Cognigy.AI 2026.17.0, the Dialogflow Endpoint is deprecated. You can't create new Dialogflow Endpoints. The removal is planned for January 2028. Existing Dialogflow Endpoints continue to work until the removal date.
</Warning>
