---
title: Dialogflow
keywords: ['dialogflow', 'google dialogflow', 'dialogflow endpoint']
description: "The Dialogflow Endpoint enables you to connect your AI Agent to the Dialogflow platform."
tag: deprecated
---

<Frame>
  <img src="/_assets/ai/deploy/endpoint-reference/dialogflow.png" alt="Dialogflow Endpoint logo" />
</Frame>

<Warning>
  As of Cognigy 2026.17.0, the Dialogflow Endpoint is deprecated. You can't create new Dialogflow Endpoints. The removal is planned for January 2028. Existing Dialogflow Endpoints continue to work until the removal date.
</Warning>
...
<Accordion title="Dialogflow Settings">
  ...
  |---------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
  | Reparse Slots | A toggle that lets you combine Dialogflow and Cognigy NLU. This feature allows slots found by Dialogflow to be passed to Cognigy and further processed by its NLU. |
</Accordion>
## How to Set Up
