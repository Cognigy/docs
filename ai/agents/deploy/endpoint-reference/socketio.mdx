---
title: Socket.IO
keywords: ['socket.io', 'socket.io endpoint']
seo:
  metatags:
    description: >-
      The Socket.IO Endpoint enables you to connect your AI Agent to the
      Socket.IO client.
---
import ReleaseNotesHandoverProvidersDeprecation from '/snippets/release-notes/handover-providers-deprecation.mdx'

<Frame>
  <img class="image-center" src="/_assets/ai/deploy/endpoint-reference/socket-io.svg" alt="Socket.IO Endpoint logo" />
</Frame>
