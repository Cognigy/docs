...
hidden: false
keywords: [' microsoft teams', ' microsoft teams', ' microsoft teams endpoint', ' teams']
seo:
  metatags:
...
<Frame>
  <img class="image-center" src="/_assets/ai/deploy/endpoint-reference/teams.png" style={{ width: 'auto' }} />
</Frame>
