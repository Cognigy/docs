...
<a href="/release-notes/4.64"><img noZoom src="https://img.shields.io/badge/Updated in-v4.64-blue.svg" /></a>
...
<AccordionGroup>
  <Accordion title="1. Create a Genesys Bot Connector">
  ...
  <Accordion title="2. Add a Bot for the Bot Connector Integration">
  ...
  <Accordion title="3. Build an Inbound Message Flow">
    ...
    11. In the **Queue** field of the **Transfer to ACD** action, select the queue to which you want to transfer the interaction.
           ...
           <Frame>
             <img src="/_assets/ai/deploy/endpoint-reference/genesys-flow-example.png"/>
           </Frame>
  ...
  <Accordion title="4. Configure a Messenger">
...
If you want to use [AI Copilot](/agent-copilot/overview) and [Notifications APIs](https://developer.genesys.cloud/notificationsalerts/notifications/notifications-apis) within the Genesys integration,
...
<AccordionGroup>
  ...
  <Accordion title="2. Configure Settings for Agent AI Copilot">
    ...
    2. Configure AI Copilot by creating an [AI Copilot config](https://api-trial.cognigy.ai/openapi#post-/v2.0/agentassistconfigs) and adding a Flow. For more information, refer to the [AI Copilot documentation](/agent-copilot/overview).
