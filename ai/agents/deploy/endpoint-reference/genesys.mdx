...
<Frame>
  <img src="/_assets/ai/escalate/handover-reference/genesys.svg" alt="Genesys Endpoint logo" />
  <img src="/_assets/ai/escalate/handover-reference/genesys-dark.svg" alt="Genesys Endpoint logo" />
</Frame>
...
<AccordionGroup>
  <Accordion title="1. Create Genesys Bot Connector Integration">
    ...
    5. In the **Bot Connector Handle Utterance URI** field, enter the Endpoint URL value you saved earlier from the Cognigy setup.
    ...
    7. Click **+ Add Credential Field** and enter the following credentials:
        ...
        - **newKey** — enter the token created earlier in the **Verify Token** field on the Cognigy side.
  ...
  <Accordion title="2. Add Bot for Bot Connector Integration">
    ...
    5. In the **Request Body** editor under **Query Parameters**, enter the following JSON:
         ...
         ```
      The `id` field must contain a UUID, which you can create using an online [UUID generator](https://www.uuidgenerator.net/).<br/>
