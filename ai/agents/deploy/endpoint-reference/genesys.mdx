...
If you want to use [Agent Copilot](/agent-copilot/overview) and [Notifications APIs](https://developer.genesys.cloud/notificationsalerts/notifications/notifications-apis) within the Genesys integration,
...
<AccordionGroup>
  ...
  <Accordion title="2. Configure Settings for Agent Agent Copilot">
