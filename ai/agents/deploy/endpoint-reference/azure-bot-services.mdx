...
<a href="/release-notes/4.55"><img noZoom src="https://img.shields.io/badge/Updated in-v4.55-blue.svg" /></a>

<Frame>
  <img class="image-center" src="/_assets/ai/deploy/endpoint-reference/azure-bot-services.png" style={{ width: 'auto' }} />
</Frame>
...
<Accordion title="1. Create an Azure Bot Services Endpoint">
...
<AccordionGroup>
  ...
  <Accordion title="_(Optional)_ 6.1 Configure Single Sign-On">
