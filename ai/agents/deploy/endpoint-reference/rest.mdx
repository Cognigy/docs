---
title: REST
keywords: ['rest', 'api', 'rest endpoint']
seo:
  metatags:
...
<Frame>
  <img src="/_assets/ai/deploy/endpoint-reference/REST.png" alt="REST Endpoint logo" />
</Frame>
...
<Accordion title="Create a REST Endpoint">
...
<AccordionGroup>
  <Accordion title="1. Send a Request">
    ...
    <AccordionGroup>
      ...
      <Accordion title="With API Key Authentication">
        ...
        <AccordionGroup>
          <Accordion title="For Cognigy 2026.16.0 and later">

            Use the `x-cognigy-endpoint-key` header. The Endpoint also accepts the legacy `x-rest-endpoint-key` header for backward compatibility, but `x-cognigy-endpoint-key` takes precedence if both are provided.
            ...
            <Tabs>
              <Tab title="cURL">
                ...
                curl -X POST https://<your-endpoint-url> \
                  -H "Content-Type: application/json" \
                  -H "x-cognigy-endpoint-key: <your-rest-endpoint-api-key>" \
                  -d '{
                    "userId": "user123",
                    "sessionId": "session123",
                    "text": "Hello, I need help with my order",
              ...
              <Tab title="Postman">
                ...
                3. Go to the **Headers** tab and configure:
                    ...
                    - `x-cognigy-endpoint-key` — the API key you created using the [Cognigy API](#api-key-authentication).
                4. Go to the **Body** tab, select **raw**, then select **JSON** as the format.
                5. Paste the request body:
                ...
                async function sendRequest() {
                  try {
                    const response = await axios.post('https://<your-endpoint-url>', {
                      ...
                      headers: {
                        "Content-Type": "application/json",
                        "x-cognigy-endpoint-key": "<your-rest-endpoint-api-key>"
                      }
                    });
          ...
          <Accordion title="For Cognigy 2026.14 and 2026.15">
            <Tabs>
              <Tab title="cURL">
                Replace `https://<your-endpoint-url>` with the Endpoint URL and `<your-rest-endpoint-api-key>` with an active API key from your Endpoint settings.
  ...
  <Accordion title="2. Get a Response">
    ...
    ```json
    {
      "text": "Hello, this is the Cognigy Agent. How can I help you?",
      "data": {},
      "outputStack": [
        {
          "text": "Hello, this is the Cognigy Agent.",
          "data": {},
