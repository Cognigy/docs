...
<Frame>
  <img class="image-center" src="/_assets/ai/deploy/endpoint-reference/voice-copilot.png" style={{ width: 'auto' }} />
</Frame>
...
- You have configured an [Agent Copilot Flow](/agent-copilot/configuration).
