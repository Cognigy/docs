---
title: Twilio SMS
keywords: ['twilio sms', 'twilio sms endpoint']
seo:
  metatags:
    description: >-
      The Twilio SMS Endpoint enables you to connect your AI Agent to the Twilio
      platform to handle SMS and WhatsApp messages. Via this Endpoint, your end
      users can interact with your AI Agent through text messaging.
---

<Frame>
  <img src="/_assets/ai/deploy/endpoint-reference/twilio.png" alt="Twilio SMS Endpoint logo" />
</Frame>
...
<Accordion title="1. Create a Twilio Endpoint">
...
<AccordionGroup>
  <Accordion title="1. Get a Phone Number">
    ...
    4. Go to **Active Numbers**. Select the number, then go to **Voice Configuration**. From the **A call comes in** list, select **Webhook**. In the **URL** field, enter the Cognigy Endpoint URL. Click **Save configuration**. To test the connection, send an SMS to your Twilio number.
  </Accordion>

  <Accordion title="2. Connect Your Twilio Number to WhatsApp">
