...
<Frame>
  <img class="image-center" src="/_assets/ai/deploy/endpoint-reference/amazon-lex.png" alt="Amazon Lex Endpoint logo"/>
</Frame>
...
<AccordionGroup>
  ...
  <Accordion title="Use Amazon Lex with Cognigy.AI NLU">
