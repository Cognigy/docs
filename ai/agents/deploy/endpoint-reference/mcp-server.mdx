...
<a href="/release-notes/2026.12"><Badge className="version-badge" color="purple">Updated in 2026.12 (experimental)</Badge></a>

<Frame>
  <img class="image-center" src="/_assets/ai/deploy/endpoint-reference/mcp.svg" alt="MCP Server Endpoint logo" />
</Frame>
