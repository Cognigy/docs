---
title: Userlike
keywords: ['userlike', 'userlike endpoint']
seo:
  metatags:
    description: >-
...
<Frame>
  <img src="/_assets/ai/deploy/endpoint-reference/userlike.png" alt="Userlike Endpoint logo" />
</Frame>
...
<Accordion title="Create a Chatbot in Userlike">
  ...
  6. In the **Webhook URL** field, paste the Endpoint URL from the Cognigy Userlike Endpoint.
  7. If you selected the **Unified Messaging API** in the Cognigy Userlike Endpoint, copy the following fields:
      - **API URL** — copy and paste this URL into the **Webhook URL** field in the Cognigy Endpoint.
      - **API security token** — copy and paste this token into the **Security Token** field in the Cognigy Endpoint.
