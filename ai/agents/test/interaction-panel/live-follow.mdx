...
You can now view and track the user's real-time conversation from the Interaction Panel. To stop live following, click ![stop-live-follow](/_assets/icons/blue/stop-live-follow.svg).
