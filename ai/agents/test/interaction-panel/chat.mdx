...
<Frame>
  <img class="image-center" src="/_assets/ai/test/interaction-panel/interaction-panel-chat-tab-debug-mode.png" alt="Interaction Panel Chat tab with debug mode enabled" style={{ width: 'auto' }} />
</Frame>
