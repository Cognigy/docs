...
- You can run up to 10 Playbooks simultaneously. You can change this limit for:
    ...
    - Dedicated SaaS — contact [Cognigy technical support](/help/get-help).
...
<Tabs>
  <Tab title="GUI">
        ...
        In **Test > Playbooks**, you can create, delete, and run Playbooks as well as export them as a Package. To define Steps and Assertions the Playbook editor, select a Playbook from the list. Playbook runs are [Tasks](/ai/agents/develop/projects-and-flows/projects#task-panel) and take place in the background. The results are available in the Playbook editor.
