...
seo:
  metatags:
    description: >-
      Cognigy.AI Playbooks are conversation scripts that you can run
...
<Tabs>
  <Tab title="GUI">
        ...
        **Interaction Panel**
        ...
        2. Click ![vertical-ellipsis](/_assets/icons/black-and-white/vertical-ellipsis.svg) above the chat window and select **Create Playbook**.
