...
seo:
  metatags:
    description: >-
      Cognigy Logs are system records that contain information about input
...
<Frame>
  <img src="/_assets/ai/test/logs.png" alt="Cognigy Logs page showing input and output message records" style={{ width: 'auto' }} />
</Frame>
...
- Log entries on the Logs page are retained for up to 24 hours. By default, the Logs page displays the logs of the last 2 hours. To change this value, contact [Cognigy technical support](/help/get-help). Alternatively, use the [GET Log Entries](/api-reference-logs/logs-v21/get-log-entries) API method to view all retained logs.
...
<Tabs>
  ...
  <Tab title="API">
        You can view the logs of a Project with the [Cognigy Logs API](/api-reference-logs/).
  </Tab>
</Tabs>
