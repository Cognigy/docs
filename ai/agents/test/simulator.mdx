...
import SimulatorOnTrial from '/snippets/ai/build/test/simulator-on-trial.mdx'
import CreateScenariosFromTranscript from '/snippets/ai/build/test/create-scenarios-from-transcript.mdx'

<a href="/release-notes/2025.24"><img noZoom src="https://img.shields.io/badge/Added in-v2025.24(beta)-purple.svg" /></a>
...
<Frame>
 <img class="image-center" src="/_assets/ai/analyze/simulator.webp" alt="Simulator" style={{ width: 'auto' }} />
</Frame>
...
<AccordionGroup>
  ...
  <Tabs>
    ...
    <Tab title="Manually">
      ...
      2. In the **Success Criteria** section, add metrics to evaluate the simulation's success:
          - **Add Goal** – select a goal from the list of available goals. If you don't have any goals, you can [create a new one](../analyze/goals-and-tasks/goals.md). The goal should reflect the simulation's desired outcome. Example: `Receive personalized recommendations for exotic dishes`.
  ...
  <Accordion title="3. Evaluate">
      ...
      Go to the **Runs** table and locate runs where **Complete Success Rate** is `Failed`. Click a run to view the simulated conversation. Hover over the `Failed` status to see a tooltip explaining why the success criterion failed.
