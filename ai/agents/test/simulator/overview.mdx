...
"seo": {
  "metatags": {
    "description": "Cognigy Simulator is an LLM-powered tool in Cognigy that allows users to model and test full conversational scenarios for LLM-based AI Agents."
  }
}
---
...
_Simulator_ is an LLM-powered tool in Cognigy that allows users to model and test full conversational scenarios for LLM-based AI Agents.
...
<Frame>
 <img src="/_assets/ai/test/simulator/simulation-overview.webp" alt="Simulator overview interface showing Scenarios, Simulation Runs, and Simulations components for testing LLM-based AI Agents" style={{ width: 'auto' }} />
</Frame>
...
- **Simulations Across Multiple Interfaces**. Run simulations via the Simulator or the Interaction Panel and view all simulated conversations in the Conversations Explorer, Simulator, or Interaction Panel for quick outcome review.
...
- The maximum number of scenarios per Project is 100. You can change this limit as follows:
  - For SaaS installations, contact [Cognigy technical support](/help/get-help).
  - For on-premises installations, assign a new limit to the `MAX_SIMULATIONS_PER_PROJECT` environment variable in `values.yaml`.
...
- Results from simulations are deleted after 90 days.

## How the Simulator Works

<Frame>
  <img src="/_assets/ai/test/simulator/workflow.webp" alt="Simulator workflow from scenario creation to simulation to evaluation" style={{ width: 'auto' }} />
</Frame>
...
<Tabs>
  <Tab title="GUI">
    <AccordionGroup>
      ...
      In the Simulator, you can create a scenario automatically or manually. Alternatively, you can create a scenario from a transcript in the [Conversations Explorer](/insights/explorers/conversations).
      ...
      <Tabs>
        <Tab title="Automatically">
          ...
          4. Click **Generate**. Cognigy generates a scenario based on the AI Agent Job Node configuration. Review the generated scenario and adjust it if necessary.
        ...
        <Tab title="From Transcripts">
          ...
          You can also create a scenario from an existing conversation transcript in the [Conversations Explorer](/insights/explorers/conversations#scenarios).
        </Tab>
      </Tabs>
      </Accordion>
      ...
      To start a simulation, follow these steps:
        ...
        2. In the **Start Simulation** window, configure the simulation:
            ...
            - **Locale** – select the [Locale](/ai/platform-features/translation-and-localization/localization) that defines the language of the AI Agent and simulated user.
      ...
      <Accordion title="3. Evaluate">
        ...
        You can also view the simulated conversation in the [Conversations Explorer](/insights/explorers/conversations) by toggling on **Interaction Panel / Playbooks / Simulations** in the Endpoint filters.
  ...
  <Tab title="API">
    You can use the [Cognigy Simulator API](/api-reference-simulator/) to create scenarios, run simulations, and retrieve results from simulations and simulation runs.
...
<Tabs>
  <Tab title="GUI">
    ...
    1. Hover over the scenario for which you want to schedule a simulation and select ![menu](/_assets/icons/black-and-white/vertical-ellipsis.svg) **> Schedule** on the right. The **Schedule Configuration** panel opens.
...
<AccordionGroup>
  ...
  <Accordion title="Azure Content Filter Error">
    ...
    This error isn't caused by Cognigy, it occurs because [Azure's content filter](https://learn.microsoft.com/en-us/azure/ai-foundry/openai/concepts/content-filter?view=foundry-classic) blocks the LLM prompt, also called system message, according to your subscription's safety policy. The LLM prompt includes your simulation settings, for example, personas, missions, and success criteria.
