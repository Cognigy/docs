...
<Tabs>
  ...
  <Tab title="API">
    You can use the [Cognigy.AI Simulator API](/api-reference-simulator/) to create scenarios, run simulations, and retrieve results from simulations and simulation runs.
