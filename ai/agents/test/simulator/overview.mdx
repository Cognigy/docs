...
<Tabs>
  ...
  <Tab title="API">
    You can use the [Cognigy.AI Simulator API](https://api-dev.cognigy.ai/testing/openapi) to create scenarios, run simulations, and retrieve results from simulations and simulation runs.
...
<Tabs>
  ...
  <Tab title="API">
    To schedule a simulation, use the [`POST /simulations/{simulationReference}/schedules`](https://api-dev.cognigy.ai/testing/openapi#post-/simulations/-simulationReference-/schedules) request.
  </Tab>
</Tabs>
