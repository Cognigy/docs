...
<Frame>
  <img src="/_assets/ai/test/simulator/simulator-dashboard.webp" alt="Simulator Dashboard showing key metrics with indicators, bar charts, and tables of scheduled and recent simulations" style={{ width: 'auto' }} />
</Frame>
...
You can use the [Cognigy.AI Simulator API](/api-reference-simulator/) to access the Simulator dashboard data.
