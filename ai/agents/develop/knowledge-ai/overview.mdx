---
title: Knowledge AI
keywords: ['knowledge ai', 'rag', 'retrieval augmented generation', 'knowledge base', 'ai agents']
sidebarTitle: Overview
description: "Upload documents and use RAG to enable AI Agents to provide accurate, context-aware responses with Knowledge AI."
---
...
<Frame>
    <img class="image-center" src="/_assets/ai/empower/knowledge-ai/knowledge-hierarchy.png" alt="Knowledge AI hierarchy from Knowledge Store to Source to Chunk" style={{ width: 'auto' }}/>
</Frame>
