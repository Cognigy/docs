...
<AccordionGroup>
  <Accordion title="Embedding model">
   ...
   Knowledge AI supports the following embedding models:
    ...
    | <span style={ {whiteSpace: 'nowrap'} }>`gemini-embedding-2`</span> | Available for Cognigy.AI 2026.13 and later versions.                                                                                                                                                                                                                                                                                                                                       |
...
<Frame>
    <img src="/_assets/ai/empower/knowledge-ai/knowledge-hierarchy.png" alt="Knowledge AI hierarchy from Knowledge Store to Source to Chunk" style={{ width: 'auto' }} />
</Frame>
