...
<AccordionGroup>
  <Accordion title="Embedding model">
   ...
   Knowledge AI supports the following embedding models:
    ...
    | <span style={ {whiteSpace: 'nowrap'} }>`amazon.titan-embed-text-v2:0`</span> | For Cognigy 2025.10 and earlier versions, use the `FEATURE_ENABLE_AWS_BEDROCK_EMBEDDING_LLM_WHITELIST` environment variable to make this model available to individual or all feature flags.                                                                                                                                                                                   |
    | <span style={ {whiteSpace: 'nowrap'} }>`gemini-embedding-2`</span> | Available for Cognigy 2026.13 and later versions.                                                                                                                                                                                                                                                                                                                                       |
