...
<Accordion title="Controls">
  ...
  | ![vertical-ellipsis](/_assets/icons/black-and-white/vertical-ellipsis.svg) | Menu with options to edit, delete, or disable the Knowledge Chunk. |
  | ![collapse-arrow](/_assets/icons/black-and-white/collapse-arrow.svg) | Collapses Knowledge Chunk field. |
  | ![plus-sign](/_assets/icons/black-and-white/plus-sign.svg) | Adds a Knowledge Chunk. |
</Accordion>
