...
keywords: ['knowledge chunk', 'knowledge ai', 'chunk metadata', 'knowledge source', 'rag']
...
- The Knowledge Chunk text field can't be empty or contain only whitespace. The same rule applies to the `text` parameter in the [Cognigy KnowledgeChunks API](https://api-trial.cognigy.ai/openapi#tag--KnowledgeChunks).
...
<Tabs>
  ...
  <Tab title="API">
        You can view, create, edit, and delete Knowledge Chunks using the [Cognigy API](https://api-trial.cognigy.ai/openapi#tag--KnowledgeChunks).
  </Tab>
</Tabs>
## More information
