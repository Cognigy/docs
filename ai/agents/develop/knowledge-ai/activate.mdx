...
<Frame>
  <img class="image-center" src="/_assets/ai/administer/access/knowledge-ai.png" alt="Knowledge AI metrics in the Admin Center showing queries and chunks" style={{ width: 'auto' }} />
</Frame>
