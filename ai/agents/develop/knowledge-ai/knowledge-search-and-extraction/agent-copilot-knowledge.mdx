...
<a href="/release-notes/4.72"><img noZoom src="https://img.shields.io/badge/Added in-v4.72-blue.svg" /></a>
...
- The Copilot: Knowledge Tile adds an [Agent Copilot widget](/agent-copilot/plug-and-play-widgets) in which human agents can use a search bar to access [Knowledge Sources](/ai/agents/develop/knowledge-ai/knowledge-source/overview) and find information to answer questions from customers.
...
- You have installed [Agent Copilot](/agent-copilot/getting-started).
...
2. In the **Condition** field, enter `input.data._cognigy._agentAssist.payload.tileId === TILE_ID`, where `TILE_ID` is the Tile ID you created in the [Agent Copilot configuration](/agent-copilot/getting-started).
...
2. Configure the following fields:
    - **Tile ID** — enter the Tile ID you created in the [Agent Copilot configuration](/agent-copilot/getting-started).
