---
title: PDF
keywords: ['pdf knowledge source', 'knowledge ai', 'chunk strategy', 'pdf parsing', 'knowledge chunks']
seo:
  metatags:
    description: >-
      You can split PDF Knowledge Sources into Knowledge Chunks with two
      strategies: Default and Alternative.
---
...
<Accordion title="PDF sample" defaultOpen="true">
...
<Accordion title="Default Chunk Splitting" defaultOpen="true">
...
<Accordion title="Alternative Chunk Splitting" defaultOpen="true">
  1.
    ```markdown
