...
<a href="/release-notes/4.73"><img noZoom src="https://img.shields.io/badge/Updated in-v4.73-blue.svg" /></a>


Knowledge AI supports using web pages to create [Knowledge Sources](/ai/agents/develop/knowledge-ai/knowledge-source).
