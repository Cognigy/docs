---
title: Text Extraction with Content Parsers
keywords: ['text extraction', 'content parsers', 'knowledge ai', 'basic parser', 'advanced parser']
sidebarTitle: Overview
seo:
  metatags:
    description: >-
      In Knowledge AI, parsers extract texts from uploaded files in different
      formats. These parsers are categorized based on their complexity and the
      techniques they use.
---
...
- [Advanced Parser (Default)](/ai/agents/develop/knowledge-ai/knowledge-source/text-extraction/advanced-parser)
- [Azure AI Document Intelligence](/ai/agents/develop/knowledge-ai/knowledge-source/text-extraction/azure-ai)
