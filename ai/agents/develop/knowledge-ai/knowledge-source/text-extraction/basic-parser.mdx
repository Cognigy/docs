---
title: Basic Parser
keywords: ['basic parser', 'text extraction', 'pdf parsing']
seo:
  metatags:
    description: >-
      Text Extraction with the Basic Parser is a Cognigy solution that extracts
      content from files more effectively.
---
