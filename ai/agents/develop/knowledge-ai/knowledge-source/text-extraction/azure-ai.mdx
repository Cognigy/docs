...
keywords: ['azure ai document intelligence', 'text extraction', 'ocr']
seo:
  metatags:
    description: >-
...
<Note>
  - By using Azure AI Document Intelligence as a content parser, you agree to the [Cognigy Additional Data Privacy Terms](https://www.cognigy.com/additional-privacy-terms).
