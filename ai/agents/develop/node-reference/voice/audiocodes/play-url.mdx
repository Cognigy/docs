---
title: Play URL
keywords: ['play url', 'audiocodes', 'wav file', 'audio playback', 'voice node']
---
...
<Frame>
  <img class="image-center" src="/_assets/ai/develop/node-reference/audiocodes/play-url.png" alt="AudioCodes Play URL Node configuration panel" style={{ width: 'auto' }} />
