---
title: Send Message
keywords: ['send message', 'audiocodes', 'text to speech', 'tts', 'ssml']
---
...
<Frame>
  <img class="image-center" src="/_assets/ai/develop/node-reference/audiocodes/send-message.png" alt="AudioCodes Send Message Node configuration panel" style={{ width: 'auto' }} />
