...
keywords: ['call recording', 'audiocodes', 'siprec', 'voice recording', 'sbc']
---
...
<Frame>
  <img class="image-center" src="/_assets/ai/develop/node-reference/audiocodes/call-recording.png" alt="AudioCodes Call Recording Node configuration panel" style={{ width: 'auto' }} />
