...
<Frame>
  <img class="image-center" src="/_assets/ai/develop/node-reference/vg/send-metadata.png" alt="Voice Gateway Send Metadata Node configuration panel" style={{ width: 'auto' }} />
</Frame>
