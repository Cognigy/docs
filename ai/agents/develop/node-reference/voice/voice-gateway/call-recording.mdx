...
keywords: ['call recording', 'voice gateway', 'siprec', 'session recording', 'voice ai']
---
...
<Frame>
  <img class="image-center" src="/_assets/ai/develop/node-reference/vg/call-recording.png" alt="Voice Gateway Call Recording Node configuration panel" style={{ width: 'auto' }} />
</Frame>
...
Note that this Node controls a specific Flow. If you want to enable call recording for all Flows and record entire calls, configure the [Call Recording](/voice-gateway/webapp/accounts#call-recording-configuration) setting on the Voice Gateway Self-Service Portals.
