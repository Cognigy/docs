...
<Frame>
  <img class="image-center" src="/_assets/ai/develop/node-reference/vg/mute-speech-input.png" alt="Voice Gateway Mute Speech Input Node configuration panel" style={{ width: 'auto' }} />
</Frame>

## Description

This Node controls when speech and Dual-Tone Multi-Frequency (DTMF) user inputs can be collected in your Flow.
It prevents speech and DTMF interruptions in specific cases, such as [xApp Flows](/xApps/overview), allowing for a smoother conversation experience.
