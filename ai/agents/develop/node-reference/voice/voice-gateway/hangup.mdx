...
<Frame>
  <img class="image-center" src="/_assets/ai/develop/node-reference/vg/hang-up.png" alt="Voice Gateway Hang Up Node configuration panel" style={{ width: 'auto' }} />
