---
title: Play
keywords: ['play audio', 'voice gateway', 'mp3', 'wav', 'audio streaming']
---
...
<Frame>
  <img class="image-center" src="/_assets/ai/develop/node-reference/vg/play.png" alt="Voice Gateway Play Node configuration panel" style={{ width: 'auto' }} />
</Frame>
