...
<Frame>
  <img class="image-center" src="/_assets/ai/develop/node-reference/vg/dtmf.png" style={{ width: 'auto' }} />
</Frame>
...
<Accordion title="Example DTMF Flow">
  ...
  6. Configure the logic in the branch for the second Case Node:
      ...
      <Frame>
        <img class="image-center" src="/_assets/ai/develop/node-reference/vg/dtmf-example.png" style={{ width: 'auto' }} />
      </Frame>
