...
This Node is useful when paired with a [Handover to Agent](/ai/agents/develop/node-reference/service/handover-to-agent) Node or a [Transfer](/ai/agents/develop/node-reference/voice/voice-gateway/transfer) Node.
