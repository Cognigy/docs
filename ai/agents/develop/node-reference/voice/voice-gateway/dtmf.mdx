...
<Frame>
  <img src="/_assets/ai/develop/node-reference/vg/dtmf.png" alt="Voice Gateway DTMF Node configuration panel" style={{ width: 'auto' }} />
</Frame>
...
<Accordion title="Example DTMF Flow">
  ...
  6. Configure the logic in the branch for the second Case Node:
      ...
      <Frame>
        <img src="/_assets/ai/develop/node-reference/vg/dtmf-example.png" alt="DTMF example Flow with Question, Lookup, and Handover Nodes" style={{ width: 'auto' }} />
      </Frame>
