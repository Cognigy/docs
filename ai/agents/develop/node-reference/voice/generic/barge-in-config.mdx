...
keywords: ['barge in', 'voice interruption', 'dtmf', 'speech detection', 'voice gateway']
---
...
<Frame>
  <img class="image-center" src="/_assets/ai/develop/node-reference/generic-voice/barge-in-config.png" alt="Generic Barge In Config Node configuration panel" style={{ width: 'auto' }} />
