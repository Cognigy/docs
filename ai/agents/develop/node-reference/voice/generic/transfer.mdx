---
title: Transfer
keywords: ['transfer', 'call transfer', 'sip uri', 'voice handover', 'generic voice node']
---
...
<Frame>
  <img class="image-center" src="/_assets/ai/develop/node-reference/generic-voice/transfer.png" alt="Generic Transfer Node configuration panel" style={{ width: 'auto' }} />
