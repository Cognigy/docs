...
<Frame>
  <img src="/_assets/ai/develop/node-reference/generic-voice/dtmf-collect-config.png" alt="Generic DTMF Collect Config Node configuration panel" style={{ width: 'auto' }} />
</Frame>
