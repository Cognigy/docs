---
title: Play URL
keywords: ['play url', 'audio streaming', 'mp3', 'wav', 'voice node']
---
...
<Frame>
  <img class="image-center" src="/_assets/ai/develop/node-reference/generic-voice/play-url.png" alt="Generic Play URL Node configuration panel" style={{ width: 'auto' }} />
