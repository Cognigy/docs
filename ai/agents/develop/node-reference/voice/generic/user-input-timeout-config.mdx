...
<Frame>
  <img src="/_assets/ai/develop/node-reference/generic-voice/user-input-timeout-config.png" alt="Generic User Input Timeout Config Node configuration panel" style={{ width: 'auto' }} />
</Frame>
