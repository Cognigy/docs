...
keywords: ['user input timeout', 'no input', 'voice session', 'timeout configuration', 'generic voice node']
---
...
<Frame>
  <img class="image-center" src="/_assets/ai/develop/node-reference/generic-voice/user-input-timeout-config.png" alt="Generic User Input Timeout Config Node configuration panel" style={{ width: 'auto' }} />
