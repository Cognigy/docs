...
<Frame>
  <img src="/_assets/ai/develop/node-reference/generic-voice/continuous-asr-config.png" alt="Generic Continuous ASR Config Node configuration panel" style={{ width: 'auto' }} />
</Frame>
