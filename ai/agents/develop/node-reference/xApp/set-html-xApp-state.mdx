...
keywords: ['xapp', 'show html', 'custom html', 'xapp sdk', 'micro web app']
---
...
<Frame>
  <img class="image-center" src="/_assets/ai/develop/node-reference/xApp/set-html-xApp-state.png" alt="xApp Show HTML Node configuration panel" style={{ width: 'auto' }} />
</Frame>
