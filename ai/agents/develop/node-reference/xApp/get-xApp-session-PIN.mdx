...
keywords: ['xapp', 'session pin', 'xapp session', 'pin authentication', 'micro web app']
---

<Frame>
  <img class="image-center" src="/_assets/ai/develop/node-reference/xApp/get-xApp-session-PIN.png" alt="xApp Get Session PIN Node configuration panel" style={{ width: 'auto' }} />
</Frame>
