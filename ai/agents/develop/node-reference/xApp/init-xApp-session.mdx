...
<Frame>
  <img class="image-center" src="/_assets/ai/develop/node-reference/xApp/init-xApp-session.png" alt="xApp Init Session Node configuration panel" style={{ width: 'auto' }} />
</Frame>
