...
keywords: ['xapp', 'init session', 'xapp session', 'session url', 'micro web app']
---

import XAppScreenCustomization from '/snippets/ai/xApp/screen-customization.mdx';

<a href="/release-notes/2026.19"><Badge className="version-badge" color="blue">Updated in 2026.19</Badge></a>

<Frame>
  <img src="/_assets/ai/develop/node-reference/xApp/init-xApp-session.png" alt="xApp Init Session Node configuration panel" style={{ width: 'auto' }} />
</Frame>
...
<AccordionGroup>
  ...
  <Accordion title="xApp Screens">
    ...
    | 'Session Ended' Text   | CognigyScript | Specify the message shown to the user when the xApp session ends and no further input is accepted. The default text is `The session has ended.` |
  </Accordion>
  ...
  <Accordion title="Intermediate Screen">
    ...
    <XAppScreenCustomization default_text="Nothing to do..." screen_type="intermediate screen" />
  ...
  <Accordion title="Connection Screen">
    ...
    <XAppScreenCustomization default_text="Connecting..." screen_type="connection screen" />
  </Accordion>
</AccordionGroup>
