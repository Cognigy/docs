...
<Frame>
  <img class="image-center" src="/_assets/ai/develop/node-reference/basic/optional-question.png" alt="Optional Question Node configuration panel" style={{ width: 'auto' }} />
</Frame>
