...
keywords: ['optional question node', 'user input', 'question node', 'slot filling']
---

<Frame>
  <img src="/_assets/ai/develop/node-reference/basic/optional-question.png" alt="Optional Question Node configuration panel" style={{ width: 'auto' }} />
</Frame>
...
<Accordion title="Comparison with the Question Node">
  The Optional Question Node is non-blocking. This means that the user can continue their conversation with the Flow if they haven't provided an answer to the Optional Question. Before regular Flow execution, the Cognigy checks if the user input answers the Optional Question to find a result. If not, the Flow execution follows a different path.
...
<AccordionGroup>
  ...
  | Data        | Any data (input.data) input.                                                                                                                                                                            |
    ...
    The Optional Question Node output types carry the same functionality as the [Say Node](/ai/agents/develop/node-reference/basic/say).
    ...
    <Accordion title="Question Information in Input">
