...
<AccordionGroup>
  ...
  <Accordion title="LLM Entity Extraction Options">
    ...
    set the Generative AI provider in the [Settings](/ai/agents/develop/gen-ai-and-llms/generative-ai).
  ...
  <Accordion title="Escalation on Wrong Answers">
  ...
  <Accordion title="Reconfirmation Settings">
