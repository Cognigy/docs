---
title: Debug Message
keywords: ['debug message', 'flow debugging', 'interaction panel', 'debug mode', 'error logging']
seo:
  metatags:
...
<Frame>
  <img class="image-center" src="/_assets/ai/develop/node-reference/basic/debug-message.png" alt="Debug Message Node configuration panel" style={{ width: 'auto' }} />
</Frame>
