---
title: "Code"
keywords: ['code node', 'javascript', 'custom logic', 'nodes']
"seo": {
  "metatags": {
...
<Frame>
  <img class="image-center" src="/_assets/ai/develop/node-reference/code/code.png" alt="Code Node configuration panel" style={{ width: 'auto' }} />
</Frame>
