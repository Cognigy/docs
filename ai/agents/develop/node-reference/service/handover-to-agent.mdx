...
<AccordionGroup>
  ...
  <Accordion title="Salesforce MIAW Settings">
    ...
    | Enable User Connects Message           | Notify human agents when an end user reconnects to the chat. The parameter is enabled by default. When the parameter is enabled, the message `User joined the conversation` appears in the chat as soon as the end user returns to the chat tab by clicking the **←** (back arrow) at the top bar in the browser, after having opened a new URL on the same tab as the chat.                                                                                                                                                                                                                                                                                                                                                                                                                     |
    | Enable User Disconnects Message        | Notify human agents when an end user disconnects from the chat. The parameter is enabled by default. When the parameter is enabled, the message `User left the conversation` is sent as soon as the end user closes the tab with the chat or switches to a new URL address within the current tab.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
    | Agent Change Notification              | Send a system message to the end user indicating when the conversation is reassigned to another human agent. This parameter is deactivated by default. When the conversation is reassigned, the system message is sent under the human avatar name set in the [Webchat v3 Endpoint settings](/webchat/v3/configuration#webchat-layout).                                                                                                                                                                                                                                                                                                                                                  |
    | Get Queue Position                     | Enable the system to retrieve the end user's current queue position. This parameter is inactive by default.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
    | Get Estimated Wait Time                | Enable the retrieval of the estimated wait time for the end user. This parameter is inactive by default.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
    | Alternative Update                     | Enable sending an alternative message to the end user when the maximum queue position is reached. This parameter is inactive by default.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
    | Maximum Queue Position                 | Set the threshold for the maximum queue position. If this threshold is reached, the alternative text is sent instead of the actual queue position. This parameter appears if **Alternative Update** is selected.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
    | Alternative Text                       | Specify the message to be sent when the maximum queue position is reached. This parameter appears if **Alternative Update** is selected.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
  ...
  <Accordion title="NiCE CXone Settings">
    ...
    | Display Agent Details            | Display the human agent's name and avatar from NiCE CXone in the chat for the end user. This parameter is disabled by default.               |
    | Custom Attributes                | Add custom attributes in JSON format to include additional information the handover. For more information, refer to [NiCE CXone](/ai/escalate/handover-reference/nice-cxone/overview).                            |
  ...
  <Accordion title="Genesys Settings">
    ...
    | Enable User Connects Message    | Notify human agents when an end user reconnects to the chat. The parameter is enabled by default. When the parameter is enabled, the message `User joined the conversation` appears in the chat as soon as the end user returns to the chat tab by clicking the **←** (back arrow) at the top bar in the browser, after having opened a new URL on the same tab as the chat. |
    | Enable User Disconnects Message | Notify human agents when an end user disconnects from the chat. The parameter is enabled by default. When the parameter is enabled, the message `User left the conversation` is sent as soon as the end user closes the tab with the chat or switches to a new URL address within the current tab.                                                                           |
    | Display Agent Details           | Display the human agent's name and avatar from Genesys in the chat for the end user. This parameter is disabled by default.                                                                                                                                                                                                                                                  |
