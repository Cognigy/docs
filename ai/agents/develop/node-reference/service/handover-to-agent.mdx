...
<a href="/release-notes/2025.19">
  <img noZoom src="https://img.shields.io/badge/Updated in-v2025.19-blue.svg" />
</a>
...
2. **Integration with Agent Handover**. Once the **Handover to Agent** Node is triggered, it sends a handover request to the contact center configured in the [Endpoint Handover Settings](/ai/agents/deploy/endpoints/handover-settings), allowing a human agent to take over the conversation.
