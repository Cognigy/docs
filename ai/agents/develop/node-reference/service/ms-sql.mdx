---
title: MS SQL
keywords: ['ms sql', 'sql server', 'database query', 'sql node', 'stored procedure']
---

<Frame>
  <img src="/_assets/ai/develop/node-reference/services/run-sql-query.png" alt="MS SQL Node configuration panel" style={{ width: 'auto' }} />
</Frame>
...
|-------------------|---------------|--------------------------------------------------------------------------------------------------------------------------|
| MS SQL Connection | List          | Select MS SQL database connection. To create a new connection, click ![add MS SQL connection](/_assets/icons/plus-simple.svg). |
