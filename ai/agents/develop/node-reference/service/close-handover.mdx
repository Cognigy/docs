...
keywords: ['close handover', 'handover provider', 'live agent', 'human handover', 'agent escalation']
---

<Frame>
  <img class="image-center" src="/_assets/ai/develop/node-reference/services/close-handover.png" alt="Close Handover Node configuration panel" style={{ width: 'auto' }} />
</Frame>
