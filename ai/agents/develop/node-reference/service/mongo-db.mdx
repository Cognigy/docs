...
<Frame>
  <img class="image-center" src="/_assets/ai/develop/node-reference/services/mongo-db-find.png" alt="MongoDB Node configuration panel with find operation" style={{ width: 'auto' }} />
</Frame>
