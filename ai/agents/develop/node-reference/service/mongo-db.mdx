---
title: MongoDB
keywords: ['mongodb', 'database node', 'nosql', 'database query', 'data storage']
seo:
  metatags:
    description: >-
      The MongoDB Nodes allow you to execute a range of operations on your
      MongoDB database, such as find, update, and remove operations.
---
...
<Frame>
  <img src="/_assets/ai/develop/node-reference/services/mongo-db-find.png" alt="MongoDB Node configuration panel with find operation" style={{ width: 'auto' }} />
</Frame>
...
|--------------------|---------------|---------------------------------------------------------------------------------------------------------------------------|
| MongoDB Connection | List          | Select MongoDB database connection. To create a new connection, click ![add MongoDB connection](/_assets/icons/plus-simple.svg). |
