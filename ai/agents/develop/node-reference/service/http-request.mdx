...
<Frame>
  <img class="image-center" src="/_assets/ai/develop/node-reference/services/http-request.png" alt="HTTP Request Node configuration panel" style={{ width: 'auto' }} />
</Frame>
...
<AccordionGroup>
  ...
  <Accordion title="POST, PATCH, and PUT">
    ...
    **Payload**
    ...
    - **JSON** — consists of key-value pairs. When using a JSON payload to access Cognigy.AI objects such as Input, Context, or Profile, refer to [CognigyScript](/ai/platform-features/cognigyscript) for an example payload.
