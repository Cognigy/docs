...
<a href="/release-notes/2025.23"><img noZoom src="https://img.shields.io/badge/Updated in-v2025.23-blue.svg" /></a>
...
<AccordionGroup>
  ...
  <Accordion title="Tool Settings">
    The process of setting up a tool is the same as for the AI Agent Node. See the example in the [AI Agent Tool Settings](/ai/agents/develop/node-reference/ai/ai-agent#ai-agent-tool-settings) section.
...
<Accordion title="Image Handling">
  ...
  <ul>
    <li>**Minify** — reduces the size of these images to 512x512px.</li>
    <li>**Drop** — excludes the images.</li>
    <li>**Keep** — sends the max size (this option consumes more tokens).</li>
  </ul>{" "}
