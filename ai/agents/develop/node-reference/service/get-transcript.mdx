...
- The Get Transcript Node stores only plain text in the conversation transcript. Structured data, such as [Text with Buttons and Text with Quick Replies](/ai/agents/develop/node-reference/basic/say#default-cognigy-ai-channel), isn't included in the transcript. You can access the full transcript in the [Transcript Explorer](/insights/explorers/transcript) or with the [OData endpoint](/ai/agents/analyze/odata).
