...
<Frame>
  <img class="image-center" src="/_assets/ai/develop/node-reference/services/check-agent-availability.png" alt="Check Agent Availability Node configuration panel" style={{ width: 'auto' }} />
</Frame>
...
<AccordionGroup>
  ...
  <Accordion title="Genesys Cloud">

    These settings are applicable to both [Genesys Cloud Guest Chat](/ai/escalate/handover-reference/genesys-cloud-guest-chat) and [Genesys Cloud Open Messaging](/ai/escalate/handover-reference/genesys-cloud-open-messaging).
  ...
  <Accordion title="Chatwoot">

    | Parameter         | Type          | Description                      |
    |-------------------|---------------|----------------------------------|
    | Chatwoot Inbox Id | CognigyScript | The ID of your Inbox in Chatwoot. |
  </Accordion>
...
<Frame>
  <img class="image-center" src="/_assets/ai/develop/node-reference/services/check-agent-availability-flow.png" alt="Check Agent Availability example Flow with If and Handover Nodes" style={{ width: 'auto' }} />
</Frame>
