...
<Frame>
  <img class="image-center" src="/_assets/ai/develop/node-reference/services/check-agent-availability.png" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
  <img class="image-center" src="/_assets/ai/develop/node-reference/services/check-agent-availability-flow.png" style={{ width: 'auto' }} />
</Frame>
