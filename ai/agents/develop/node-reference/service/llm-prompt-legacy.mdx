...
keywords: ['llm prompt', 'generative ai', 'large language model', 'ai text generation', 'prompt node']
seo:
  metatags:
    description: >-
...
<Warning>
  As of Cognigy.AI 4.97.0, this Node is deprecated. Use a [new version](/ai/agents/develop/node-reference/service/llm-prompt) of this Node to get more flexibility when building AI Agents.
</Warning>
