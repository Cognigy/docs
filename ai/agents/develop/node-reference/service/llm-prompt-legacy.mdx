...
<a href="/release-notes/4.97">
  <img noZoom src="https://img.shields.io/badge/Updated in-v4.97-blue.svg" />
</a>
...
<AccordionGroup>
  ...
  <Accordion title="Custom Options">
    ...
    **Forcing Model Versions**
    ...
    1. [Create an Anthropic LLM resource](/ai/agents/develop/gen-ai-and-llms/providers/anthropic) for Claude-1, for example, `claude-3-5-sonnet-20240620`.
