...
<Frame>
  <img src="/_assets/ai/develop/node-reference/services/set-handover-inactivity.png" alt="Set Handover Inactivity Node configuration panel" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
  <img src="/_assets/ai/develop/node-reference/other/set-handover-inactivity-lookup.png" alt="Lookup Node configured for handover inactivity behavior" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
  <img src="/_assets/ai/develop/node-reference/other/set-handover-inactivity-if.png" alt="If Node with handover inactivity count condition" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
  <img src="/_assets/ai/develop/node-reference/other/set-handover-inactivity-say.png" alt="Say Node with inactivity prompt message for the user" style={{ width: 'auto' }} />
</Frame>
