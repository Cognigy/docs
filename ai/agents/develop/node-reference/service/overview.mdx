...
keywords: ['service nodes', 'api integration', 'database connector', 'handover', 'http request']
...
<CardGroup cols={3}>
  <Card
    ...
    href="/ai/agents/develop/node-reference/service/add-transcript-step"
  >
    The Add Transcript Step Node adds a step for one of the conversation actors to simulate an input or output.
  </Card>
  <Card
  ...
  <Card
    title="Get Token"
    href="/ai/agents/develop/node-reference/service/get-token"
  >
  ...
  <Card
    ...
    href="/ai/agents/develop/node-reference/service/invalidate-token"
  >
  ...
  >
    This Node combines the capabilities of the AI Agent Node with support for tools, image recognition, and conversation transcripts.
  </Card>
  <Card
    title="MongoDB Nodes"
  ...
  <Card
    title="Token Status"
    href="/ai/agents/develop/node-reference/service/token-status"
  >
