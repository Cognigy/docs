...
keywords: ['node reference', 'flow nodes', 'cognigy nodes', 'ai agent nodes', 'flow configuration']
sidebarTitle: Overview
description: Explore the Node reference documentation for configuring Flows in Cognigy, including Basic, Logic, Voice, Analytics, Service, AI, and other Node categories.
---
...
<CardGroup cols={3}>
  ...
  <Card
    title="CXone"
    href="/ai/agents/develop/node-reference/cxone/overview"
  >
  ...
  >
    AI Nodes are a collection of Nodes for Cognigy [NLU](/ai/platform-features/nlu/overview) and [Agentic AI](/ai/agents/overview).
  </Card>
  <Card
    title="Data"
