...
description: Explore the Node reference documentation for configuring Flows in Cognigy.AI, including Basic, Logic, Voice, Analytics, Service, AI, and other Node categories.
---
