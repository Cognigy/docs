...
description: "Use the Regex Slot Filler Node to fill Slots with regular expressions, giving you precise control over pattern-based slot extraction."
keywords: ['regex slot filler', 'regular expression', 'slots', 'nlu', 'pattern matching']
---

<Frame>
  <img src="/_assets/ai/develop/node-reference/ai/regex-slot-filler.png" alt="Regex Slot Filler Node configuration panel" style={{ width: 'auto' }} />
</Frame>
