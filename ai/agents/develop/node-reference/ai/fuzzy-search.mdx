...
seo:
  metatags:
    description: >-
      The Fuzzy Search Node enables a Flow to search fuzzy string patterns in a
      list of source data and returns the best possible matches.
keywords: ['similarity scoring', 'data retrieval', 'string matching', 'fuzzy search']
---

<Frame>
  <img class="image-center" src="/_assets/ai/develop/node-reference/ai/fuzzy-search.png" alt="Fuzzy Search Node configuration panel" style={{ width: 'auto' }} />
</Frame>
...
The matches can be stored in either the [Context](/ai/agents/develop/ai-agent-memory/context) or [Input](/ai/agents/develop/ai-agent-memory/input) object.
...
<AccordionGroup>
  ...
  <Accordion title="Fuzzy Matching Options">
...
<Accordion title="Error: this.docs.forEach is not a function">
