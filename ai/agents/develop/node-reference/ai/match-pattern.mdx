---
title: Match Pattern
description: "Use the Match Pattern Node to detect text patterns in user input and expose the matches in the Input object for use within a Flow."
keywords: ['match pattern', 'pattern matching', 'slots', 'nlu', 'input object']
---

<Frame>
  <img src="/_assets/ai/develop/node-reference/ai/match-pattern.png" alt="Match Pattern Node configuration panel" style={{ width: 'auto' }} />
</Frame>
