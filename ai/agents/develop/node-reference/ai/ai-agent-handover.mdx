...
keywords: ['ai agent handover', 'flow transfer', 'conversation handover', 'entrypoint', 'agentic ai']
seo:
  metatags:
    description: >-
...
<Frame>
  <img class="image-center" src="/_assets/ai/develop/node-reference/ai/ai-agent-handover.png" alt="AI Agent Handover Node configuration panel" style={{ width: 'auto' }} />
</Frame>
