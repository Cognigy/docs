...
| Select Node | Selector | Select the Node to hand over to. You must set the Node as an Entrypoint before you can select it. To set the Node as an Entrypoint, use the [Set Entrypoint](/ai/agents/develop/nodes/overview#set-node-as-entrypoint) setting. |
