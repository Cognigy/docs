---
title: Load AI Agent
keywords: ['load ai agent node', 'load ai agent']
seo:
  metatags:
    description: >-
...
<Frame>
  <img class="image-center" src="/_assets/ai/develop/node-reference/ai/load-ai-agent.png" alt="Load AI Agent Node configuration panel" style={{ width: 'auto' }} />
</Frame>
