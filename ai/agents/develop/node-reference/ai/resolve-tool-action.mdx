...
<Frame>
  <img class="image-center" src="/_assets/ai/develop/node-reference/ai/resolve-tool-action.png" alt="Resolve Tool Action Node configuration panel" style={{ width: 'auto' }} />
</Frame>
