...
<Frame>
  <img class="image-center" src="/_assets/ai/develop/node-reference/ai/copy-slots-to-context.png" alt="Copy Slots to Context Node configuration panel" style={{ width: 'auto' }} />
</Frame>
