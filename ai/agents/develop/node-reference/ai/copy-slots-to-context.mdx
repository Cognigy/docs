...
description: "Use the Copy Slots to Context Node to store a found Slot value in a specific place in the Context for later reuse throughout a Flow."
keywords: ['slots', 'context', 'nlu', 'lexicon', 'slot extraction']
---

<Frame>
  <img src="/_assets/ai/develop/node-reference/ai/copy-slots-to-context.png" alt="Copy Slots to Context Node configuration panel" style={{ width: 'auto' }} />
</Frame>
