...
<Frame>
  <img class="image-center" src="/_assets/ai/develop/node-reference/ai/add-lexicon-keyphrase.png" alt="Add Lexicon Keyphrase Node configuration panel" style={{ width: 'auto' }} />
</Frame>
