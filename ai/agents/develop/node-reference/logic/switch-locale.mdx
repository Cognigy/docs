---
title: Switch Locale
keywords: ['switch locale', 'localization', 'language detection', 'multilingual', 'flow locale']
---

<Frame>
  <img class="image-center" src="/_assets/ai/develop/node-reference/logic/switch-locale.png" alt="Switch Locale Node configuration panel" style={{ width: 'auto' }} />
</Frame>
