...
keywords: ['remove from context', 'context object', 'delete context', 'session data', 'flow memory']
---

<Frame>
  <img class="image-center" src="/_assets/ai/develop/node-reference/logic/remove-from-context.png" alt="Remove From Context Node configuration panel" style={{ width: 'auto' }} />
</Frame>
