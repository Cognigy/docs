...
<Frame>
  <img class="image-center" src="/_assets/ai/develop/node-reference/logic/set-state.png" alt="Set State Node" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
  <img class="image-center" src="/_assets/ai/develop/node-reference/logic/set-state-example.png" alt="Set State example Flow in the Interaction Panel" style={{ width: 'auto' }} />
</Frame>
