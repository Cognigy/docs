...
<Frame>
  <img class="image-center" src="/_assets/ai/develop/node-reference/logic/set-state.png" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
  <img class="image-center" src="/_assets/ai/develop/node-reference/logic/set-state-example.png" style={{ width: 'auto' }} />
</Frame>
