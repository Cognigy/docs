...
<Frame>
  <img src="/_assets/ai/develop/node-reference/logic/go-to.png" alt="Go To Node configuration panel" style={{ width: 'auto' }} />
</Frame>
...
<AccordionGroup>
  ...
  <Accordion title="Loops">
    Cognigy checks how often a Go To Node was activated without a user input in-between. The default setting for maximum loops is 4, but it is configurable for on-premises installations.
  </Accordion>
</AccordionGroup>
