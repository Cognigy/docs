---
title: Logic
keywords: ['logic nodes', 'flow control', 'conditional logic', 'if node', 'flow execution']
...
<CardGroup cols={3}>
  ...
  <Card
    ...
    href="/ai/agents/develop/node-reference/logic/copy-data-to-context"
  >
    The Copy Data To Context Node copies the contents of the Input `data` object into the [Context](/ai/agents/develop/ai-agent-memory/context) object.
  </Card>
  <Card
    title="Execute Flow"
