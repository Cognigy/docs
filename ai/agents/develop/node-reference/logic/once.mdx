---
title: Once
keywords: ['once node', 'single execution', 'flow loop prevention', 'conditional execution']
---

<Frame>
  <img class="image-center" src="/_assets/ai/develop/node-reference/logic/once.png" alt="Once Node configuration panel" style={{ width: 'auto' }} />
</Frame>
