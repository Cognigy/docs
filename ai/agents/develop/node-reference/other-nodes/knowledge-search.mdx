...
<Frame>
  <img class="image-center" src="/_assets/ai/develop/node-reference/other/knowledge-search.png" alt="Knowledge Search Node configuration panel" style={{ width: 'auto' }} />
</Frame>
