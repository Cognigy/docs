...
keywords: ['knowledge search', 'knowledge ai', 'knowledge store', 'content retrieval', 'semantic search']
seo:
  metatags:
    description: >-
...
3. In the **Text** field, click ![token](/_assets/icons/black-and-white/token.svg) and select the **KSearch:TopK Texts** Token.
4. Click **Save Node**.
