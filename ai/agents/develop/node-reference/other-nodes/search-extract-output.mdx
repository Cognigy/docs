...
<Frame>
  <img class="image-center" src="/_assets/ai/develop/node-reference/other/search-extract-output.png" style={{ width: 'auto' }} />
</Frame>
...
<AccordionGroup>
  ...
  <Accordion title="Custom Options">
    ...
    **Forcing Model Versions**
    ...
    2. Create a Flow and add an Search Extract Output Node to it.
