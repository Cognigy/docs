...
<a href="/release-notes/4.97"><Badge color="blue">Updated in 4.97</Badge></a>
...
For more information, refer to the [list of supported providers](/ai/agents/develop/gen-ai-and-llms/model-support-by-feature).
