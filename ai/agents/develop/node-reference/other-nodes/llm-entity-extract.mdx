...
<Frame>
  <img class="image-center" src="/_assets/ai/develop/node-reference/other/llm-entity-extract.png" alt="LLM Entity Extract Node configuration panel" style={{ width: 'auto' }} />
</Frame>
