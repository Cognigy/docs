---
title: Log Message
keywords: ['log message', 'project logs', 'flow logging', 'error logging', 'debug logging']
seo:
  metatags:
...
<Frame>
  <img class="image-center" src="/_assets/ai/develop/node-reference/other/log-message.png" alt="Log Message Node configuration panel" style={{ width: 'auto' }} />
</Frame>
