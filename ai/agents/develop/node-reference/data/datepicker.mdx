---
title: Datepicker
keywords: ['datepicker', 'date selection', 'date input', 'calendar widget', 'date range']
---

<Frame>
  <img class="image-center" src="/_assets/ai/develop/node-reference/datepicker.png" alt="Datepicker Node configuration panel" style={{ width: 'auto' }} />
</Frame>
