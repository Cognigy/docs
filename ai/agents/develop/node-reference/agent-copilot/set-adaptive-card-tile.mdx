...
<Frame>
  <img src="/_assets/ai/develop/node-reference/agent-copilot/set-adaptive-card-tile.png" alt="Copilot Adaptive Card Tile Node configuration panel" style={{ width: 'auto' }} />
</Frame>
...
<Accordion title="Create an Adaptive Card with Generative AI">
  ...
  <Frame>
    <img src="/_assets/ai/develop/node-reference/agent-copilot/adaptive-card-generative-ai.png" alt="Adaptive Card Tile editor with Generative AI prompt" style={{ width: 'auto' }} />
  </Frame>
</Accordion>
