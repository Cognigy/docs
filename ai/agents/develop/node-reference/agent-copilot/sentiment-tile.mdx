...
keywords: ['agent copilot', 'sentiment analysis', 'emotional tone', 'sentiment tile', 'customer feedback']
---
...
<Frame>
  <img class="image-center" src="/_assets/ai/develop/node-reference/agent-copilot/sentiment-tile.png" alt="Copilot Sentiment Tile Node configuration panel" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
  <img class="image-center" src="/_assets/ai/develop/node-reference/agent-copilot/sentiment-tile-example.png" alt="Sentiment Tile widget showing emotional tone analysis in Agent Copilot" style={{ width: 'auto' }} />
</Frame>
