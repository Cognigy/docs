...
- Add a [compatible LLM](/ai/agents/develop/gen-ai-and-llms/model-support-by-feature#model-support-by-feature) and select the LLM in the [Generative AI settings](/ai/agents/develop/gen-ai-and-llms/generative-ai).
