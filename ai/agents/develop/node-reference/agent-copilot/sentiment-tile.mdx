...
<Frame>
  <img src="/_assets/ai/develop/node-reference/agent-copilot/sentiment-tile.png" alt="Copilot Sentiment Tile Node configuration panel" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
  <img src="/_assets/ai/develop/node-reference/agent-copilot/sentiment-tile-example.png" alt="Sentiment Tile widget showing emotional tone analysis in Agent Copilot" style={{ width: 'auto' }} />
</Frame>
