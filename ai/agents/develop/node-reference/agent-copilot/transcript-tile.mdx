...
keywords: ['agent copilot', 'transcript tile', 'voice transcript', 'sentiment analysis', 'copilot widget']
---
...
<Frame>
  <img src="/_assets/ai/develop/node-reference/agent-copilot/transcript-tile.png" alt="Copilot Transcript Tile Node configuration panel" style={{ width: 'auto' }} />
</Frame>
...
| Enable sentiment | Toggle        | This option allows you to decide if sentiment analysis should be applied to the customer's voice input. Enabling this option means that Cognigy assesses the emotional tone (positive, negative, or neutral) of the input. |
...
<Frame>
  <img src="/_assets/ai/develop/node-reference/agent-copilot/transcript-tile-example.png" alt="Transcript Tile widget displaying voice call transcript in Agent Copilot" style={{ width: 'auto' }} />
</Frame>
