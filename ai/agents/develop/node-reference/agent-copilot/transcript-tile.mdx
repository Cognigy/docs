...
<Frame>
  <img class="image-center" src="/_assets/ai/develop/node-reference/agent-copilot/transcript-tile.png" alt="Copilot Transcript Tile Node configuration panel" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
  <img class="image-center" src="/_assets/ai/develop/node-reference/agent-copilot/transcript-tile-example.png" alt="Transcript Tile widget displaying voice call transcript in Agent Copilot" style={{ width: 'auto' }} />
</Frame>
