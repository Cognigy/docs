...
<Frame>
  <img class="image-center" src="/_assets/ai/develop/node-reference/agent-copilot/secure-forms.png" alt="Copilot SecureForms Tile Node configuration panel" style={{ width: 'auto' }} />
</Frame>
...
Any credit card information will be securely stored within the [Cognigy PCI Vault](/pci-vault/overview) product, which is PCI-certified.
