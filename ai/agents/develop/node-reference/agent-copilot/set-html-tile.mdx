...
keywords: ['agent copilot', 'html tile', 'custom html', 'iframe', 'copilot widget']
seo:
  metatags:
    description: >-
...
<Frame>
  <img class="image-center" src="/_assets/ai/develop/node-reference/agent-copilot/set-html-tile.png" alt="Copilot HTML Tile Node configuration panel" style={{ width: 'auto' }} />
</Frame>
