...
<Frame>
  <img class="image-center" src="/_assets/ai/develop/node-reference/agent-copilot/set-iframe-tile.png" alt="Copilot IFrame Tile Node configuration panel" style={{ width: 'auto' }} />
</Frame>
...
<Steps>
  ...
  <Step title="Workspace receives the message">
    ...
    The HTML Tile doesn't need to be visible, but it must exist in the workspace.
