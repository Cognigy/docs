...
<Frame>
  <img src="/_assets/ai/develop/node-reference/agent-copilot/next-action-tile.png" alt="Copilot Next Action Tile Node configuration panel" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
  <img src="/_assets/ai/develop/node-reference/agent-copilot/next-action-tile-example.png" alt="Next Action Tile widget with guidance and links in Agent Copilot" style={{ width: 'auto' }} />
</Frame>
