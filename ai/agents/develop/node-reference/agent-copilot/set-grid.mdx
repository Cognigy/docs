...
keywords: ['agent copilot', 'set grid', 'workspace layout', 'grid configuration', 'copilot workspace']
---
...
<Frame>
  <img class="image-center" src="/_assets/ai/develop/node-reference/agent-copilot/set-grid.png" alt="Copilot Set Grid Node configuration panel" style={{ width: 'auto' }} />
</Frame>
...
| Background Selector        | Select        | Customizes the background color of the Agent Copilot workspace. You can select one of the following options:<ul><li>**Default** — the default white color.</li><li>**Solid Background Color** — specify the color in RGB or Hex format.</li><li>**Custom Image** — specify an image URL.</li></ul>                                     |
