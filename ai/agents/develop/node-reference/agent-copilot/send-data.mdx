...
keywords: ['agent copilot', 'send data', 'dynamic content', 'postmessage', 'iframe']
seo:
  metatags:
    description: >-
      The Copilot: Send Data Node lets you update the content within Agent
      Copilot widgets (iframe or HTML) without reloading the entire widget,
      making it easier to modify and refresh dynamic content in real time.
---
...
<Frame>
  <img class="image-center" src="/_assets/ai/develop/node-reference/agent-copilot/send-data.png" alt="Copilot Send Data Node configuration panel" style={{ width: 'auto' }} />
</Frame>
