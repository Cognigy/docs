...
keywords: ['agent copilot', 'identity tile', 'customer profile', 'contact data', 'copilot widget']
---
...
<Frame>
  <img class="image-center" src="/_assets/ai/develop/node-reference/agent-copilot/identity-tile.png" alt="Copilot Identity Tile Node configuration panel" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
  <img class="image-center" src="/_assets/ai/develop/node-reference/agent-copilot/identity-assist-example.png" alt="Identity Tile widget displaying customer profile data in Agent Copilot" style={{ width: 'auto' }} />
</Frame>
