...
keywords: ['agent copilot', 'knowledge tile', 'knowledge base', 'knowledge search', 'llm']
---
...
<Frame>
  <img src="/_assets/ai/develop/node-reference/agent-copilot/knowledge-tile.png" alt="Copilot Knowledge Tile Node configuration panel" style={{ width: 'auto' }} />
</Frame>
...
The Node uses the [inject API](/ai/agents/deploy/endpoints/inject-and-notify) to update the widget.
...
- The Copilot: Knowledge Tile Node doesn't support the [NiCE CXone AAH Endpoint](/agent-copilot/deploy/nice-aah). You can still add the Node to a Flow that uses this Endpoint, but the Node is skipped during Flow execution without breaking the Flow.
...
<Accordion title="Configure the Copilot: Knowledge Tile widget">
  ...
  <Frame>
    <img src="/_assets/ai/develop/node-reference/agent-copilot/knowledge-tile-flow.webp" alt="Knowledge Tile Flow configuration with If, Once, and Knowledge Tile Nodes" style={{ width: 'auto' }} />
  </Frame>
  ...
  <Frame>
    <img src="/_assets/ai/develop/node-reference/agent-copilot/knowledge-tile-example.png" alt="Knowledge Tile widget showing search results in Agent Copilot" style={{ width: 'auto' }} />
  </Frame>
</Accordion>
