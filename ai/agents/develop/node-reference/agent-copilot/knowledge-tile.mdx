...
<Frame>
  <img class="image-center" src="/_assets/ai/develop/node-reference/agent-copilot/knowledge-tile.png" alt="Copilot Knowledge Tile Node configuration panel" style={{ width: 'auto' }} />
</Frame>
...
<Accordion title="Configure the Copilot: Knowledge Tile widget">
  ...
  <Frame>
    <img class="image-center" src="/_assets/ai/develop/node-reference/agent-copilot/knowledge-tile-flow.webp" alt="Knowledge Tile Flow configuration with If, Once, and Knowledge Tile Nodes" style={{ width: 'auto' }} />
  </Frame>
  ...
  <Frame>
    <img class="image-center" src="/_assets/ai/develop/node-reference/agent-copilot/knowledge-tile-example.png" alt="Knowledge Tile widget showing search results in Agent Copilot" style={{ width: 'auto' }} />
  </Frame>
</Accordion>
