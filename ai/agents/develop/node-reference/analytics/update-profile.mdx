...
keywords: ['update profile', 'contact profile', 'profile schema', 'analytics', 'user data']
---

<Frame>
  <img class="image-center" src="/_assets/ai/develop/node-reference/analytics/update-profile.png" alt="Update Profile Node configuration panel" style={{ width: 'auto' }} />
</Frame>
