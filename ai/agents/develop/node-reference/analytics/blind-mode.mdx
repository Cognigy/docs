...
<Frame>
  <img class="image-center" src="/_assets/ai/develop/node-reference/analytics/blind-mode.png" alt="Blind Mode Node configuration panel" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
  <img class="image-center" src="/_assets/ai/develop/node-reference/analytics/blind-mode-example.png" alt="Flow editor showing Blind Mode On and Off Nodes around sensitive input" style={{ width: 'auto' }} />
</Frame>
