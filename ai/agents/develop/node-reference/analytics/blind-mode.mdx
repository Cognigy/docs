---
title: Blind Mode
keywords: ['blind mode', 'masking data', 'blind mode node']
tag: deprecated
seo:
  metatags:
    description: >-
...
<Frame>
  <img src="/_assets/ai/develop/node-reference/analytics/blind-mode.png" alt="Blind Mode Node configuration panel" style={{ width: 'auto' }} />
</Frame>

## Description

<Warning>
  As of Cognigy 2026.18.0, the Blind Mode Node is deprecated. The removal is planned for March 2027. Use the [Data Redaction](/ai/platform-features/data-redaction) feature instead.
</Warning>

Cognigy logs conversations to operate, maintain, and improve the service, but user inputs can sometimes contain sensitive information, such as names, addresses, phone numbers, or other private details. To protect this information, you can mask or exclude it from logs or analytics by using a Blind Mode Node.
...
<Frame>
  <img src="/_assets/ai/develop/node-reference/analytics/blind-mode-example.png" alt="Flow editor showing Blind Mode On and Off Nodes around sensitive input" style={{ width: 'auto' }} />
</Frame>
...
<AccordionGroup>
  <Accordion title="Mask Data in Analytics">
    To mask sensitive data in the Conversations explorer:

    1. In the **Blind Mode On** Node editor, activate the **Mask Analytics** option.
    2. Go to the Conversations explorer to explore the conversation transcript:
