...
<Frame>
  <img class="image-center" src="/_assets/ai/develop/node-reference/analytics/complete-task.png" alt="Complete Task Node configuration panel" style={{ width: 'auto' }} />
</Frame>
...
The [top tasks](/insights/reports/engagement#tasks-reached) are listed in the Insights Engagement report
and allow you to track and analyze their frequency. 
If you don't intend to analyze Contact Profiles and prefer a more focused analysis using the [Insights Step explorer](/insights/explorers/step), then [Analytics Steps](/ai/agents/analyze/analytics-steps) are more suitable.
