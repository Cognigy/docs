...
keywords: ['overwrite analytics', 'analytics data', 'insights', 'intent tracking', 'odata']
seo:
  metatags:
    description: >-
      An Overwrite Analytics Node lets you overwrite default values such as
      intent, text, understood messages, and more, and manage the analytics data
      stored in the Cognigy.AI Analytics database.
---

import AiUnderstoodMessages from '/snippets/ai/understood-messages.mdx'

<Frame>
  <img class="image-center" src="/_assets/ai/develop/node-reference/analytics/overwrite-analytics.png" alt="Overwrite Analytics Node configuration panel" style={{ width: 'auto' }} />
</Frame>
...
as well as manage the analytics data stored in the [Analytics](/ai/agents/analyze/collecting-data) database.
You can view this data on the [Insights reports](/insights/overview) or retrieve it via the [Cognigy.AI OData Endpoint](/ai/agents/analyze/odata).
...
<AccordionGroup>
  <Accordion title="Anonymize Personal Data for Privacy in OData">
  ...
  <Accordion title="Clean Up NLU Metrics with Understood">
