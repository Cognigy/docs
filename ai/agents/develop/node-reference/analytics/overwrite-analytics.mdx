...
seo:
  metatags:
    description: >-
      ...
      stored in the Cognigy Analytics database.
---
...
You can view this data on the [Insights reports](/insights/overview) or retrieve it via the [Cognigy OData Endpoint](/ai/agents/analyze/odata).
