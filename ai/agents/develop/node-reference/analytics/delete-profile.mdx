...
<Frame>
  <img class="image-center" src="/_assets/ai/develop/node-reference/analytics/delete-profile.png" alt="Delete Profile Node configuration panel" style={{ width: 'auto' }} />
</Frame>
