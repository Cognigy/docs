...
<Frame>
  <img class="image-center" src="/_assets/ai/develop/node-reference/analytics/deactivate-profile.png" alt="Deactivate Profile Node configuration panel" style={{ width: 'auto' }} />
</Frame>
