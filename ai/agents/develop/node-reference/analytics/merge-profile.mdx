---
title: Merge Profile
keywords: ['merge profile', 'contact profile', 'omnichannel', 'user identity', 'analytics']
---

<Frame>
  <img class="image-center" src="/_assets/ai/develop/node-reference/analytics/merge-profile.png" alt="Merge Profile Node configuration panel" style={{ width: 'auto' }} />
</Frame>
