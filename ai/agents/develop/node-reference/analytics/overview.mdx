...
keywords: ['analytics nodes', 'contact profile', 'insights', 'goal tracking', 'task tracking']
---

Analytics Nodes let you take advantage of Cognigy's comprehensive marketing functionality. Use and update [Contact Profiles](/ai/agents/analyze/contact-profiles) within your Flow for personalized, adaptive Flows that connect with your audience.
...
<CardGroup cols={3}>
  ...
  >
    The Set Rating Node extends the analytical capabilities of Cognigy together with the [Insights](/insights/overview) application.
  </Card>
  <Card
