---
title: Track Goal
keywords: ['track goal', 'goal tracking', 'analytics', 'insights', 'flow metrics']
seo:
  metatags:
    description: >-
...
<Frame>
  <img class="image-center" src="/_assets/ai/develop/node-reference/analytics/track-goal.png" alt="Track Goal Node configuration panel" style={{ width: 'auto' }} />
</Frame>
