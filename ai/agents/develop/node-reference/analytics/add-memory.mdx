---
title: Add Memory
keywords: ['add memory', 'contact profile', 'long-term memory', 'ai agent', 'personalization']
seo:
  metatags:
    description: >-
...
<Frame>
  <img class="image-center" src="/_assets/ai/develop/node-reference/analytics/add-memory.png" alt="Add Memory Node configuration panel" style={{ width: 'auto' }} />
</Frame>
