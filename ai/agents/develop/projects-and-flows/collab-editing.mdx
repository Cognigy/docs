...
- When the changes are saved, the Node editor displays the ![refresh-icon](/_assets/icons/blue/refresh.svg) button. Then, you can:
  - Click the ![refresh-icon](/_assets/icons/blue/refresh.svg) button to refresh the Node editor and view the latest changes.
  - Select ![vertical-ellipsis](/_assets/icons/black-and-white/vertical-ellipsis.svg) **> Edit** to unlock and keep editing the Node. The changes you save after unlocking the Node overwrite the changes other users previously made.
