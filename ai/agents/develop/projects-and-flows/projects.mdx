...
Projects include [Flows](/ai/agents/develop/projects-and-flows/overview), [Endpoints](/ai/agents/deploy/endpoints/overview), [Connections](/ai/platform-features/connections), and many other resources you need to build an AI Agent.
...
<a href="/release-notes/4.65"><Badge color="blue">Updated in 4.65</Badge></a>
