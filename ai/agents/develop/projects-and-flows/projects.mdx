---
title: Projects
keywords: ['projects', 'ai agents', 'flows', 'endpoints']
seo:
  metatags:
    description: >-
      Cognigy Projects contain collections of Conversational AI resources,
...
<Tabs>
  ...
  <Tab title="API">
        You can view, create, and manage Projects using the [Cognigy API](https://api-trial.cognigy.ai/openapi#get-/v2.0/projects).
  </Tab>
  <Tab title="CLI">
        You can access Project resources, for example, AI Agents, Flows, and Endpoints, using the [Cognigy CLI](https://github.com/Cognigy/Cognigy-CLI?tab=readme-ov-file#cognigy-command-line-interface-cli).
  </Tab>
</Tabs>
