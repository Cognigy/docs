...
sidebarTitle: "Voice"
slug: "quickstart-guide-for-voice-ai-agents"
hidden: false
keywords: ["voice", "ai agent", "quickstart"]
"seo": {
  "metatags": {
    "description": "This guide provides a quickstart guide for building a voice AI Agent using Cognigy.AI."
  }
}
---
...
<img class="image-center" src="/_assets/ai/develop/getting-started-voice.png" />
