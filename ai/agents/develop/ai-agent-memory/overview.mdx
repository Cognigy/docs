...
keywords: ['ai agent memory', 'cognigy.ai objects', 'input object', 'context object', 'profile object', 'memory access']
seo:
  metatags:
    description: >-
...
<Frame>
  <img class="image-center" src="/_assets/ai/develop/life-span.png" alt="Comparison of Input, Context, and Profile object lifespans" style={{ width: 'auto' }} />
</Frame> 
