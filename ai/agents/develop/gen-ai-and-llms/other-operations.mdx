...
keywords: ['llm', 'delete llm', 'clone llm', 'default llm', 'export llm']
seo:
  metatags:
    description: >-
      Once you've added an LLM to Cognigy, you can perform the following
      operations with your model: clone, set as default, export, or delete.
---

Once you've added an LLM to Cognigy, you can perform the following operations with your model:
...
<AccordionGroup>
  <Accordion title="Clone a Model">
    <Tabs>
      <Tab title="GUI">
             ...
             1. Go to **Build > LLM**.
             2. Hover over the existing model and click ![menu](/_assets/icons/black-and-white/vertical-ellipsis.svg).
             3. Select **Clone** from the list.

             The model will contain the same settings as the initial one.
      </Tab>
      <Tab title="API">
             To create a copy of the existing model, use the [Cognigy API POST /v2.0/largelanguagemodels/{largeLanguageModelId}/clone](https://api-trial.cognigy.ai/openapi#post-/v2.0/largelanguagemodels/-largeLanguageModelId-/clone) request.
  ...
  <Accordion title="Set a Model as Default">
    ...
    <Tabs>
      ...
      <Tab title="API">
            To set a model as the default, use the `"isDefault": true` parameter in the [Cognigy API PATCH /v2.0/largelanguagemodels/{largeLanguageModelId}](https://api-trial.cognigy.ai/openapi#patch-/v2.0/largelanguagemodels/-largeLanguageModelId-) request. 
  ...
  <Accordion title="Delete a Model">
    ...
    <Tabs>
      ...
      <Tab title="API">
            To delete a model, use the [Cognigy API DELETE /v2.0/largelanguagemodels/{largeLanguageModelId}](https://api-trial.cognigy.ai/openapi#delete-/v2.0/largelanguagemodels/-largeLanguageModelId-).
      </Tab>
    </Tabs>
  </Accordion>
</AccordionGroup>
