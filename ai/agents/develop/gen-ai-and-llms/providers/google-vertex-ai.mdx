...
keywords: ['llms', 'google vertex ai', 'google vertex ai models']
seo:
  metatags:
    description: >-
      To start using a Google Vertex AI LLMs with Cognigy features, add the
...
<CompletionApiDeprecation/>

To start using a Google Vertex AI or Gemini model with Cognigy features, follow these steps:
...
To add a model provided by Google Vertex AI to Cognigy, follow these steps:

<Tabs>
  <Tab title="Standard Model (Cognigy 2025.15 and earlier versions)">
