---
title: Google Gemini
keywords: ['llms', 'google gemini', 'google gemini models']
seo:
  metatags:
    description: >-
      To start using a Google Gemini LLMs with Cognigy features, add the LLM
...
To start using a Google Gemini model with Cognigy features, follow these steps:
...
You can add a model provided by Google Gemini to Cognigy in **Build > LLM**. To add the model, you will need the following parameters:
