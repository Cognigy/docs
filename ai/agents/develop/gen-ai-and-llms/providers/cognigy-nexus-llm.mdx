...
seo:
  metatags:
    description: >-
      The Cognigy Nexus LLM is a proprietary large language model, provided and
      hosted by Cognigy, optimized for AI-driven customer service.
---
...
<Frame>
  <img class="image-center" src="/_assets/ai/empower/llms/cognigy-nexus-llm.png" alt="Cognigy Nexus LLM configuration within a Project" style={{ width: 'auto' }} />
