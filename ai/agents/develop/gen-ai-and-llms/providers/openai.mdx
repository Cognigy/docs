...
import AiGenerativeAiGpt5ReasoningEffortDefault from "/snippets/ai/generative-ai/gpt-5-reasoning-effort-default.mdx";
...
<AiGenerativeAiGpt5ReasoningEffortDefault />

To start using an OpenAI model with Cognigy features, follow these steps:
...
- The `gpt-5-5`, `gpt-5-6-sol`, `gpt-5-6-terra`, and `gpt-5-6-luna` models support only the Responses API.
...
You can add a model provided by OpenAI to Cognigy in **Build > LLM**. To add the model, you will need the following parameters:
