...
<a href="/release-notes/4.90"><img noZoom src="https://img.shields.io/badge/Added in-v4.90(Beta)-purple.svg" /></a>
...
- Using a fallback model overrides the [default retry mechanism](/ai/agents/develop/gen-ai-and-llms/llms#retry-mechanism).
