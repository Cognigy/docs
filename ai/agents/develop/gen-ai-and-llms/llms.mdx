...
sidebarTitle: LLMs
description: "Integrate LLMs from OpenAI, Azure, Anthropic, and more to enhance AI Agent conversations in Cognigy.AI."
...
<AccordionGroup>
  ...
  <Accordion title="Extract Specific Entities from User Inputs">
    ...
    <Frame>
      <img class="image-center" src="/_assets/ai/empower/llms/llm-entity-extract.png" alt="LLM Entity Extract Node tested in the Interaction Panel" style={{ width: 'auto' }}/>
  ...
  <Accordion title="Determine the Emotional Tone of the Conversation">
    ...
    <Frame>
      <img class="image-center" src="/_assets/ai/empower/llms/copilot-sentiment-tile.png" alt="Sentiment Analysis Tile widget in the Agent Copilot workspace" style={{ width: 'auto' }}/>
