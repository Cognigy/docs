...
<AccordionGroup>
  <Accordion title="Generate Lexicons">
    ...
    <Frame>
      <img class="image-center" src="/_assets/ai/empower/generative-ai/generating-lexicons.png" alt="Lexicon editor with AI-generated keyphrases" style={{ width: 'auto' }} />
    </Frame>
  ...
  <Accordion title="Generate Flows">
    ...
    <Frame>
      <img class="image-center" src="/_assets/ai/empower/generative-ai/generating-flows.png" alt="Flow with Nodes generated by Generative AI from a scenario" style={{ width: 'auto' }} />
    </Frame>
  ...
  <Accordion title="Generate Intent Sentences">
    ...
    <Frame>
      <img class="image-center" src="/_assets/ai/empower/generative-ai/generating-intent-sentences.png" alt="AI-generated example sentences for an Intent" style={{ width: 'auto' }} />
    </Frame>
...
<AccordionGroup>
  ...
  <Accordion title="Rephrasing AI Agent Outputs">
    ...
    <Frame>
      <img class="image-center" src="/_assets/ai/empower/generative-ai/generating-output.png" alt="AI-enhanced output rephrasing settings in a Say Node" style={{ width: 'auto' }} />
    </Frame>
