...
To open the Node Search field, click ![search](/_assets/icons/blue/search.svg) in the lower-left corner of the Flow editor.
...
<ExpandableTable
  ...
  rows={[
    ...
    ["Reference ID", "The ID you can use for setting a Node, for example, as an Entrypoint or for manipulating Nodes via the <a href=\"https://api-trial.cognigy.ai/openapi\">Cognigy API</a>. You can copy the Reference ID from the <img src=\"/_assets/icons/black-and-white/vertical-ellipsis.svg\" alt=\"more options\" /> menu in the Node editor."],
    ...
    ["If-condition expression", "The expression in the <strong>Condition</strong> field of an <a href=\"/ai/agents/develop/node-reference/logic/if\">If Node</a>. Use this to find and update variables, conditions, or logic used in If Nodes across large Flows."]
    ]}
    initialRowsToShow={3}
/>
...
When you enter a text into the Node Search field, the Flow editor highlights matching Nodes in yellow and scrolls to the first match. Use ![previous match](/_assets/icons/black-and-white/arrow-up.svg) and ![next match](/_assets/icons/black-and-white/arrow-down.svg) to navigate between matches. Click ![clear search](/_assets/icons/black-and-white/close-button.svg) to reset the search.

<Accordion title="Toggle Search Results">
  To close the Node Search field but keep the matching Nodes highlighted, click
  ![search](/_assets/icons/blue/search.svg) again.
</Accordion>
...
<Frame>
  <img
    ...
    alt="Node editor with a highlighted field matching the Node search text" style={{ width: 'auto' }} />
</Frame>
