...
<a href="/release-notes/4.48"><img noZoom src="https://img.shields.io/badge/Updated in-v4.48-blue.svg" /></a>
...
<AccordionGroup>
  ...
  <Accordion title="Messenger">
    ...
    <Accordion title="Use Code Nodes to Output Facebook Markup">
      You can use the [output action in Code Nodes](/ai/for-developers/code/actions) to send a JSON object directly to Facebook. To do so, set the following code as the data property:
