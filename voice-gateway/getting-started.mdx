...
<Frame>
<img class="image-center" src="/_assets/voice-gateway/VG-logo.png" alt="Cognigy Voice Gateway logo" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
   <img class="image-center" src="/_assets/voice-gateway/VG-endpoint-new.png" alt="Creating a new Voice Gateway Endpoint in Cognigy.AI" style={{ width: 'auto' }} />
</Frame>
