...
This setting allows users with the [Account](/voice-gateway/webapp/users#account) scope to log in to the Voice Gateway Self-Service Portal using their Cognigy.AI user credentials. To enable this option, you need to follow these steps:
