...
- **Continuity for Genesys customers.** Customers can keep their existing Cognigy and Voice Gateway integration if SIP calling is no longer available in Genesys Cloud.
...
<AccordionGroup>
  <Accordion title="1. Assign a number and use a test Flow">
    ...
    2. Route the phone number to a voice Flow in Cognigy to confirm the setup works end to end without affecting live traffic.
  </Accordion>
  <Accordion title="2. Place a test call">
    ...
    3. Confirm the call is handed off through the **Call Audio Connector** action and that the Cognigy voice Flow starts as expected.
  </Accordion>
</AccordionGroup>
