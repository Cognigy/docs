...
<Frame>
  <img src="/_assets/voice-gateway/VG-webapp-recent-calls.png" alt="Voice Gateway recent calls page displaying call history with date, direction, and duration" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
  <img src="/_assets/voice-gateway/tracing-details.png" alt="Call tracing report showing duration details for speech recognition and connection steps" />
</Frame>
...
<Frame>
  <img src="/_assets/voice-gateway/audio-player.png" alt="Embedded media player for listening to and downloading call recordings" />
</Frame>
