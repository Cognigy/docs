---
title: Recent Calls
description: "View and filter your Voice Gateway call history, including call duration, direction, SIP trunk data, PCAP traces, and call recording details."
keywords: ['recent calls', 'call history', 'call recording', 'pcap', 'call tracing']
---
...
<Frame>
  <img class="image-center" src="/_assets/voice-gateway/VG-webapp-recent-calls.png" alt="Voice Gateway recent calls page displaying call history with date, direction, and duration" style={{ width: 'auto' }} />
</Frame>
...
| terminated_at        | The time the call was ended.                                                                                                         |
...
<img class="image-center" src="/_assets/voice-gateway/tracing-details.png" alt="Call tracing report showing duration details for speech recognition and connection steps" />
...
<img class="image-center" src="/_assets/voice-gateway/audio-player.png" alt="Embedded media player for listening to and downloading call recordings" />
