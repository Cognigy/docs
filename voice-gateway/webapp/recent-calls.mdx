...
<a href="/release-notes/4.60"><img noZoom src="https://img.shields.io/badge/Updated in-v4.60-blue.svg" /></a>
...
You can delete a call recording by clicking ![delete](/_assets/icons/black-and-white/delete.svg). Note that this action will delete your file both from Voice Gateway and remote storage, for example, Amazon S3.

To download a call recording, click ![download](/_assets/icons/black-and-white/dowload.svg).