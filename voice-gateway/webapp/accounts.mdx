...
<Frame>
  <img class="image-center" src="/_assets/voice-gateway/VG-webapp-accounts.png" alt="Voice Gateway accounts page listing resource containers for voice applications" style={{ width: 'auto' }} />
</Frame>
