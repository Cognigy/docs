...
<Frame>
  <img class="image-center" src="/_assets/voice-gateway/VG-webapp-applications-overview.png" alt="Voice Gateway applications overview page with Endpoint routing and speech vendor defaults" style={{ width: 'auto' }}/>
</Frame>
