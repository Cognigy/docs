...
<Frame>
  <img class="image-center" src="/_assets/voice-gateway/VG-webapp-speech-services.png" alt="Voice Gateway speech services page listing configured TTS and STT vendors" style={{ width: 'auto' }} />
</Frame>
...
To configure the connection for a cloud-based speech service:
    ...
    <Tabs>
      ...
      <Tab title="Soniox">
            1. Enter an API key in the **API key** field. For more information on Soniox API keys, read the [Soniox Quick Start Guide](https://soniox.com/docs/stt/get-started).
          </Tab>
