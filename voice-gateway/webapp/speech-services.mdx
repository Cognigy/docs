...
<a href="/release-notes/2025.17"><img noZoom src="https://img.shields.io/badge/Updated in-v2025.17-blue.svg" /></a>
...
<Tabs>
  ...
  <Tab title="Soniox">
    ...
    Once you created a speech service, add this service to the [Application](/voice-gateway/webapp/applications).
  </Tab>
</Tabs>
...
6. In the **Label** field, create a label only if you need to create multiple speech services from the same vendor. Then, use the label in your [application](/voice-gateway/webapp/applications#add-additional-tts-and-stt-vendor) to specify which service to use.
