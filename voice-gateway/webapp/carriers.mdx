...
<Warning>
  ...
  <Frame>
    <img class="image-center" src="/_assets/voice-gateway/VG-webapp-carriers.png" alt="Voice Gateway carriers page listing SIP trunk connections" style={{ width: 'auto' }} />
  </Frame>
