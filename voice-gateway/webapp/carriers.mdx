...
4. Select an existing gateway you want to use for outbound communication or create a new one by clicking ![add SIP gateway](/_assets/icons/black-and-white/voice-gateway/plus.svg).
