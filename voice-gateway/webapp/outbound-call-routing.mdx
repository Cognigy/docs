...
description: "Configure outbound call routing rules in Voice Gateway to select SIP trunks and carriers for outbound calls."
keywords: ['outbound call routing', 'sip trunk', 'call routing rules', 'carrier selection', 'voice gateway']
---

_Outbound Call Routing_ allows you to select a [carrier](/voice-gateway/webapp/carriers) (SIP trunk) for outbound calls and configure specific rules for call routing.
...
You can create multiple rules and assign the same carrier to several of them. 
