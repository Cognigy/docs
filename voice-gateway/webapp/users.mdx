...
<Frame>
  <img class="image-center" src="/_assets/voice-gateway/VG-webapp-users.png" alt="Voice Gateway user management page showing member list with roles and permissions" style={{ width: 'auto' }} />
</Frame>
