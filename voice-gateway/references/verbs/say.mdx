...
- [Check supported speech vendors](/voice-gateway/references/tts-and-stt-vendors)
- [Add a custom speech API](/voice-gateway/webapp/speech-services#add-custom-speech-vendors)
...
| synthesizer.voice    | The voice to use. Check the voice lists of the vendor used. Defaults to the [Application](/voice-gateway/webapp/applications) setting, if provided. Required, if `synthesizer.vendor` is defined | No       |
