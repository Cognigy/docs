---
title: Transcribe
description: The verb for real-time call transcription.
...
Additional vendor-specific options are available through properties like `deepgramOptions`, `googleOptions`, `azureOptions`, `awsOptions`, `nuanceOptions`, `ibmOptions`, `nvidiaOptions`, `cobaltOptions`, `verbioOptions`, `speechmaticsOptions`, `assemblyAiOptions`, `openaiOptions`, and `customOptions`.
