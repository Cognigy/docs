...
The `transcribe` verb is only allowed to be nested within a [`dial`](/voice-gateway/references/verbs/dial) or [`listen`](/voice-gateway/references/verbs/listen) verb.
