---
title: Listen
description: The verb streams real-time call audio over WebSocket, supporting call recording, DTMF, and bidirectional audio.
keywords: ['cognigy voice gateway', 'listen verb', 'audio streaming', 'websocket', 'bidirectional audio', 'dtmf']
---
