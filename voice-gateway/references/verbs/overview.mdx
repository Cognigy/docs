...
description: Voice Gateway includes verbs to help you build voice AI Agents, including dial, hangup, listen, gather, and speech configuration with Code Node examples.
keywords: ['voice gateway verbs', 'voice nodes', 'dial', 'gather', 'call control']
sidebarTitle: "Overview"
---

To create a voice AI Agent,
you need to build a Flow on the Cognigy side using [Voice Nodes](/ai/agents/develop/node-reference/voice/voice-gateway/overview).
