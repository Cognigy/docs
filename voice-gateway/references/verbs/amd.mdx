...
description: Configure answering machine detection on outbound calls to distinguish human from machine answers.
keywords: ['answering machine detection', 'amd', 'outbound calls', 'voice gateway', 'human detection']
sidebarTitle: "Amd"
---
