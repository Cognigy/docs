---
title: Answering Machine Detection (/voice-gateway/references/verbs/amd)

---

The Answering Machine Detection (/voice-gateway/references/verbs/amd) feature can be enabled on outbound calls to provide an indication of whether a call has been answered by a person or a machine. To use this feature, provide the `amd` property in a [dial](/voice-gateway/references/verbs/dial) verb.
...
| recognizer                         | Speech recognition parameters, used as per the [gather](/voice-gateway/references/verbs/gather) and [transcribe](/voice-gateway/references/verbs/transcribe) functions. The default value is `application`. | No       |
