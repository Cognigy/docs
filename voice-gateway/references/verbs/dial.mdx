---
title: Dial
description: The verb for initiating outbound calls to phone numbers, SIP users, or SIP URIs, with support for DTMF capture and AMD.
keywords: ['dial verb', 'outbound call', 'sip uri', 'voice gateway', 'call transfer']
---
