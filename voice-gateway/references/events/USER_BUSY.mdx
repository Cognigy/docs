---
title: USER_BUSY
description: This event triggers when the user is busy (SIP 603) and can't answer or accept the call transfer.
keywords: ['user busy', 'call event', 'busy signal', 'voice gateway', 'sip 603']
---

This event indicates that the user was busy and could not answer the call or engage in the desired action. 
