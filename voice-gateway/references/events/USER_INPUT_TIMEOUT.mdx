...
Input: Start a call via the Interaction Panel by clicking ![call](/_assets/icons/blue/phone.svg) **> Start Call**. When the call starts, say "Hello". Wait several seconds until a payload with the `USER_INPUT_TIMEOUT` event appears.
