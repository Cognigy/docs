...
description: This event triggers when a call transfer via the Dial method fails due to an unreachable or busy destination.
keywords: ['transfer dial error', 'call transfer', 'dial failure', 'voice gateway', 'call event']
---
