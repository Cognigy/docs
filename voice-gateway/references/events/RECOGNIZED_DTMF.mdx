...
description: This event triggers when DTMF keypad input is detected during a call.
keywords: ['dtmf', 'recognized dtmf', 'call event', 'keypad input', 'voice gateway']
---
...
Input: Add the **Set Session Config** Node to the Flow editor and enable the **Capture DTMF Signals** setting in the Node. Start a call via the Interaction Panel by clicking ![phone](/_assets/icons/blue/phone.svg) **> Start Call**, then enter `#`.
