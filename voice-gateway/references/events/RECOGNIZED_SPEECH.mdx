...
description: "The Voice Gateway call event triggered when the AI Agent recognizes user speech during a call."
keywords: ['speech recognition', 'recognized speech', 'call event', 'stt', 'voice gateway']
---
...
Input: Start a call via the Interaction Panel by clicking ![phone](/_assets/icons/blue/phone.svg) **> Start Call**. When the call starts, say "Hello". 
