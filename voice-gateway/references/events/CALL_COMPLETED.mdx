...
Input: Start a call via the Interaction Panel by clicking ![call](/_assets/icons/blue/phone.svg) **> Start Call**. The call will either automatically end when the AI Agent terminates the conversation due to inactivity, or you can end the call by clicking **End Call**.
