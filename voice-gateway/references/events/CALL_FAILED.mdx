---
title: CALL_FAILED
description: This event triggers when a call ends with a SIP error status, including call failure payload and error codes.
keywords: ['call failed', 'call event', 'sip error', 'voice gateway', 'call failure']
---
