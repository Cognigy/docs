...
description: This event detects whether a call is answered by a human or machine on outbound calls.
keywords: ['answering machine detection', 'amd', 'call event', 'voice gateway', 'outbound call']
---
...
- [Answering Machine Detection (AMD)](/voice-gateway/references/verbs/amd)
