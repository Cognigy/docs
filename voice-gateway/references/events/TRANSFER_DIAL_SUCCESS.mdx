...
description: This event triggers when a call transfer via the Dial method succeeds and the destination answers.
keywords: ['transfer dial success', 'call transfer', 'dial method', 'voice gateway', 'call event']
---
