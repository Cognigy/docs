---
title: CALL_CREATED
description: This event triggers when an inbound SIP call is initiated, including full SIP headers and payload structure.
keywords: ['call created', 'call event', 'sip invite', 'voice gateway', 'inbound call']
---
...
Input: Start a call via the Interaction Panel by clicking ![phone](/_assets/icons/blue/phone.svg) **> Start Call**.
