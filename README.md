...
This repository provides comprehensive documentation for NiCE Cognigy products, hosted on [docs.cognigy.com](https://docs.cognigy.com/). It includes documentation for all NiCE Cognigy products, such as Cognigy, Insights, Webchat, Voice Gateway, and Live Agent.
...
|-----------|-------------|
| `ai/` | Core Cognigy platform documentation |
