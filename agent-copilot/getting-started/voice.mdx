...
<Steps>
  ...
  <Step title="Create an Agent Copilot Flow">
    1. In **Build > Flows**, create a [Flow](/ai/agents/develop/flows-and-projects/flows) and give it a clear name, for example, `Agent Copilot`.
    ...
    4. Add the following Agent Copilot Nodes after the LLM Prompt Node and configure them as follows:
        ...
        - **[Copilot: Transcript Tile Node](/ai/agents/develop/node-reference/agent-copilot/transcript-widget)**:
          - **Tile ID** — `transcript`
  </Step>
  ...
  <Step title="Create a Transfer Flow">
    1. In **Build > Flows**, create a [Flow](/ai/agents/develop/flows-and-projects/flows) and give it a clear name, for example, `Transfer`.
