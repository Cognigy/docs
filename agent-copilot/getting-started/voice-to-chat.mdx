...
- Add a [compatible LLM](/ai/agents/develop/gen-ai-and-llms/model-support-by-feature#model-support-by-feature) for the LLM Prompt Node.
...
<Steps>
  ...
  <Step title="Create a Handover Flow">
    1. In **Build > Flows**, create a [Flow](/ai/agents/develop/flows-and-projects/flows) and give it a clear name, for example, `Handover`.
    ...
    3. Add a [Handover to Agent Node](/ai/agents/develop/node-reference/service/handover-to-agent) and configure the following:
  ...
  <Step title="Create an Agent Copilot Flow">
    1. In your Cognigy.AI Project, go to **Build > Flows** and create a [Flow](/ai/agents/develop/flows-and-projects/flows) and give it a clear name, for example, `Agent Copilot`.
