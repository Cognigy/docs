...
description: "Get started with Agent Copilot for chat: configure your first workspace with widgets that suggest next actions to human agents in your contact center."
sidebarTitle: "Chat"
keywords: ['copilot chat setup', 'chat workspace', 'next action widget', 'copilot configuration']
---
