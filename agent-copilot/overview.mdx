---
title: "Agent Copilot"
keywords: ['agent copilot', 'contact center', 'human agent support', 'customizable workspace']
sidebarTitle: "About Agent Copilot"
description: Learn about Agent Copilot features, including customizable workspaces, rich media capabilities, and integration with contact center platforms for human agent support.
---
