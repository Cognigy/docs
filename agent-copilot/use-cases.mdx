...
title: "Use Cases"
slug: "use-cases"
description: "Explore Agent Copilot use cases for sentiment analysis, knowledge retrieval, call summaries, and real-time translation."
...
<div style={{textAlign: 'center'}}>
   <video width="500" height="313" controls title="Sentiment analysis widget showing real-time emotion detection in Agent Copilot" aria-label="Sentiment analysis widget showing real-time emotion detection in Agent Copilot" style={{border: '1px solid #ccc', borderRadius: '12px', display: 'block', margin: '0 auto'}}>
