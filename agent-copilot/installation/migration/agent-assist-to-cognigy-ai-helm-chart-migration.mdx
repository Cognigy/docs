---
title: Define secret and namespaces
description: "Step-by-step instructions for migrating Agent Assist services to the Helm chart, including secret and namespace configuration."
sidebarTitle: 'Migration Guide: Agent Assist to Cognigy Helm Chart'
---

<a href="/release-notes/4.64"><Badge className="version-badge" color="blue">Updated in 4.64</Badge></a>


This guide provides step-by-step instructions for migrating Agent Assist<sup>[1](#footnote1)</sup> services to the `cognigy-ai-app` Helm chart.

<AccordionGroup>
  <Accordion title="Helm Chart Migration Required">
    As of release 4.65, the Agent Assist services have been fully integrated into the `cognigy-ai-app` Helm chart. This integration implies that the services provided by this Helm chart will be incompatible with versions 4.65 and onwards of the Cognigy platform. Users must migrate to the new chart to continue receiving updates and support. 
...
<sup id="footnote1">1</sup>: As of release 4.65, Agent Assist has been renamed to AI Copilot.
