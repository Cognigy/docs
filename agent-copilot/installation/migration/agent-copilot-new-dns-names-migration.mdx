---
title: 'Migration Guide: DNS Name Change for Agent Copilot Services'
description: "Migration guide for updating DNS names when rebranding Agent Assist services to Agent Copilot, covering backend and frontend service configuration."
---
...
<AccordionGroup>
  <Accordion title="DNS Name Change Required">
  ...
  <Accordion title="Minimal Service Interruption">
...
- Cognigy Helm chart version 4.68.0 or higher is required.
