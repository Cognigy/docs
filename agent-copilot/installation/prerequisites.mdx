---
title: Prerequisites
description: "Review the prerequisites for installing Cognigy Agent Copilot, including Cognigy.AI, Kubernetes namespace, and Helm chart requirements."
---
...
For detailed MongoDB setup and configuration, refer to the [Cognigy.AI Installation Prerequisites guide](/ai/administer/installation/prerequisites#kubernetes-cluster).
