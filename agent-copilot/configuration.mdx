...
Only [Agent Copilot Nodes](/ai/agents/develop/node-reference/agent-copilot/overview) must be added to the Agent Copilot Flow. Basic Nodes, such as Say, Code, or Question Nodes, aren't supported and won't be rendered in the Agent Copilot workspace.
...
- Use the [Copilot: Set Grid Node](/ai/agents/develop/node-reference/agent-copilot/set-grid) (this option is recommended).
...
1. On the **Main** page of the Cognigy.AI interface, click **User Menu ![user-menu](/_assets/icons/blue/user-menu.svg) > My Profile** in the upper-right corner. 
...
<a href="/release-notes/4.54"><img noZoom src="https://img.shields.io/badge/Updated in-v4.54-blue.svg" /></a>
...
<a href="/release-notes/4.65"><img noZoom src="https://img.shields.io/badge/Updated in-v4.65-blue.svg" /></a>
...
The Transcript Tile feature is intended specifically for [chat use cases](/agent-copilot/chat). For voice-related scenarios, use the [Copilot: Transcript Tile](/ai/agents/develop/node-reference/agent-copilot/transcript-tile) Node.
