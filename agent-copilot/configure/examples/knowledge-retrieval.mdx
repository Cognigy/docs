...
<Steps>
  ...
  <Step title="Add a Handover to Agent Node">
    1. Below the Say Node, add a [Handover to Agent Node](/ai/agents/develop/node-reference/service/handover-to-agent) and configure the following settings:
...
- [Handover to Agent Node](/ai/agents/develop/node-reference/service/handover-to-agent)