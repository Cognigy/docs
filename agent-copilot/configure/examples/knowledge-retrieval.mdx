...
description: "Configure Agent Copilot for knowledge retrieval to surface relevant information to human agents during live conversations."
...
<Steps>
  ...
  <Step title="Add a Once Node and the Second Copilot: Knowledge Tile Node">
    ...
    3. Below the **On the First Time** Node, right-click ![add node](/_assets/icons/flow-plus.svg) and select **Paste** to add a [Copilot: Knowledge Tile Node](/ai/agents/develop/node-reference/agent-copilot/knowledge-tile).
  </Step>
</Steps>
