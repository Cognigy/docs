...
description: "Configure Agent Copilot for real-time translation in voice-to-chat conversations with multilingual support."
...
- Configure a speech provider in [Cognigy](/ai/agents/test/voice-preview#set-up-a-speech-provider).
...
<Steps>
  ...
  <Step title="Add a Question Node for Language Recognition">
    1. Below the Say Node, add a Question Node and configure the following settings:
        ...
        2. Click ![add channel](/_assets/icons/blue/plus-transparent.svg) and select **Voice Gateway** from the list.
