...
description: "Control the Agent Copilot workspace from your Cognigy.AI Flow using configuration, plug-and-play widget, and customization Nodes."
keywords: ['agent copilot nodes', 'copilot widgets', 'set grid node', 'workspace tiles']
sidebarTitle: "Nodes"
slug: "nodes"
---
