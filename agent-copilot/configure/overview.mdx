...
<AccordionGroup>
  <Accordion title="Handover to Human Agents">
    For chat applications, you need to configure the handover to human agents by adding a [Handover to Agent Node](/ai/agents/develop/node-reference/service/handover-to-agent) to the AI Agent Flow.
  </Accordion>
