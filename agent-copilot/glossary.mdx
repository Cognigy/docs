...
keywords: ['glossary', 'agent copilot']
sidebarTitle: "Glossary"
slug: "glossary"
description: "Definitions for Agent Copilot terms including workspace, grid, tiles, widgets, and deployment methods."
---
