...
keywords: ['voice copilot endpoint', 'agent desktop integration', 'copilot embed', 'developer setup']
seo:
...
Your web server should accept `POST` requests and process the JSON payload sent by Cognigy. For testing purposes, you can use [webhook.site](https://webhook.site) as a temporary web server.
