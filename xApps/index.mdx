---
title: Cognigy xApps
description: "Discover Cognigy xApps, micro-web applications for customer self-service that extend AI Agent capabilities beyond standard chat channel limitations."
keywords: ['cognigy xapps', 'micro-web applications', 'customer self-service', 'conversational journeys', 'xapp overview']
mode: wide
---
