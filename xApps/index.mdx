    ...
    xApps seamlessly embed interactive workflows, rich media, and device features directly into conversational journeys.
     ...
     <div style={{ position: "relative", width: "fit-content", margin: "0 auto" }}>
      <video
        ...
        aria-label="Cognigy xApps hero animation showing a booking process via xApp."
        style={{
          margin: "0 auto",
      ...
      >
        ...
        aria-label="Cognigy xApps hero animation showing a booking process via an xApp."
        style={{
          margin: "0 auto",
          borderRadius: "var(--rounded-xl, .75rem)",
