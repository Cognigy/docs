---
title: About xApps
description: Learn about Cognigy xApps concepts, including sessions, screens, and how to build flexible micro-web applications for customer self-service within conversational journeys.
keywords: ['xapps overview', 'micro-web applications', 'customer self-service', 'xapp nodes', 'adaptive cards']
---
...
The Shell Page has a set of configurable built-in screens. These default screens can be used to interact with end users, for example, when the xApp content is not displayed. These default screens are part of the Shell Page, which holds the connection to the Cognigy backend.
...
<Frame>
    <img src="/_assets/xApps/success-screen.png" alt="xApp success screen displayed when a page launches successfully" style={{ width: 'auto' }} />
</Frame>

<Frame>
    <img src="/_assets/xApps/error-screen.png" alt="xApp error screen displayed when a page fails to launch" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
    <img src="/_assets/xApps/intermediate-screen.png" alt="Default intermediate screen shown while no xApp page is configured" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
    <img src="/_assets/xApps/connection-screen.png" alt="Connection screen shown while re-establishing the backend connection" style={{ width: 'auto' }} />
</Frame>

#### Session Ended Screen

The Session Ended Screen appears when the xApp session ends, for example, when the channel connection is closed. The screen informs the user that no further input is accepted. You can customize this message using the **'Session Ended' Text** parameter on the [xApp: Init Session](/ai/agents/develop/node-reference/xApp/init-xApp-session) Node.

<Frame>
    <img src="/_assets/xApps/end-session-screen.webp" alt="Session Ended Screen shown when the xApp session ends, for example, when the channel connection is closed." style={{ width: 'auto' }} />
</Frame>
...
<Frame>
    <img src="/_assets/xApps/pin-screen.png" alt="PIN entry screen prompting the user to access the xApp session" style={{ width: 'auto' }} />
</Frame>
