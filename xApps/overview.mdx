...
<Frame>
    <img class="image-center" src="/_assets/xApps/success-screen.png" alt="xApp success screen displayed when a page launches successfully" style={{ width: 'auto' }}/>
    <figcaption>xApp Success Screen</figcaption>
</Frame>

<Frame>
    <img class="image-center" src="/_assets/xApps/error-screen.png" alt="xApp error screen displayed when a page fails to launch" style={{ width: 'auto' }}/>
...
<Frame>
    <img class="image-center" src="/_assets/xApps/intermediate-screen.png" alt="Default intermediate screen shown while no xApp page is configured" style={{ width: 'auto' }} />
...
<Frame>
    <img class="image-center" src="/_assets/xApps/connection-screen.png" alt="Connection screen shown while re-establishing the backend connection" style={{ width: 'auto' }} />
...
<Frame>
    <img class="image-center" src="/_assets/xApps/pin-screen.png" alt="PIN entry screen prompting the user to access the xApp session" style={{ width: 'auto' }} />
