...
<Frame>
    <img class="image-center" src="/_assets/xApps/build/standalone/flow-result.png" style={{ width: 'auto' }}/>
</Frame>
...
5. In the **Phone Number** field, specify a mobile number and click **Submit**.
   ...
   <Frame>
    <img class="image-center" src="/_assets/xApps/build/standalone/test-flow.png" style={{ width: 'auto' }}/>
   </Frame>
