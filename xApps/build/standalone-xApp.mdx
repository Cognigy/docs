...
description: "Build and deploy a standalone xApp accessible via URL without requiring a primary communication channel."
keywords: ['standalone xapp', 'xapp deployment', 'xapp url', 'xapp tutorial', 'self-service app']
---
...
<Frame>
    <img class="image-center" src="/_assets/xApps/build/standalone/flow-result.png" alt="xApp Flow configuration showing the Wait for xApp User Input setting enabled" style={{ width: 'auto' }}/>
</Frame>
...
5. In the **Phone Number** field, specify a mobile number and click **Submit**.
   ...
   <Frame>
    <img class="image-center" src="/_assets/xApps/build/standalone/test-flow.png" alt="Interaction Panel showing the xApp test result after phone number submission" style={{ width: 'auto' }}/>
   </Frame>
