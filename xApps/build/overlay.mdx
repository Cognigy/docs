---
title: xApp Overlay
description: "Learn how to display xApp pages as an overlay within Webchat v3, showing xApp content on dedicated screens inside the chat interface."
keywords: ['xapp overlay', 'webchat v3 xapp', 'xapp screen', 'in-chat xapp', 'xapp display']
---
