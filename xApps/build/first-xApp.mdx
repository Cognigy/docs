...
<Frame>
  <img class="image-center" src="/_assets/xApps/build/first-xApp/open-xApp.png" style={{ width: 'auto' }}/>
</Frame>

3. Open the URL in a new tab to view the xApp with the Adaptive Card and select your customer status.

<Frame>
  <img class="image-center" src="/_assets/xApps/build/first-xApp/open-url.png" style={{ width: 'auto' }}/>
</Frame>

4. When you select **New Customer** and submit the action, a new page will be loaded.

<Frame>
  <img class="image-center" src="/_assets/xApps/build/first-xApp/select-new-customer.png" style={{ width: 'auto' }}/>
</Frame>
...
<Frame>
  <img class="image-center" src="/_assets/xApps/build/first-xApp/check-input-result.png" style={{ width: 'auto' }}/>
</Frame>
