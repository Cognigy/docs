...
description: "Build a multi-channel xApp that complements voice and SMS channels, collecting user data via a Twilio-linked xApp form."
keywords: ['xapp multichannel', 'voice xapp', 'xapp sms', 'twilio xapp', 'multi-channel integration']
---

In this tutorial, you will learn how to build an xApp that can complement a primary channel, the voice channel,
...
- Access to a [voice provider](/ai/administer/access/project-settings), for example, Microsoft Azure Speech Services.
- [Twilio API Key](https://www.twilio.com/docs/glossary/what-is-an-api-key#how-can-i-create-api-keys).
- Twilio Extension preinstalled from [Cognigy Marketplace](/ai/for-developers/extensions).
- [Voice Gateway Endpoint](/ai/agents/deploy/endpoint-reference/voice-gateway) configured in Cognigy.
...
11. Click **Add button**. Fill in the following fields:
    ...
    - **URL** — click ![token](/_assets/icons/black-and-white/token.svg) and select the **xApp Session URL** Token.
...
<Frame>
    <img class="image-center" src="/_assets/xApps/build/multichannel/basic-xApp-flow.png" alt="Basic xApp Flow configuration in the Flow Editor" style={{ width: 'auto' }}/>
</Frame>
...
<Frame>
    <img class="image-center" src="/_assets/xApps/build/multichannel/test-voice-channel-flow.png" alt="Interaction Panel showing voice channel Flow test with xApp interaction" style={{ width: 'auto' }}/>
</Frame>
