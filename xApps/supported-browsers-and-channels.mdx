...
description: "Overview of supported browsers and channels for Cognigy xApps, including browser versions and messaging channels."
keywords: ['xapp supported browsers', 'xapp channels', 'browser compatibility', 'voice gateway', 'whatsapp xapp']
---
