---
title: xApp Tokens
description: "Learn how xApp Tokens provide the xApp session URL and PIN code used to access and authenticate xApp sessions via Cognigy flow input objects."
keywords: ['xapp tokens', 'xapp session url', 'xapp pin', 'session access', 'xapp authentication']
---
