...
<Frame>
    <img src="/_assets/xApps/use-cases/microsoft-login.png" alt="Microsoft login form for user authentication via credentials" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
    <img src="/_assets/xApps/use-cases/select-seat.png" alt="Flight seat selection interface showing available and occupied seats" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
    <img src="/_assets/xApps/use-cases/share-location.png" alt="xApp prompting the user to share their device location" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
    <img src="/_assets/xApps/use-cases/energy-meter.png" alt="Mobile camera interface capturing an energy meter reading" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
    <img src="/_assets/xApps/use-cases/boarding-pass.png" alt="Boarding pass with an option to add it to a digital wallet" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
    <img src="/_assets/xApps/use-cases/signature-pad.png" alt="Digital signature pad for electronically signing documents" style={{ width: 'auto' }} />
</Frame>
