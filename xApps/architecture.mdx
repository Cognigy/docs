...
<Frame>
    <img src="/_assets/xApps/architecture.png" alt="xApp architecture showing Shell Page loading assets and WebSocket connections to backend services" style={{ width: 'auto' }} />
</Frame>
