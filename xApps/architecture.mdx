...
description: "Technical overview of xApp architecture, including WebSocket connections, session manager, load balancing, and the xApp interaction sequence diagram."
keywords: ['xapp architecture', 'websocket', 'session manager', 'xapp backend', 'system design']
---
...
<Frame>
    <img class="image-center" src="/_assets/xApps/architecture.png" alt="xApp architecture showing Shell Page loading assets and WebSocket connections to backend services" style={{ width: 'auto' }} />
</Frame>
