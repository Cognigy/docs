    If you are using Live Agent as a handover provider, you can forward information from the widget to the **Reply to User** section by clicking ![forwarder](/_assets/icons/blue/forwarder.svg) and then sending it to the end user.
