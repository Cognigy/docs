<Warning>
  ...
  Respectively, the OData endpoint `understood` field was deprecated in the same version, with full removal scheduled for 2026.1. Use the [Goals collection](https://docs.cognigy.com/ai/analyze/odata#goals) in the Cognigy.AI OData endpoint.
