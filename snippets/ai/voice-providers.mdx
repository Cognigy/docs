...
<Tabs>
  <Tab title="Microsoft">
    1. Next to the **Speech Connection** field, click ![add speech connection](/_assets/icons/black-and-white/plus-sign.svg) to enter credentials.<br/>
  ...
  <Tab title="Deepgram">
    1. Next to the **Speech Connection** field, click ![add speech connection](/_assets/icons/black-and-white/plus-sign.svg) to enter credentials.
    2. In the **New Connection** window, fill in the following fields:
        ...
        - **Region** — select one of the following regions to host the data processed by Deepgram:
  ...
  <Tab title="ElevenLabs">
      ...
      2. In the **New Connection** window, fill in the following fields:
          ...
          - **Region** — select one of the following regions:
            ...
            - **Europe** — for ElevenLabs services hosted in the European Union.
