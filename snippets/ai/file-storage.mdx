<Tabs>
  ...
  <Tab title="Google Cloud Storage Bucket">
    <AccordionGroup>
      ...
      <Accordion title="2. On the Cognigy.AI Side">
        1. On the Cognigy.AI side, open the Project that contains the Endpoint for which you want to configure file storage. Go to **Deploy > Endpoints** and select an Endpoint or create one.
        2. Depending on the Endpoint you select, proceed as follows:
