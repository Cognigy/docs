...
At the end of a tool branch, it is advisable to use a [Resolve Tool Action](https://docs.cognigy.com/ai/develop/node-reference/ai/resolve-tool-action) Node to return to the AI Agent.
