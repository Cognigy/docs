...
<AccordionGroup>
  ...
  <Accordion title="Advanced">
    ...
    | Parameter                   | Type          | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
    |-----------------------------|---------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
    | Top K                       | Slider        | Set how many Knowledge Chunks to return. The default value is 5, and the maximum value is 10. Providing more results gives the AI Agent additional context, but it also increases noise and token usage.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
| Target Flow | Select the target Flow that the AI Agent executes when this tool is called. Click ![open target flow](/_assets/icons/black-and-white/target-flow.svg) to open the target Flow.                                                                                           |
