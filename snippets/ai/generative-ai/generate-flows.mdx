...
To use [Generative AI](/ai/agents/develop/gen-ai-and-llms/generative-ai) technology for creating a new Flow with pre-configured Nodes based on your scenario, do the following:

1. In the left-side menu of the Cognigy interface, click **Build > Flows**.
2. Click **+ New Flow**.
