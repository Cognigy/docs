...
<Warning>
  ...
  <Frame>
    <img src="/_assets/live-agent/la-agent-assist-flow-example.png" alt="Agent assist Flow with Lookup Nodes and Say Nodes for customer inputs" style={{ width: 'auto' }} />
  </Frame>
</Warning>