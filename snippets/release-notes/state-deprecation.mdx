<Warning>
As of Cognigy 2026.7.0, States are deprecated. The removal of States is planned for Cognigy 2026.12.0. Before the removal, delete your States and retrain your NLU model so it no longer uses state-based Intent masking. For alternative approaches to control Intent recognition, use [Intent Conditions](/ai/platform-features/nlu/intents/conditions).
</Warning>