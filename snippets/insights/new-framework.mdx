<Note>
  ...
  The migration to the new framework isn't linked to a specific release. We will start with a few SaaS customers, inform them, and provide assistance for migration. For on-premises customers, the migration guide will be provided soon.

  Afterward, we will migrate the remaining SaaS customers.
</Note>