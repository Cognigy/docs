...
description: Configure Agent Copilot Whisper in Live Agent to provide human agents with AI-powered reply suggestions and next-action hints directly in the chat window.
keywords: ['agent copilot whisper', 'ai suggestions', 'human agents', 'live agent', 'real-time assistance']
...
<Frame>
    <img src="/_assets/live-agent/la-agent-assist-webchat_f.png" alt="Webchat session during a handover for testing Agent Copilot Whisper" style={{ width: 'auto' }} />
</Frame>
...
2. In this menu, the human agent will find the results from the Flow sent via Agent Copilot Whisper.
       <Frame>
           <img src="/_assets/live-agent/la-agent-assist-agentview_f.png" alt="Agent Copilot dropdown menu showing whisper results from the Flow" style={{ width: 'auto' }} />
       </Frame>
3. The human agent can click the blue arrow to forward content to the user.
      <Frame>
           <img src="/_assets/live-agent/la-agent-assist-agentview-forward_f.png" alt="Blue arrow button to forward Agent Copilot content to the user" style={{ width: 'auto' }} />
      </Frame>

       <Frame>
           <img src="/_assets/live-agent/la-agent-assist-webchat-complete_f.png" alt="Webchat showing the forwarded Agent Copilot Whisper response to the end user" style={{ width: 'auto' }} />
       </Frame>
