...
<Frame>
    <img class="image-center" src="/_assets/live-agent/la-agent-assist-webchat_f.png" style={{ width: 'auto' }} alt="Webchat session during a handover for testing Agent Copilot Whisper" />
</Frame>
...
2. In this menu, the human agent will find the results from the Flow sent via Agent Copilot Whisper.
       <Frame>
           <img class="image-center" src="/_assets/live-agent/la-agent-assist-agentview_f.png" style={{ width: 'auto' }} alt="Agent Copilot dropdown menu showing whisper results from the Flow" />
       </Frame>
3. The human agent can click the blue arrow to forward content to the user.
      <Frame>
           <img class="image-center" src="/_assets/live-agent/la-agent-assist-agentview-forward_f.png" style={{ width: 'auto' }} alt="Blue arrow button to forward Agent Copilot content to the user" />
      </Frame>

       <Frame>
           <img class="image-center" src="/_assets/live-agent/la-agent-assist-webchat-complete_f.png" style={{ width: 'auto' }} alt="Webchat showing the forwarded Agent Copilot Whisper response to the end user" />
       </Frame>
