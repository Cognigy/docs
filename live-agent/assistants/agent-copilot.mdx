...
<Frame>
    <img class="image-center" src="/_assets/live-agent/la-agent-assist-webchat.png" style={{ width: 'auto' }} alt="Webchat session during a handover to a Live Agent human agent" />
</Frame>
...
<Frame>
 <img class="image-center" src="/_assets/live-agent/la-agent-assist-workspace.png" style={{ width: 'auto' }} alt="Agent Copilot workspace panel on the right side of the conversation chat" />
</Frame>
