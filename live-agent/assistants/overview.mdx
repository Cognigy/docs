...
description: Overview of Live Agent assistant types, including Agent Copilot Bot, Whisper, and Copilot workspace, to support human agents during customer interactions.
keywords: ['live agent assistants', 'agent copilot', 'human agents', 'virtual assistant', 'ai assistance']
...
Assistants in Cognigy are tools designed to support human agents in their interactions with customers. They often involve AI-powered features, helping agents provide more effective assistance and enhance the overall customer experience.
