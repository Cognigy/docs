...
description: Access Live Agent analytics data via the OData endpoint. Query conversation and agent metrics for dashboards, BI tools, and data exports.
keywords: ['odata endpoint', 'live agent analytics', 'data export', 'rest api', 'business intelligence']
sidebarTitle: OData
---
...
| `members.cognigy_user_id`      | The user ID from Cognigy                                        | String          | `"63ca7c200d733eefd7512584"`                                        |
...
<Danger>
  Cognigy supports OData 4.0, which implies that certain versions of Tableau aren't compatible.
</Danger>
