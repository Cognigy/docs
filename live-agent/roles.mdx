---
title: Roles
description: "Learn about Live Agent user roles, including their permissions, responsibilities, and access levels in the system."
keywords: ['user roles', 'live agent permissions', 'agent', 'supervisor', 'administrator']
---

In Live Agent, human agents can have three distinct user roles:

- [Agent](#agents)
- [Supervisor](#supervisor)
- [Administrator](#administrator)

These roles define the permissions and responsibilities of individuals using the Live Agent system.
...
- Create and delete users. You can only do this in the [Cognigy Admin Center](/ai/administer/access/admin-center/access-control).
...
You can assign roles to human agents.

To create an Agent with certain access rights, do the following steps:

1. Create an Agent from the [Cognigy Access Control](/ai/administer/access/admin-center/access-control).
2. Assign one of the following roles to the Agent:
    - `liveAgentAgent`
    - `liveAgentSupervisor`
    - `liveAgentAdmin` <br/>If you have an Admin role in Cognigy, you do not need to add the Administrator role for your user because the Cognigy role already includes the right to administer Live Agent.
...
the new role will only take effect once the user logs out of Cognigy and Live Agent.
...
<span style={{ fontSize: "0.8rem" }}>
  <sup id="footnote1">1</sup> This permission is granted on the Cognigy side.
</span>
<br />
