...
[^2]: By default, human agents cannot request files from users. To enable this feature, you need to install the [File Upload](https://github.com/Cognigy/WebchatPlugins/tree/master/plugins/file-upload) plugin in the [Webchat Endpoint](/webchat/v2/configuration).
...
<a href="/release-notes/4.44"><img noZoom src="https://img.shields.io/badge/Added in-v4.44-blue.svg" /></a>
