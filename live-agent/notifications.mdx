---
title: Notifications
description: Set up email, push, and audio notifications in Live Agent to keep agents informed about new conversations, assignments, and customer messages in real time.
keywords: ['notifications', 'push notifications', 'email notifications', 'live agent', 'audio alerts']
---
...
Notifications can be configured at three levels: 
...
1. In the bottom-left corner of the Live Agent screen, click ![notifications](/_assets/icons/bell.svg).
