...
description: Manage your Live Agent Profile settings, including notification preferences, Agent Copilot options, message hotkeys, and personal API access token.
keywords: ['profile settings', 'live agent', 'user preferences', 'notifications', 'api access token']
---
...
The other user data, such as email address, full name, and password, needs to be updated in the Cognigy account. The changes will automatically apply to Live Agent.
