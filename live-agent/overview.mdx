...
description: Learn about Cognigy Live Agent, a contact center solution that works with Cognigy.AI to route conversations to human agents based on expertise and availability.
---
...
<Frame>
    <img class="image-center" src="/_assets/live-agent/LA-overview.png" alt="Live Agent Overview" style={{ width: 'auto' }}/>
</Frame>
