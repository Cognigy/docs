...
keywords: ['live agent overview', 'contact center', 'human agents', 'conversation routing']
description: Learn about Cognigy Live Agent, a contact center solution that works with Cognigy to route conversations to human agents based on expertise and availability.
---
...
_Cognigy Live Agent_ is a contact center solution that specifically works with the Cognigy platform.
...
<Frame>
    <img src="/_assets/live-agent/LA-overview.png" alt="Live Agent Overview" style={{ width: 'auto' }} />
</Frame>
