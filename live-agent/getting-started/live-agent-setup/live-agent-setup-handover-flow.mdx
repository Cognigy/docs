...
3. Start the conversation by typing `Hi` and clicking the **Send** button.
    ...
    <Frame>
        <img class="image-center" src="/_assets/live-agent/LA-webchat-hi.png" style={{ width: 'auto' }} alt="Webchat Screen"/>
    </Frame>
...
7. In the **Reply** section, send a message to the user as a human agent.
    ...
    <Frame>
       <img class="image-center" src="/_assets/live-agent/LA-conversation-example.png" style={{ width: 'auto' }} alt="Live Agent Conversation"/>
    </Frame>

8. This message should also appear in the Cognigy.AI Webchat window.

    <Frame>
        <img class="image-center" src="/_assets/live-agent/LA-webchat.png" style={{ width: 'auto' }} alt="Cognigy.AI Webchat"/>
    </Frame>
