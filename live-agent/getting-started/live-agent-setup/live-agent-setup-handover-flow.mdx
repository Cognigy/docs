---
title: Set up a Cognigy.AI Flow for Handover
description: Configure a Cognigy.AI Flow with a Handover Node to route conversations from an AI Agent to a human agent in Live Agent.
keywords: ['handover flow', 'live agent setup', 'cognigy.ai flow', 'handover node', 'agent handover']
...
8. This message should also appear in the Cognigy.AI Webchat window.
    ...
    <Frame>
        <img src="/_assets/live-agent/LA-webchat.png" alt="Cognigy.AI Webchat showing the human agent's reply message received from Live Agent" style={{ width: 'auto' }} />
    </Frame>
