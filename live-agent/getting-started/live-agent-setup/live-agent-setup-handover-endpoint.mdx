...
<Frame>
    <img class="image-center" src="/_assets/live-agent/getting-started/LA_Inbox_URL.png" style={{ width: 'auto' }} alt="Live Agent browser URL highlighting the Account ID in the Inbox settings"/>
</Frame>
