...
description: Create additional Inboxes in Live Agent and configure them for handover within your Cognigy.AI Flows.
keywords: ['additional inbox', 'live agent setup', 'inbox configuration', 'handover', 'cognigy.ai integration']
...
1. In the Cognigy.AI interface, open the Flow that contains the Handover Node.
    ...
    <Frame>
        <img src="/_assets/live-agent/Flow_handover_node_config.png" alt="Cognigy.AI Flow editor with a Handover to Human Agent Node" style={{ width: 'auto' }} />
    </Frame>
