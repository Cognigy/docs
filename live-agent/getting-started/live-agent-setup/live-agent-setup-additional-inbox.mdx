...
description: Create additional Inboxes in Live Agent and configure them for handover within your Cognigy Flows.
keywords: ['additional inbox', 'live agent setup', 'inbox configuration', 'handover', 'cognigy integration']
...
2. In the upper-right corner, click the **+ Add Inbox** button. Live Agent will show you a screen to set up your Inbox.
    ...
    <Frame>
        <img src="/_assets/live-agent/getting-started/LA_Inbox_setup.png" alt="Live Agent Inbox Setup" style={{ width: 'auto' }} />
    </Frame>
...
3. On the Inbox setup page, fill in the following fields:
    ...
    - **Webhook URL** — enter the Cognigy Endpoint Config URL domain name, extended by `/handover/liveagent`. For example, `https://endpoint-trial.cognigy.ai/handover/liveagent`. You can find the Endpoint Config URL in the **Configuration Information** section of your Endpoint.
        ...
        <Frame>
            <img src="/_assets/live-agent/getting-started/LA_Config_URL.png" alt="Endpoint Configuration Information section showing the Config URL" style={{ width: 'auto' }} />
        </Frame>

4. Click the **Create Cognigy Inbox** button. Once you have successfully set up the Inbox, you are prompted in the next step to assign your Agents to the new Inbox. 
...
1. In the Cognigy interface, open the Flow that contains the Handover Node.

    <Frame>
        <img src="/_assets/live-agent/Flow_handover_node_config.png" alt="Cognigy Flow editor with a Handover to Human Agent Node" style={{ width: 'auto' }} />
    </Frame>
