---
title: Audit Logs
description: Track user activities and configuration changes in Live Agent with audit logs. Monitor create, update, and delete events for security and compliance.
keywords: ['audit logs', 'live agent', 'activity tracking', 'security logs', 'administrator']

---

<a href="/release-notes/4.57"><Badge className="version-badge" color="blue">Updated in 4.57</Badge></a>
...
- [Inbox Collaborators](/live-agent/settings/inboxes)
- [Inbox Webhooks](/live-agent/settings/inboxes)
...
<Frame>
<img src="/_assets/live-agent/LA-audit-logs-update-inbox-changes.png" alt="Audit log change details window showing Before and After sections for an update action" style={{ width: 'auto' }} />
</Frame>
