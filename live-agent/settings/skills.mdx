---
title: Skills
description: Define agent skills in Live Agent for skill-based routing, assign language proficiency and domain expertise to improve conversation assignment.
keywords: ['skills', 'agent skills', 'live agent', 'language proficiency', 'skill-based routing']
...
If you want to remove a skill from the row with the agent, open the **Skills** window and click ![remove skill](/_assets/icons/black-and-white/cross.svg) on the right side of the selected skill.
