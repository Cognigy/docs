...
<Frame>
    <img class="image-center" src="/_assets/live-agent/getting-started/LA_Inbox_URL.png" style={{ width: 'auto' }} alt="Live Agent browser URL showing the Account ID and Inbox ID"/>
</Frame>
