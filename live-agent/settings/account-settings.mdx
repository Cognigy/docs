...
The **TTL for Attachments** option lets you automatically delete the attachments in messages of all conversations in the account after a set period.
...
you can enter the Account ID in the [Handover Settings](/live-agent/getting-started/live-agent-setup/live-agent-setup-handover-endpoint#handover-to-manually-configured-live-agent) of your Endpoint in Cognigy.AI,
