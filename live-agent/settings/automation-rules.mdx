---
title: Automation
description: Set up Live Agent automation rules to auto-assign conversations, add labels, set priorities, and trigger actions based on custom workflow conditions.
keywords: ['automation rules', 'live agent', 'workflow automation', 'conversation triggers', 'auto assign']
...
The automation rule appears in the automation rule list and is automatically activated.
...
<Frame>
    <img src="/_assets/live-agent/add-automation-rule.png" alt="Adding an automation rule with conditions and actions in Live Agent" style={{ width: 'auto' }} />
</Frame>
...
- [Settings](/live-agent/settings/overview)
