...
<Frame>
    <img class="image-center" src="/_assets/live-agent/add-automation-rule.png" style={{ width: 'auto' }} alt="Adding an automation rule with conditions and actions in Live Agent" />
</Frame>
