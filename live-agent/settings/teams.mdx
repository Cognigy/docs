---
title: Teams
description: Create and manage teams of human agents in Live Agent to handle specific customer inquiries, assign conversations, and collaborate efficiently.
keywords: ['teams', 'live agent', 'team management', 'agent groups', 'conversation assignment']
...
- [Manual assignment](/live-agent/conversation/conversation-routing/manual-mode#manual-assignment)
