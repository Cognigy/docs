---
title: Labels
description: Organize and prioritize conversations in Live Agent using labels. Learn how to create, edit, and delete conversation tags for custom workflows.
keywords: ['labels', 'conversation tags', 'live agent', 'conversation categorization', 'label management']
