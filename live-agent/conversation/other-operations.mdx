...
description: Learn about other operations in Live Agent, such as muting, sending transcripts by email, and enabling agent masking for efficient support.
keywords: ['conversation operations', 'mute conversation', 'send transcript', 'agent masking', 'live agent']
...
4. In the upper-right corner of the Conversation page, click ![mute conversation](/_assets/icons/black-and-white/mute-conversation.svg). 
...
2. In the **Inboxes** column, select an Inbox.
3. Select a conversation.
4. In the upper-right corner of the Conversation page, click ![unmute conversation](/_assets/icons/black-and-white/unmute-conversation.svg).
...
2. In the **Inboxes** column, select an Inbox.
3. Select a conversation.
4. In the upper-right corner of the Conversation page, click ![send transcript](/_assets/icons/black-and-white/send-transcript.svg). A screen opens up which allows sending a conversation transcript as email to human agents in a team. The chat transcript can also be sent to the customer or another selected email address.
...
2. In the **Inboxes** column, select an Inbox.
3. Select a conversation.
4. In the upper-right corner of the Conversation page, click ![clear conversation history](/_assets/icons/black-and-white/clear-conversation-history.svg).
...
- To expand the chat area, click ![expand](/_assets/icons/black-and-white/expand.svg) in the upper-left corner of the chat screen.
- To collapse the chat area, click ![collapse](/_assets/icons/blue/collapse.svg) in the upper-left corner of the chat screen.
