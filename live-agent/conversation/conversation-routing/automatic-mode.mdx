...
<Frame>
    <img class="image-center" src="/_assets/live-agent/conversation/round-robin.png" style={{ width: 'auto' }} alt="Round-robin assignment cycling conversations among three agents" />
</Frame>
