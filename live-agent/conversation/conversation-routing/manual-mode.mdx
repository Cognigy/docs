---
title: Manual Mode
description: Configure manual routing in Live Agent to assign or escalate conversations to specific agents, supervisors, or administrators based on case needs.
keywords: ['manual routing', 'conversation assignment', 'supervisor escalation', 'live agent', 'manual assignment']
---
