...
<Frame>
<img class="image-center" src="/_assets/live-agent/conversation/reply-section.png" style={{ width: 'auto' }} alt="Live Agent Conversations Reply" />
</Frame>
...
<Frame>
  <img class="image-center" src="/_assets/live-agent/LA-conversation-workflow-27.png" style={{ width: 'auto' }} alt="Live Agent request file upload webchat" />
</Frame>
...
<Frame>
  <img class="image-center" src="/_assets/live-agent/LA-conversation-workflow-28.png" style={{ width: 'auto' }} alt="Live Agent request file upload webchat completed" />
</Frame>

The successful upload is displayed in Live Agent.

<Frame>
  <img class="image-center" src="/_assets/live-agent/LA-conversation-workflow-29.png" style={{ width: 'auto' }} alt="Live Agent request file upload completed" />
</Frame>
...
<Frame>
<img class="image-center" src="/_assets/live-agent/LA-conversation-workflow-14.png" style={{ width: 'auto' }} alt="Live Agent Canned Responses" />
</Frame>
...
<Frame>
<img class="image-center" src="/_assets/live-agent/conversation/private-message.png" style={{ width: 'auto' }} alt="Live Agent Private Message" />
</Frame>
