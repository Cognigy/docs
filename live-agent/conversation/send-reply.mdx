...
By default, you can send messages by pressing ++cmd+enter<kbd>OR</kbd>ctrl+enter<kbd>INSTEAD OF CLICKING THE **SEND** BUTTON.
THE</kbd>enter++ key will be used for line breaks. If you want to change hotkey options, go to [Profile Settings](/live-agent/profile-settings).
