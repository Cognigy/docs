...
3. Click **Add Note** to send the message. You can see a locked sign ![private note](/_assets/icons/black-and-white/locked.svg) in the chat next to the message that has been sent. This message will not be visible to the end user but only to you and your team.
...
1. Click ![menu](/_assets/icons/black-and-white/vertical-ellipsis.svg) icon beside the sent message.
