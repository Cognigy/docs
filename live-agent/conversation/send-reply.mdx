---
title: Send Replies
description: Send replies with canned responses and variables in Live Agent for quick, efficient customer support messages.
keywords: ['send replies', 'canned responses', 'conversation chat', 'live agent', 'human agent messages']

---

<a href="/release-notes/4.87"><Badge className="version-badge" color="blue">Updated in 4.87</Badge></a>
...
<Frame>
<img src="/_assets/live-agent/conversation/reply-section.png" alt="Live Agent Conversations Reply" style={{ width: 'auto' }} />
</Frame>
...
By default, you can send messages by pressing <kbd>Cmd</kbd>+<kbd>Enter</kbd> (Mac) or <kbd>Ctrl</kbd>+<kbd>Enter</kbd> (Windows/Linux) instead of clicking the **Send** button.
The <kbd>Enter</kbd> key will be used for line breaks. If you want to change hotkey options, go to [Profile Settings](/live-agent/profile-settings).
...
| Button                                                | Description                                                                                            |
|-------------------------------------------------------|--------------------------------------------------------------------------------------------------------|
| ![emoji](/_assets/icons/black-and-white/emoji.svg)               | The **Show emoji selector** button allows a human agent to select and include an Emoji in the message. |
| ![attach-files](/_assets/icons/black-and-white/attach-files.svg) | The **Attach files** button allows a human agent to select and include attachments in the message.     |
| ![request-file](/_assets/icons/black-and-white/request-file.svg) | The **Request file** button allows a human agent to request a file from the end user.                  |
| ![record-audio](/_assets/icons/black-and-white/record-audio.svg) | The **Record audio** button allows a human agent to send voice messages to the end user.               |
| ![insert-link](/_assets/icons/black-and-white/insert-link.svg)   | The **Insert link** button allows a human agent to send hyperlinked text to the end user.              |

#### Request File Uploads

By default, human agents cannot request files from users. To enable this feature, you need to install the [File Upload](https://github.com/Cognigy/WebchatPlugins/tree/master/plugins/file-upload) plugin in the [Webchat Endpoint](/webchat/v2/configuration#persistent-menu).
...
1. At the bottom of the **Reply to User** section, click ![request-file](/_assets/icons/black-and-white/request-file.svg). A window for the file request appears and prompts you to confirm.
...
<Frame>
  <img src="/_assets/live-agent/LA-conversation-workflow-27.png" alt="Live Agent request file upload webchat" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
  <img src="/_assets/live-agent/LA-conversation-workflow-28.png" alt="Live Agent request file upload webchat completed" style={{ width: 'auto' }} />
</Frame>

The successful upload is displayed in Live Agent.

<Frame>
  <img src="/_assets/live-agent/LA-conversation-workflow-29.png" alt="Live Agent request file upload completed" style={{ width: 'auto' }} />
</Frame>
...
To include a [canned response](/live-agent/settings/canned-responses) as a reply to the user, follow these steps:
...
<Frame>
<img src="/_assets/live-agent/LA-conversation-workflow-14.png" alt="Live Agent Canned Responses" style={{ width: 'auto' }} />
</Frame>

#### Send Canned Responses with Variables

You can create text including [variables](#send-responses-with-variables) for [canned responses](/live-agent/settings/canned-responses).
...
3. Click **Add Note** to send the message. You can see a locked sign ![locked sign](/_assets/icons/black-and-white/locked.svg) in the chat next to the message that has been sent. This message will not be visible to the end user but only to you and your team.

<Frame>
<img src="/_assets/live-agent/conversation/private-message.png" alt="Live Agent Private Message" style={{ width: 'auto' }} />
</Frame>
...
1. Click ![vertical-ellipsis](/_assets/icons/black-and-white/vertical-ellipsis.svg) icon beside the sent message.
...
- [Conversation](/live-agent/conversation/overview)
- [Conversation Assignment](/live-agent/conversation/assign-conversations)
