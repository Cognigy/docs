---
title: 'Search, Filter, and Sort Conversations'
description: Search, filter, and sort Live Agent conversations by keywords, status, assignee, or team.
keywords: ['conversation search', 'filter conversations', 'sort conversations', 'live agent', 'conversation management']

---

<a href="/release-notes/4.85"><Badge className="version-badge" color="blue">Updated in 4.85</Badge></a>
...
| ----------------------- | ------------------------------------------------------------------------------------------------------------------------ |
| Status                  | Filters data based on the current conversation [status](/live-agent/conversation/overview#conversation-life-cycle). |
...
| Created At              | Filters based on the timestamp of when a conversation was created.                                                       |
| First Reply Created At  | Filters based on the timestamp of the first reply to a conversation.                                                     |
| Last Activity           | Filters based on the timestamp of the last activity on a conversation.                                                   |
| Priority                | Filters based on the priority level assigned to a conversation.                                                          |
...
2. On the left side of the screen, select **Conversations**.
3. From the **Inboxes** list, select an Inbox.
4. At the top of the **Conversations** list, click ![filter](/_assets/icons/black-and-white/filter.svg).
...
7. At the top of the **Conversations** list, click ![save filter](/_assets/icons/black-and-white/live-agent/save-filter.svg).
...
If you want to return to the unfiltered list, click **All Conversations >** ![clear filters](/_assets/icons/black-and-white/live-agent/clear-filters.svg).
...
5. In the **Filter Conversations** window, select the following options:<br/>
   ...
   3. In the **Select** list, choose a priority level by either clicking it or hovering your cursor over it and then pressing <kbd>Enter</kbd>. You can select multiple priorities from the list.<br/>
...
5. Above the tabs, click ![sort conversations](/_assets/icons/black-and-white/live-agent/arrows.svg).
6. In the **Sort Conversations** window, select the following options:
   - **Status** — select a conversation [status](/live-agent/conversation/overview#conversation-life-cycle) you want to search for. Available statuses are `Open`, `Pending`, `Resolved`, `Snoozed`, and `Abandoned`.<br/>
...
- [Conversations](/live-agent/conversation/overview)
- [Conversation Assignment](/live-agent/conversation/assign-conversations)
- [Conversation Replies](/live-agent/conversation/send-reply)
