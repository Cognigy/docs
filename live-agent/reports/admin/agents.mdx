---
title: Agents Report
description: Analyze human agent performance in Live Agent with the Agents Report, including conversation counts, response time, resolution time, and resolved requests.
keywords: ['agents report', 'live agent analytics', 'response time', 'resolution time', 'agent performance']
...
<Frame>
<img src="/_assets/live-agent/LA_Agents_report.png" alt="Live Agent Agents report" style={{ width: 'auto' }} />
</Frame>
