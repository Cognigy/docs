---
title: Labels Report
description: Monitor label usage in Live Agent with the Labels Report, showing conversation counts, response time, and resolution time for each conversation tag.
keywords: ['labels report', 'live agent analytics', 'conversation labels', 'metrics', 'admin reports']
...
<Frame>
<img src="/_assets/live-agent/LA_Labels_report.png" alt="Live Agent Labels report" style={{ width: 'auto' }} />
</Frame>
