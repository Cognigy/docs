---
title: Teams Report
description: Evaluate team performance in Live Agent with the Teams Report, tracking conversations, average response time, and resolution time for each support team.
keywords: ['teams report', 'live agent analytics', 'team performance', 'response time', 'admin reports']
