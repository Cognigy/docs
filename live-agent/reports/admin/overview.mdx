...
description: Access Live Agent administrator reports covering agents, teams, inboxes, labels, and conversations, with combined indicator and bar chart analytics.
keywords: ['administrator reports', 'live agent analytics', 'performance metrics', 'bar charts', 'admin dashboard']

---

import MaintenanceMode from '/snippets/live-agent/maintenance-mode.mdx'
import LiveAgentReports from '/snippets/live-agent/reports.mdx'

<MaintenanceMode />

Administrators can monitor the account's performance in terms of [agents](/live-agent/reports/admin/agents),
[labels](/live-agent/reports/admin/labels), [Inboxes](/live-agent/reports/admin/inboxes), [teams](/live-agent/reports/admin/teams),
and also track [conversation](/live-agent/reports/admin/conversations) metrics over time periods.
...
<Frame>
<img src="/_assets/live-agent/LA_Team_report.png" alt="Live Agent Team report" style={{ width: 'auto' }} />
</Frame>
...
- [Supervisor report](/live-agent/reports/supervisor-overview)
