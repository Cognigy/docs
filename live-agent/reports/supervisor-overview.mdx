...
description: Monitor real-time conversation activity with the Live Agent Supervisor Overview Report, tracking agent status and key metrics for the past 24 hours.
...
<Frame>
<img src="/_assets/live-agent/LA_Supervisor_overview_1.webp" alt="Live Agent Supervisor overview" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
<img src="/_assets/live-agent/LA_Supervisor_overview_2.png" alt="Live Agent Supervisor overview 2" style={{ width: 'auto' }} />
</Frame>
