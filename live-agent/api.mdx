...
keywords: ['live agent api', 'rest api', 'access token', 'api authentication', 'openapi']
description: >-
  The Cognigy Live Agent API provides access to conversations, teams, and
  agents. It enables you to integrate, automate, and analyze workflows beyond
  the Live Agent GUI.
hide:
  - live agent api
---
