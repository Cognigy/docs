---
title: Storage
description: Configure Live Agent storage backends including NFS server, AWS S3, Microsoft Azure, and Google Cloud for managing conversation attachments.
...
When using AWS, [an existing Elastic File System or EFS must be set up](https://aws.amazon.com/efs/). Based on your EFS, fill in the following values:
