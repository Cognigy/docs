...
description: Customize Live Agent email notification templates by adding new templates to the database via the Rails console on your Kubernetes pod.
...
<p> <a href="{{action_url}}">Open the conversation</a> to get cracking.</p>
```
...
<p>
<a href="{{ action_url }}">Open the conversation</a> to get cracking.
</p>
```
