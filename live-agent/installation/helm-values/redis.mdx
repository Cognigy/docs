---
title: Redis
description: "Configure Redis Helm values for Live Agent with options for in-cluster or external Redis, managed solutions, and compatible versions between 5 and 7."
---
...
Compatible and tested Redis versions are later than 5 and earlier than 7.
