---
title: Database
description: "Configure PostgreSQL Helm chart values for Live Agent, covering in-cluster and external database setup, and managed solutions."
---
...
Compatible and tested PostgreSQL versions are later than 10 and earlier than 15.
