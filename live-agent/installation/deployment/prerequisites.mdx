---
title: Prerequisites
description: Learn the prerequisites for installing Live Agent, including Kubernetes 1.16+ cluster requirements, Helm 3.1.0+, and recommended pod resource settings.
...
>**Note:** It is recommended to install Live Agent in a separate namespace as it has its own resources, separated from Cognigy ones.
