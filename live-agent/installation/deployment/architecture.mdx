---
title: Architecture
description: Explore the Live Agent system architecture, including its Ruby on Rails backend, Vue.js frontend, Kubernetes services, and WebSocket support.
...
<Frame>
 <img src="/_assets/live-agent/LA-diagram.svg" alt="Live Agent Architecture" style={{ width: 'auto' }} />
</Frame>
