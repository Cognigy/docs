...
description: Step-by-step guide to installing Live Agent using Helm charts from the Cognigy OCI registry, including login, configuration, and deployment commands.
...
2. Log in to the OCI prod registry with the following command:
...
Once you have a good understanding of how customizing works, you can look at the section [Helm Values](/live-agent/installation/helm-values/helm-values), which contains a brief explanation about each value and its purpose.
