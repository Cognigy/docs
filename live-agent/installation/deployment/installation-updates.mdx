...
description: Learn how to upgrade your Live Agent installation using Helm, including pulling and upgrading simultaneously or modifying the values.yaml file.
