---
title: Create a new file backup-pod.yaml
sidebarTitle: Migration guide for Helm dependencies in Live Agent 4.44
description: Migration guide for Live Agent 4.44 covering PostgreSQL and Redis Helm dependency upgrades, including manual data migration and backup steps.
---
...
<Tabs>
  <Tab title="Delete the secrets (recommended)">
  ...
  <Tab title="Modify the existing secrets">
