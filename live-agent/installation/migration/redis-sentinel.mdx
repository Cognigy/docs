---
title: Migration guide for Redis Sentinel
sidebarTitle: Migration guide for Redis Sentinel in Live Agent 4.53
description: Step-by-step migration guide for upgrading to Redis Sentinel high availability in Live Agent 4.53, including Helm values and upgrade steps.
