...
description: Live Agent supports Firefox, Chrome, Chromium, Safari, and Edge. Check the minimum supported browser version requirements for full compatibility.
keywords: ['browser requirements', 'live agent', 'supported browsers', 'web browsers', 'compatibility']
