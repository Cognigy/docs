...
That may happen because Cognigy.AI is running under a custom SSL certificate (Error cannot validate certificate). And Live Agent is failing to perform the requests to it as SSL requests cannot be verified.
...
<Frame>
<img src="/_assets/live-agent/LA-link-cognigy.ai-platform.png" alt="Link to Cognigy.AI" style={{ width: 'auto' }} />
</Frame>
