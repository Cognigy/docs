...
description: "Explore Cognigy Webchat v2 key features including Quick Replies, gallery cards, buttons, and various message output types for richer chat interactions."
keywords: ['webchat v2 features', 'quick replies', 'gallery cards', 'chat ui', 'webchat interactions']
---
...
<Frame>
  <img class="image-center" src="/_assets/webchat/v2/quick-replies.png" alt="Quick reply buttons displayed below a chat message in Webchat v2" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
  <img class="image-center" src="/_assets/webchat/v2/gallery.png" alt="Gallery carousel with cards containing titles and buttons in Webchat v2" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
  <img class="image-center" src="/_assets/webchat/v2/list.png" alt="List output showing multiple selectable options in Webchat v2" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
  <img class="image-center" src="/_assets/webchat/v2/audio.png" alt="Audio player embedded in a Webchat v2 message" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
  <img class="image-center" src="/_assets/webchat/v2/image.png" alt="Image file displayed inline within a Webchat v2 message" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
  <img class="image-center" src="/_assets/webchat/v2/video.png" alt="Video player embedded in a Webchat v2 message" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
  <img class="image-center" src="/_assets/webchat/v2/button-template.png" alt="Text message with navigation buttons in Webchat v2" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
  <img class="image-center" src="/_assets/webchat/v2/date-picker-selection-date.png" alt="Date picker button prompting the user to select a date" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
  <img class="image-center" src="/_assets/webchat/v2/date-picker.png" alt="Full-screen date picker overlay for choosing a date" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
  <img class="image-center" src="/_assets/webchat/v2/persistent-menu.png" alt="Persistent menu with pre-defined navigation options in the input bar" style={{ width: 'auto' }} />
</Frame>
