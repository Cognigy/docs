...
description: "Cognigy Webchat v2 is a chat widget featuring CSS customization, persistent chat history, and WCAG 2.0 Level AA compliance."
keywords: ['webchat v2', 'webchat deprecated', 'chat widget overview', 'accessibility wcag', 'webchat embedding']
---
...
_Webchat v2_ is a stable version of Cognigy Webchat, which is compatible with any version of Cognigy.
...
<Frame>
  <img src="/_assets/webchat/v2/webchat-v2.png" alt="Cognigy Webchat v2 chat interface" style={{ width: 'auto' }} />
</Frame>
