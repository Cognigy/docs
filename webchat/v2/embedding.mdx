---
title: 'Webchat 2: Embedding'
sidebarTitle: Embedding
description: "Learn how to embed Cognigy Webchat v2 into your website using JavaScript, configure the widget appearance and behavior, and connect it to a Cognigy Endpoint."
keywords: ['webchat embedding', 'webchat v2 embed', 'javascript widget', 'website integration', 'webchat html']
---
...
- Create a [Webchat Endpoint](/webchat/v2/configuration).
...
If you have custom [plugins](/webchat/plugins) or [stylesheets](https://github.com/Cognigy/WebchatWidget/blob/master/docs/css-customization.md) for the Webchat widget, include them by adding the appropriate `<script>` and `<link>` tags respectively. Replace the placeholders with the paths to your custom files.
