---
title: Demo Webchat
description: "Use Cognigy Demo Webchat to test your chat configuration, preview the widget appearance, and validate handover provider integrations before going live."
keywords: ['demo webchat', 'webchat testing', 'webchat preview', 'endpoint settings', 'user id']
---
...
The Webchat Demo Page will display a website that contains a Webchat widget you have configured in the Endpoint Settings in Cognigy.
...
| Enable Speech-to-Text         | Toggle | Toggle whether the Webchat should feature a microphone button. <br/> In the Webchat v3 Endpoint, this parameter is located in the [Webchat Behavior](/webchat/v3/configuration#webchat-behavior) settings and applies to both Demo and Production Webchats. <br/><br/> Note that this parameter is not supported by the Mozilla Firefox browser. |
| Enable Text-to-Speech         | Toggle | Toggle whether the Webchat should read all bot messages aloud. <br/> In the Webchat v3 Endpoint, this parameter is located in the [Webchat Behavior](/webchat/v3/configuration#webchat-behavior) settings and applies to both Demo and Production Webchats.                                                                                      |
...
- [Webchat v2: Configuration](/webchat/v2/configuration)
