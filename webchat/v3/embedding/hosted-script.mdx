---
title: "Webchat v3: via Hosted Script (HTML)"
sidebarTitle: "Embedding via Hosted Script (HTML)"
seo:
    title: "Webchat 3: Embedding via Hosted Script (HTML)"
    description: "Learn how to embed Webchat v3 into your website using a hosted script. This guide covers prerequisites, embedding steps, customization options, and testing to ensure seamless integration with your Cognigy Endpoint."
keywords: ['webchat v3 embedding', 'webchat v3 hosted script', 'webchat v3 html embedding']
---

<a href="/release-notes/2025.16"><Badge className="version-badge" color="blue">Updated in 2025.16</Badge></a>

Embedding Webchat v3 with a hosted script lets you integrate a Webchat widget interface into your website. By connecting the widget to your Cognigy Endpoint and configuring the widget's appearance and behavior, you can offer users seamless interaction and support without a complex setup.
...
- Access to a Cognigy instance with the [Webchat v3 Endpoint](/webchat/v3/configuration).
...
If you have custom [plugins](/webchat/plugins) or [stylesheets](https://github.com/Cognigy/Webchat/blob/main/docs/css-customization.md) for the webchat, include them by adding the appropriate `<script>` and `<link>` tags respectively. Replace the placeholders with the paths to your custom files.
...
To override this setting for languages that use [RTL (right-to-left)](/webchat/v3/features#rtl-language-support),
...
<Tabs>
  <Tab title="LTR (Left-to-Right) Layout">
  ...
  <Tab title="RTL (Right-to-Left) Layout">
