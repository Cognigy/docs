---
title: "Webchat 3: Embedding via npm"
sidebarTitle: "Embedding via npm"
seo:
    title: "Webchat 3: Embedding via npm"
    description: "Learn how to embed Cognigy Webchat v3 into your JavaScript project using the npm package. This guide covers installation, initialization, and customization of the Webchat widget."
keywords: ["webchat v3 embedding", "webchat v3 npm package", "webchat v3 npm embedding"]
---

<a href="/release-notes/2025.18"><img noZoom src="https://img.shields.io/badge/Updated in-v2025.18-blue.svg" /></a>
...
If you have custom [plugins](/webchat/plugins) or [stylesheets](https://github.com/Cognigy/WebchatWidget/blob/master/docs/css-customization.md):
