...
description: "Explore Webchat v3 key features including branding customization, Quick Replies, Conversation Ratings, Privacy Notices, adaptive cards, and rich media support."
keywords: ['webchat v3 features', 'conversation rating', 'adaptive cards', 'privacy notice', 'webchat customization']
---
...
<Frame>
  <img class="image-center" src="/_assets/webchat/v3/home-page.png" alt="Webchat v3 home screen with welcome text and background" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
  <img class="image-center" src="/_assets/webchat/v3/conversation-starters.png" alt="Pre-defined conversation starter buttons on the home screen" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
  <img class="image-center" src="/_assets/webchat/v3/previous-conversations.png" alt="Previous conversations list accessible from the home screen" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
  <img class="image-center" src="/_assets/webchat/v3/teaser-message.png" alt="Teaser message displayed beside the Webchat icon" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
  <img class="image-center" src="/_assets/webchat/v3/chat-options.png" alt="Chat options panel with quick replies, rating, and text-to-speech" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
  <img class="image-center" src="/_assets/webchat/v3/privacy-notice.png" alt="Privacy notice consent prompt before starting a chat" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
  <img class="image-center" src="/_assets/webchat/v3/quick-replies.png" alt="Quick reply buttons displayed below a chat message" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
  <img class="image-center" src="/_assets/webchat/v3/adaptive-card.png" alt="Adaptive card form collecting user information in the chat" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
  <img class="image-center" src="/_assets/webchat/v3/gallery.png" alt="Gallery carousel with cards containing titles, subtitles, and buttons" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
  <img class="image-center" src="/_assets/webchat/v3/list.png" alt="List output showing multiple selectable options in the chat" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
  <img class="image-center" src="/_assets/webchat/v3/audio.png" alt="Audio player embedded in a chat message" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
  <img class="image-center" src="/_assets/webchat/v3/image.png" alt="Image file displayed inline within a chat message" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
  <img class="image-center" src="/_assets/webchat/v3/video.png" alt="Video player embedded in a chat message" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
  <img class="image-center" src="/_assets/webchat/v3/text-with-buttons.png" alt="Text message with navigation buttons in the chat" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
  <img class="image-center" src="/_assets/webchat/v3/persistent-menu.png" alt="Persistent menu with quick action options on the chat screen" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
  <img class="image-center" src="/_assets/webchat/v3/minimize-and-close-window.png" alt="Minimize and close buttons in the chat window header" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
  <img class="image-center" src="/_assets/webchat/v3/attachment.png" alt="Attachment upload option in the chat input bar" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
  <img class="image-center" src="/_assets/webchat/v3/date-picker.png" alt="Interactive date picker overlay for selecting a date" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
  <img class="image-center" src="/_assets/webchat/v3/xApp-overlay.png" alt="xApp page rendered as an overlay within the Webchat window" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
  <img class="image-center" src="/_assets/webchat/v3/rtl-support.png" alt="Webchat v3 interface with right-to-left language layout" style={{ width: 'auto' }} />
</Frame>

To use RTL, add the attribute `dir="rtl"` to the `<html>` tag, which is placed at the beginning of the HTML-page.
For more information, read [RTL Configuration](/webchat/v3/embedding/hosted-script#rtl-configuration). To test this feature, [build Webchat v3 locally](https://github.com/Cognigy/Webchat/blob/main/README.md#development).
