...
description: "Implement WCAG 2.2 Level AA accessibility in Webchat v3, including UI element labels, media captions, text contrast settings, and accessible extension design."
keywords: ['webchat accessibility', 'wcag 2.2', 'screen reader', 'aria labels', 'inclusive design']
---
...
Include alternative (Alt) text to describe images for users who cannot see them. This text is pronounced by screen readers when hovering over the element. For example, include alternative text in the [Say](/ai/agents/develop/node-reference/basic/say), [Question](/ai/agents/develop/node-reference/basic/question), or [Optional Question](/ai/agents/develop/node-reference/basic/optional-question) Nodes for [images and other output types](/ai/agents/develop/node-reference/basic/say) that contain images.

<Frame>
  <img alt="Example alt text configured for an image output" src="/_assets/webchat/v3/image-alt-text.png" style={{ width: 'auto' }} />
</Frame>
...
When you use the **Adaptive Card** output type in the [Say](/ai/agents/develop/node-reference/basic/say), [Question](/ai/agents/develop/node-reference/basic/question),
or [Optional Question](/ai/agents/develop/node-reference/basic/optional-question) Nodes,
ensure
that each field in [Microsoft Adaptive Cards](https://adaptivecards.microsoft.com/designer) contains a title with meaningful text
...
<Frame>
  <img src="/_assets/webchat/v3/adaptive-card-labels.png" alt="Adaptive card with labeled form fields and heading hierarchy" style={{ width: 'auto' }} />
</Frame>

<Accordion title="Adaptive Card Sample">
...
In the [Say](/ai/agents/develop/node-reference/basic/say), [Question](/ai/agents/develop/node-reference/basic/question),
or [Optional Question](/ai/agents/develop/node-reference/basic/optional-question) Nodes, for the **Audio** output type,
...
<Accordion title="Audio Transcript Sample">
...
<Frame>
  <img src="/_assets/webchat/v3/audio-transcript.png" alt="Audio widget with a download transcript button" style={{ width: 'auto' }} />
</Frame>
...
In the [Say](/ai/agents/develop/node-reference/basic/say), [Question](/ai/agents/develop/node-reference/basic/question),
or [Optional Question](/ai/agents/develop/node-reference/basic/optional-question) Nodes, for the **Video** output type,
add the video file, provide the alternative text (a downloadable transcript) and the URL for captions.

<Frame>
  <img src="/_assets/webchat/v3/video-captions.png" alt="Video output type settings with alternative text and captions URL fields" style={{ width: 'auto' }} />
</Frame>
...
In the [Say](/ai/agents/develop/node-reference/basic/say), [Question](/ai/agents/develop/node-reference/basic/question),
or [Optional Question](/ai/agents/develop/node-reference/basic/optional-question) Nodes, for the **Video** output type,
you need to paste a video transcript into the **Video Alternative Text** field.
...
<Accordion title="Video Transcript Sample">
...
<Accordion title="Video Captions Sample">
...
In Webchat, activate captions in the video widget by clicking ![menu](/_assets/icons/black-and-white/vertical-ellipsis.svg) **> Captions**.
...
However, if you [customize the Webchat widget's home screen](/webchat/v3/configuration#home-screen), for example, with a colorful background image, ensure that the text and icons in the foreground remain visible. Use the **Color** section in the [Endpoint Settings](/webchat/v3/configuration#colors) or the [CSS customization](https://github.com/Cognigy/Webchat/blob/main/docs/css-customization.md) options to ensure color contrast.
...
1. Open Chrome DevTools by right-clicking on the web page and select **Inspect**, or press <kbd>Ctrl</kbd> + <kbd>Shift</kbd> + <kbd>I</kbd> (Windows/Linux) or <kbd>Cmd</kbd> + <kbd>Option</kbd> + <kbd>I</kbd> (Mac). 
...
<Frame>
  <img src="/_assets/webchat/v3/color-contrast.png" alt="Chrome DevTools color picker showing contrast ratio check results" style={{ width: 'auto' }} />
</Frame>
...
you created via the [Extension](/ai/for-developers/extensions) framework is developed according to accessibility standards.
