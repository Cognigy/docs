...
<Frame>
  <img class="image-center" alt="A screenshot with an example of an alt text" src="/_assets/webchat/v3/image-alt-text.png" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
  <img class="image-center" src="/_assets/webchat/v3/adaptive-card-labels.png" alt="Adaptive card with labeled form fields and heading hierarchy" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
  <img class="image-center" src="/_assets/webchat/v3/audio-transcript.png" alt="Audio widget with a download transcript button" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
  <img class="image-center" src="/_assets/webchat/v3/video-captions.png" alt="Video output type settings with alternative text and captions URL fields" style={{ width: 'auto' }} />
</Frame>
...
In Webchat, activate captions in the video widget by clicking ![vertical-ellipsis](/_assets/icons/black-and-white/vertical-ellipsis.svg) **> Captions**.
...
<Frame>
  <img class="image-center" src="/_assets/webchat/v3/color-contrast.png" alt="Chrome DevTools color picker showing contrast ratio check results" style={{ width: 'auto' }} />
</Frame>
