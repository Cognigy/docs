...
After the session, the data is available through the [Insights Conversations explorer](/insights/explorers/conversations) and [Cognigy OData endpoint](/ai/agents/analyze/odata).
