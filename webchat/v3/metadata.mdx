...
After the session, the data is available through the [Insights Transcript explorer](/insights/explorers/transcript) and [Cognigy.AI OData endpoint](/ai/agents/analyze/odata).
