...
<a href="/release-notes/2025.23"><Badge className="version-badge" color="blue">Updated in 2025.23</Badge></a>
...
| Parameter                      | Description                                                                                                                                                                                                                                                                                                                                                                              |
| ------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Enable Home Screen             | Ensures the home screen is displayed whenever the Webchat widget is launched, creating a welcoming initial interface for users to begin their interaction. If the parameter is not activated, users will be shown the privacy note page (if activated) or the standard chat interface.                                                                                            |
