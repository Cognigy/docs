...
<a href="/release-notes/2025.23">
  <img noZoom src="https://img.shields.io/badge/Updated in-v2025.23-blue.svg" />
</a>
...
>
  ...
  <p style={{ maxWidth: "200px", margin: "10px auto 0 auto", fontSize: "14px" }}>
    ...
    AI Agent messages with grey background.
  </p>
</div>
...
The Webchat Icon settings allow to customize the icon displayed on your website to open the Webchat widget. Additionally, you can animate the icon and set the animation frequency and speed. After setting the icon animation, you can preview the animation in the icon field.
...
For more information on how to create and trigger plugins, refer to [Webchat Plugins](/webchat/plugins).
