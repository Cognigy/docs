...
| Parameter          | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| ------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Icon               | Select or upload an icon to be displayed on your website to open the Webchat widget. You can select the following:<ul><li>![default-webchat-icon](/_assets/icons/black-and-white/default-webchat-icon.svg)<br/>This is the default icon.</li><li>![shiny-message-bubble-icon](/_assets/icons/black-and-white/shiny-message-bubble-icon.svg)</li><li>![round-message-bubble-icon](/_assets/icons/black-and-white/round-message-bubble-icon.svg)</li><li>![transparent-plus-square](/_assets/icons/black-and-white/transparent-plus-square.svg)<br/>Upload your own icon.</li></ul> |
