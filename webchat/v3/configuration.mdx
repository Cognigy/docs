...
>
  <video
    ...
    alt="Modern style preset: larger, wider Webchat widget with borderless AI Agent messages"
    style={{
      border: "1px solid #ccc",
      borderRadius: "12px",
      width: "100%",
...
>
  <video
    ...
    alt="Slick style preset: larger but narrower Webchat widget with bordered messages and grey background"
    style={{
      border: "1px solid #ccc",
      borderRadius: "12px",
      width: "100%",
