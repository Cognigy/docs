...
description: "Learn how to get help with Cognigy.AI by submitting support tickets, using in-product help, and accessing other resources to resolve issues quickly."
...
<Frame>
  <img class="image-center" src="/_assets/help/agent-bar.JPG" alt="Help icon in the Cognigy.AI app bar" style={{ width: 'auto' }} />
</Frame>

When clicking on this menu, the help widget will open, and you can search for help directly within the product.

<Frame>
  <img class="image-center" src="/_assets/help/help-widget.JPG" alt="In-product help widget with search functionality" style={{ width: 'auto' }} />
</Frame>
...
<Frame>
  <img class="image-center" src="/_assets/help/view-article.JPG" alt="View original article link in the help widget" style={{ width: 'auto' }} />
</Frame>
